...
pub static mut cmd_list_windows_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"list-windows\x00" as *const u8 as *const libc::c_char,
            alias: b"lsw\x00" as *const u8 as *const libc::c_char,
            args: {
            ...
            usage: b"[-a] [-F format] [-f filter] [-t target-session]\x00" as *const u8
...
unsafe extern "C" fn cmd_list_windows_server(mut self_0: *mut cmd, mut item: *mut cmdq_item) {
