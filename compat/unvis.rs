    ...
    match *astate {
        ...
        1 => {
            match c as libc::c_int {
                ...
                94 => { *astate = 4 as libc::c_int; return 0 as libc::c_int }
                110 => {
        ...
        2 => {
            ...
            } else { *astate = 0 as libc::c_int; return -(1 as libc::c_int) }
            return 0 as libc::c_int
        }
        3 => {
            *astate = 0 as libc::c_int;
        ...
        4 => {
            if c as libc::c_int == '?' as i32 {
                *cp =
                    (*cp as libc::c_int | 0o177 as libc::c_int) as
                        libc::c_char
            } else {
                *cp =
                    (*cp as libc::c_int |
                         c as libc::c_int & 0o37 as libc::c_int) as
                        libc::c_char
            }
            *astate = 0 as libc::c_int;
            return 1 as libc::c_int
        ...
        5 => {
            ...
            if c as u_char as libc::c_int >= '0' as i32 &&
                   c as u_char as libc::c_int <= '7' as i32 {
                /*
			 * yes - and maybe a third
			 */
                *cp =
                    (((*cp as libc::c_int) << 3 as libc::c_int) +
...
pub unsafe extern "C" fn strnunvis(mut dst: *mut libc::c_char,
    ...
    let mut end: *mut libc::c_char =
        dst.offset(sz as isize).offset(-(1 as libc::c_int as isize));
    let mut state: libc::c_int = 0 as libc::c_int;
    ...
    loop  {
        ...
        loop  {
            match unvis(&mut p, c, &mut state, 0 as libc::c_int) {
                ...
                2 => { if dst < end { *dst = p } dst = dst.offset(1) }
                0 | 3 => { break ; }
                _ => {
                    if dst <= end { *dst = '\u{0}' as i32 as libc::c_char }
