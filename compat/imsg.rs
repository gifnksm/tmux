...
pub unsafe extern "C" fn imsg_init(mut ibuf: *mut imsgbuf,
    ...
    memset(&mut (*ibuf).r as *mut ibuf_read as *mut libc::c_void,
           0 as libc::c_int,
...
pub unsafe extern "C" fn imsg_read(mut ibuf: *mut imsgbuf) -> ssize_t {
    ...
    let mut cmsgbuf: C2RustUnnamed_4 =
        C2RustUnnamed_4{hdr:
                            cmsghdr{cmsg_len: 0,
                                    cmsg_level: 0,
                                    cmsg_type: 0,
    ...
    memset(&mut cmsgbuf as *mut C2RustUnnamed_4 as *mut libc::c_void,
           0 as libc::c_int,
    ...
    iov.iov_base =
        (*ibuf).r.buf.as_mut_ptr().offset((*ibuf).r.wpos as isize) as
            *mut libc::c_void;
    iov.iov_len =
        (::std::mem::size_of::<[libc::c_uchar; 65535]>() as
    ...
    ifd =
        calloc(1 as libc::c_int as libc::c_ulong,
            ...
            *mut imsg_fd;
    if ifd.is_null() { return -(1 as libc::c_int) as ssize_t }
    loop  {
        ...
        if n == -(1 as libc::c_int) as libc::c_long {
			 ...
			 */
                    j =
                        ((cmsg as
                              *mut libc::c_char).offset((*cmsg).cmsg_len as
                                                            isize).wrapping_offset_from((*cmsg).__cmsg_data.as_mut_ptr()
                                                                                            as
                                                                                            *mut libc::c_char)
                             as libc::c_long as
                             libc::c_ulong).wrapping_div(::std::mem::size_of::<libc::c_int>()
...
pub unsafe extern "C" fn imsg_compose(mut ibuf: *mut imsgbuf,
    ...
    if wbuf.is_null() { return -(1 as libc::c_int) }
...
pub unsafe extern "C" fn imsg_create(mut ibuf: *mut imsgbuf,
    ...
    if wbuf.is_null() { return 0 as *mut ibuf }
    if imsg_add(wbuf, &mut hdr as *mut imsg_hdr as *const libc::c_void,
                ::std::mem::size_of::<imsg_hdr>() as libc::c_ulong as
                    uint16_t) == -(1 as libc::c_int) {
        return 0 as *mut ibuf
    }
    return wbuf;
}
...
pub unsafe extern "C" fn imsg_close(mut ibuf: *mut imsgbuf,
    ...
    (*hdr).flags =
        ((*hdr).flags as libc::c_int & !(1 as libc::c_int)) as uint16_t;
...
unsafe extern "C" fn imsg_get_fd(mut ibuf: *mut imsgbuf) -> libc::c_int {
    ...
    if ifd.is_null() { return -(1 as libc::c_int) }
    fd = (*ifd).fd;
