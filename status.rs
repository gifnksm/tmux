...
extern "C" {
    ...
    #[no_mangle]
    fn menu_add_item(_: *mut menu, _: *const menu_item, _: *mut cmdq_item,
...
unsafe extern "C" fn status_prompt_find_history_file() -> *mut libc::c_char {
    ...
    if *history_file.offset(0 as libc::c_int as isize) as libc::c_int !=
           '~' as i32 ||
           *history_file.offset(1 as libc::c_int as isize) as libc::c_int !=
               '/' as i32 {
        return 0 as *mut libc::c_char
    }
    home = find_home();
...
pub unsafe extern "C" fn status_prompt_load_history() {
    ...
    if history_file.is_null() { return }
    ...
    loop  {
        ...
        if length > 0 as libc::c_int as libc::c_ulong {
            if *line.offset(length.wrapping_sub(1 as libc::c_int as
                                                    libc::c_ulong) as isize)
                   as libc::c_int == '\n' as i32 {
                *line.offset(length.wrapping_sub(1 as libc::c_int as
                                                     libc::c_ulong) as isize)
                    = '\u{0}' as i32 as libc::c_char;
                status_prompt_add_history(line);
            } else {
                tmp =
                    xmalloc(length.wrapping_add(1 as libc::c_int as
                                                    libc::c_ulong)) as
                        *mut libc::c_char;
                memcpy(tmp as *mut libc::c_void, line as *const libc::c_void,
                       length);
...
pub unsafe extern "C" fn status_prompt_save_history() {
    ...
    history_file = status_prompt_find_history_file();
    if history_file.is_null() { return }
    log_debug(b"saving history to %s\x00" as *const u8 as *const libc::c_char,
              history_file);
...
pub unsafe extern "C" fn status_timer_start(mut c: *mut client) {
    ...
    if event_initialized(&mut (*c).status.timer) != 0 {
        ...
        event_set(&mut (*c).status.timer, -(1 as libc::c_int),
                  0 as libc::c_int as libc::c_short,
                  Some(status_timer_callback as
    ...
    if !s.is_null() &&
           options_get_number((*s).options,
                              b"status\x00" as *const u8 as
                                  *const libc::c_char) != 0 {
        status_timer_callback(-(1 as libc::c_int),
                              0 as libc::c_int as libc::c_short,
                              c as *mut libc::c_void);
    };
}
...
pub unsafe extern "C" fn status_timer_start_all() {
    ...
    c = clients.tqh_first;
    while !c.is_null() { status_timer_start(c); c = (*c).entry.tqe_next };
}
/* Update status cache. */
#[no_mangle]
pub unsafe extern "C" fn status_update_cache(mut s: *mut session) {
    ...
    } else { (*s).statusat = 1 as libc::c_int };
}
...
pub unsafe extern "C" fn status_at_line(mut c: *mut client) -> libc::c_int {
    let mut s: *mut session = (*c).session;
    if (*c).flags &
           (0x800000 as libc::c_int | 0x2000 as libc::c_int) as libc::c_ulong
           != 0 {
        return -(1 as libc::c_int)
    }
    if (*s).statusat != 1 as libc::c_int { return (*s).statusat }
...
#[no_mangle]
pub unsafe extern "C" fn status_get_range(mut c: *mut client, mut x: u_int,
                                          mut y: u_int) -> *mut style_range {
    let mut sl: *mut status_line = &mut (*c).status;
    let mut sr: *mut style_range = 0 as *mut style_range;
    if y as libc::c_ulong >=
           (::std::mem::size_of::<[status_line_entry; 5]>() as
                libc::c_ulong).wrapping_div(::std::mem::size_of::<status_line_entry>()
                                                as libc::c_ulong) {
        return 0 as *mut style_range
    }
    sr = (*sl).entries[y as usize].ranges.tqh_first;
    while !sr.is_null() {
        if x >= (*sr).start && x < (*sr).end { return sr }
    ...
    if (*sl).active == &mut (*sl).screen as *mut screen {
        (*sl).active =
            xmalloc(::std::mem::size_of::<screen>() as libc::c_ulong) as
                *mut screen;
        screen_init((*sl).active, (*c).tty.sx, status_line_size(c),
...
pub unsafe extern "C" fn status_init(mut c: *mut client) {
    ...
    while (i as libc::c_ulong) <
        ...
        (*sl).entries[i as usize].ranges.tqh_last =
            &mut (*(*sl).entries.as_mut_ptr().offset(i as
                                                         isize)).ranges.tqh_first;
        i = i.wrapping_add(1)
    }
    screen_init(&mut (*sl).screen, (*c).tty.sx, 1 as libc::c_int as u_int,
                0 as libc::c_int as u_int);
    (*sl).active = &mut (*sl).screen;
}
/* Free status line. */
...
pub unsafe extern "C" fn status_free(mut c: *mut client) {
    ...
    while (i as libc::c_ulong) <
              (::std::mem::size_of::<[status_line_entry; 5]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<status_line_entry>()
                                                   as libc::c_ulong) {
        status_free_ranges(&mut (*(*sl).entries.as_mut_ptr().offset(i as
                                                                        isize)).ranges);
...
pub unsafe extern "C" fn status_redraw(mut c: *mut client) -> libc::c_int {
    ...
    log_debug(b"%s enter\x00" as *const u8 as *const libc::c_char,
              (*::std::mem::transmute::<&[u8; 14],
                                        &[libc::c_char; 14]>(b"status_redraw\x00")).as_ptr());
    /* Shouldn't get here if not the active screen. */
    if (*sl).active != &mut (*sl).screen as *mut screen {
        fatalx(b"not the active screen\x00" as *const u8 as
                   *const libc::c_char);
    }
    /* No status line? */
    lines = status_line_size(c);
    if (*c).tty.sy == 0 as libc::c_int as libc::c_uint ||
           lines == 0 as libc::c_int as libc::c_uint {
        return 1 as libc::c_int
    }
    /* Create format tree. */
    ...
    style_apply(&mut gc, (*s).options,
                b"status-style\x00" as *const u8 as *const libc::c_char, ft);
    fg =
        options_get_number((*s).options,
                           b"status-fg\x00" as *const u8 as
                               *const libc::c_char) as libc::c_int;
    if fg != 8 as libc::c_int { gc.fg = fg }
    bg =
        options_get_number((*s).options,
                           b"status-bg\x00" as *const u8 as
                               *const libc::c_char) as libc::c_int;
    if bg != 8 as libc::c_int { gc.bg = bg }
    if grid_cells_equal(&mut gc, &mut (*sl).style) == 0 {
        force = 1 as libc::c_int;
        memcpy(&mut (*sl).style as *mut grid_cell as *mut libc::c_void,
    ...
    if o.is_null() {
        ...
        while i < lines {
            ...
            if ov.is_null() {
                ...
                sle =
                    &mut *(*sl).entries.as_mut_ptr().offset(i as isize) as
                        *mut status_line_entry;
                expanded = format_expand_time(ft, (*ov).string);
                if force == 0 && !(*sle).expanded.is_null() &&
                    ...
                    format_draw(&mut ctx, &mut gc, width, expanded,
                                &mut (*sle).ranges);
    ...
    log_debug(b"%s exit: force=%d, changed=%d\x00" as *const u8 as
                  *const libc::c_char,
              (*::std::mem::transmute::<&[u8; 14],
                                        &[libc::c_char; 14]>(b"status_redraw\x00")).as_ptr(),
              force, changed);
...
#[no_mangle]
pub unsafe extern "C" fn status_message_set(mut c: *mut client,
    ...
    server_add_message(b"%s message: %s\x00" as *const u8 as
    ...
    if delay > 0 as libc::c_int {
        ...
        event_set(&mut (*c).message_timer, -(1 as libc::c_int),
                  0 as libc::c_int as libc::c_short,
                  Some(status_message_callback as
                           unsafe extern "C" fn(_: libc::c_int,
                                                _: libc::c_short,
                                                _: *mut libc::c_void) -> ()),
                  c as *mut libc::c_void);
...
pub unsafe extern "C" fn status_message_redraw(mut c: *mut client)
 -> libc::c_int {
    ...
    memcpy(&mut old_screen as *mut screen as *mut libc::c_void,
    ...
    ft =
        format_create_defaults(0 as *mut cmdq_item, c, 0 as *mut session,
                               0 as *mut winlink, 0 as *mut window_pane);
    style_apply(&mut gc, (*s).options,
                b"message-style\x00" as *const u8 as *const libc::c_char, ft);
    format_free(ft);
    screen_write_start(&mut ctx, (*sl).active);
    screen_write_fast_copy(&mut ctx, &mut (*sl).screen,
                           0 as libc::c_int as u_int,
                           0 as libc::c_int as u_int, (*c).tty.sx,
                           lines.wrapping_sub(1 as libc::c_int as
                                                  libc::c_uint));
    screen_write_cursormove(&mut ctx, 0 as libc::c_int,
                            lines.wrapping_sub(1 as libc::c_int as
                                                   libc::c_uint) as
    ...
    if (*c).message_ignore_styles != 0 {
        ...
        format_draw(&mut ctx, &mut gc, (*c).tty.sx, (*c).message_string,
...
pub unsafe extern "C" fn status_prompt_set(mut c: *mut client,
    ...
    if input.is_null() { input = b"\x00" as *const u8 as *const libc::c_char }
    if flags & 0x8 as libc::c_int != 0 {
        tmp = xstrdup(input)
    } else { tmp = format_expand_time(ft, input) }
    status_message_clear(c);
...
pub unsafe extern "C" fn status_prompt_redraw(mut c: *mut client)
 -> libc::c_int {
    ...
    memcpy(&mut cursorgc as *mut grid_cell as *mut libc::c_void,
           ...
           ::std::mem::size_of::<grid_cell>() as libc::c_ulong);
    cursorgc.attr =
        (cursorgc.attr as libc::c_int ^ 0x10 as libc::c_int) as u_short;
    start =
        screen_write_strlen(b"%s\x00" as *const u8 as *const libc::c_char,
    ...
    screen_write_cursormove(&mut ctx, 0 as libc::c_int,
                            lines.wrapping_sub(1 as libc::c_int as
                                                   libc::c_uint) as
                                libc::c_int, 0 as libc::c_int);
    screen_write_nputs(&mut ctx as *mut screen_write_ctx, start as ssize_t,
                       &mut gc as *mut grid_cell,
                       b"%s\x00" as *const u8 as *const libc::c_char,
                       (*c).prompt_string);
    screen_write_cursormove(&mut ctx, start as libc::c_int,
                            lines.wrapping_sub(1 as libc::c_int as
                                                   libc::c_uint) as
                                libc::c_int, 0 as libc::c_int);
    ...
    if !(left == 0 as libc::c_int as libc::c_uint) {
        pcursor =
            utf8_strwidth((*c).prompt_buffer, (*c).prompt_index as ssize_t);
        pwidth =
            utf8_strwidth((*c).prompt_buffer, -(1 as libc::c_int) as ssize_t);
        if pcursor >= left {
            /*
		 ...
		 */
            offset =
                pcursor.wrapping_sub(left).wrapping_add(1 as libc::c_int as
                                                            libc::c_uint);
            pwidth = left
        } else { offset = 0 as libc::c_int as u_int }
        ...
        's_63:
            {
                ...
                match key {
                    ...
                    8 => { current_block_4 = 509724311878556287; }
                    9 => { current_block_4 = 13850883808908694939; }
                    21 => { current_block_4 = 17517844533035367829; }
                    23 => { current_block_4 = 18408218966702913984; }
                    3 | 10 | 13 | 68719476888 | 68719476902 | 68719476909 |
                    68719476904 | 68719476903 | 68719476910 | 68719476911 |
                    68719476908 => {
...
unsafe extern "C" fn status_prompt_paste(mut c: *mut client) -> libc::c_int {
    ...
    if !(*c).prompt_saved.is_null() {
        ...
        ud =
            xreallocarray(0 as *mut libc::c_void,
                          bufsize.wrapping_add(1 as libc::c_int as
                                                   libc::c_ulong),
        ...
        while i as libc::c_ulong != bufsize {
            ...
            if more as libc::c_uint ==
                ...
                loop  {
                    ...
                    more =
                        utf8_append(udp,
                                    *bufdata.offset(i as isize) as u_char)
                }
                if more as libc::c_uint ==
                    ...
                    i =
                        (i as
                             libc::c_uint).wrapping_sub((*udp).have as
                                                            libc::c_uint) as
                            u_int as u_int
                }
            }
            if *bufdata.offset(i as isize) as libc::c_int <= 31 as libc::c_int
                   ||
                   *bufdata.offset(i as isize) as libc::c_int >=
                       127 as libc::c_int {
                break ;
            }
    ...
    (*c).prompt_buffer =
        xreallocarray((*c).prompt_buffer as *mut libc::c_void,
                      size.wrapping_add(n).wrapping_add(1 as libc::c_int as
                                                            libc::c_ulong),
                      ::std::mem::size_of::<utf8_data>() as libc::c_ulong) as
            *mut utf8_data;
    if (*c).prompt_index == size {
        memcpy((*c).prompt_buffer.offset((*c).prompt_index as isize) as
                   *mut libc::c_void, ud as *const libc::c_void,
               n.wrapping_mul(::std::mem::size_of::<utf8_data>() as
                                  libc::c_ulong));
        (*c).prompt_index =
            ((*c).prompt_index as libc::c_ulong).wrapping_add(n) as size_t as
                size_t;
        ...
        memmove((*c).prompt_buffer.offset((*c).prompt_index as
                                              isize).offset(n as isize) as
                    *mut libc::c_void,
                (*c).prompt_buffer.offset((*c).prompt_index as isize) as
                    *const libc::c_void,
    ...
    if ud != (*c).prompt_saved { free(ud as *mut libc::c_void); }
    return 1 as libc::c_int;
}
/* Finish completion. */
unsafe extern "C" fn status_prompt_replace_complete(mut c: *mut client,
                                                    mut s:
                                                        *const libc::c_char)
 -> libc::c_int {
    ...
    idx = (*c).prompt_index;
    if idx != 0 as libc::c_int as libc::c_ulong { idx = idx.wrapping_sub(1) }
    size = utf8_strlen((*c).prompt_buffer);
    ...
    if last < first { return 0 as libc::c_int }
    if s.is_null() {
        ...
        while ud < last {
            ...
            memcpy(word.as_mut_ptr().offset(used as isize) as
                       *mut libc::c_void,
        ...
        if ud != last { return 0 as libc::c_int }
        word[used as usize] = '\u{0}' as i32 as libc::c_char
    }
    /* Try to complete it. */
    if s.is_null() {
        allocated =
            status_prompt_complete(c, word.as_mut_ptr(),
                                   first.wrapping_offset_from((*c).prompt_buffer)
                                       as libc::c_long as u_int);
        if allocated.is_null() { return 0 as libc::c_int }
        s = allocated
    }
    /* Trim out word. */
    n =
        size.wrapping_sub(last.wrapping_offset_from((*c).prompt_buffer) as
                              libc::c_long as
                              libc::c_ulong).wrapping_add(1 as libc::c_int as
                                                              libc::c_ulong); /* with \0 */
    memmove(first as *mut libc::c_void, last as *const libc::c_void,
            n.wrapping_mul(::std::mem::size_of::<utf8_data>() as
                               libc::c_ulong));
    size =
        (size as
             libc::c_ulong).wrapping_sub(last.wrapping_offset_from(first) as
                                             libc::c_long as libc::c_ulong) as
            size_t as size_t;
    /* Insert the new word. */
    size =
        (size as libc::c_ulong).wrapping_add(strlen(s)) as size_t as size_t;
    off =
        first.wrapping_offset_from((*c).prompt_buffer) as libc::c_long as
            size_t;
    (*c).prompt_buffer =
        xreallocarray((*c).prompt_buffer as *mut libc::c_void,
    ...
    memmove(first.offset(strlen(s) as isize) as *mut libc::c_void,
            first as *const libc::c_void,
            n.wrapping_mul(::std::mem::size_of::<utf8_data>() as
                               libc::c_ulong));
    idx = 0 as libc::c_int as size_t;
    while idx < strlen(s) {
        utf8_set(&mut *first.offset(idx as isize),
...
pub unsafe extern "C" fn status_prompt_key(mut c: *mut client,
    ...
    if (*c).prompt_flags & 0x2 as libc::c_int != 0 {
        ...
        if keys == 1 as libc::c_int {
            match status_prompt_translate_key(c, key, &mut key) {
                1 => { current_block = 10489599262272764497; }
                2 => { current_block = 14272474440432613372; }
                _ => { return 0 as libc::c_int }
            }
        } else { current_block = 10489599262272764497; }
        match current_block {
            ...
            _ => {
                match key {
                        ...
                        match current_block {
                            ...
                            6699258362909208477 => {
                                ...
                                if idx >= 2 as libc::c_int as libc::c_ulong {
                                    utf8_copy(&mut tmp,
                                              &mut *(*c).prompt_buffer.offset(idx.wrapping_sub(2
                                                                                                   as
                                                                                                   libc::c_int
                                                                                                   as
                                                                                                   libc::c_ulong)
                                                                                  as
                                                                                  isize));
                                    utf8_copy(&mut *(*c).prompt_buffer.offset(idx.wrapping_sub(2
                                                                                                   as
                                                                                                   libc::c_int
                                                                                                   as
                                                                                                   libc::c_ulong)
                                                                                  as
                                                                                  isize),
                                              &mut *(*c).prompt_buffer.offset(idx.wrapping_sub(1
                                                                                                   as
                                                                                                   libc::c_int
                                                                                                   as
                                                                                                   libc::c_ulong)
                                                                                  as
                                                                                  isize));
                                    utf8_copy(&mut *(*c).prompt_buffer.offset(idx.wrapping_sub(1
                                                                                                   as
                                                                                                   libc::c_int
                                                                                                   as
                                                                                                   libc::c_ulong)
                            ...
                            7307066281430299153 => {
                                ...
                                free((*c).prompt_saved as *mut libc::c_void);
                                (*c).prompt_saved =
                                    xcalloc(::std::mem::size_of::<utf8_data>()
                                                as libc::c_ulong,
                                            (*c).prompt_index.wrapping_sub(idx).wrapping_add(1
                                                                                                 as
                                                                                                 libc::c_int
                                                                                                 as
                                                                                                 libc::c_ulong))
                                        as *mut utf8_data;
                                memcpy((*c).prompt_saved as *mut libc::c_void,
                            ...
                            7209921709130718133 => {
                                /* C-u */
                                (*(*c).prompt_buffer.offset(0 as libc::c_int
                                                                as
                                                                isize)).size =
                                    0 as libc::c_int as u_char;
                                (*c).prompt_index =
                                    ...
                                    memmove((*c).prompt_buffer.offset((*c).prompt_index
                                            ...
                                            (*c).prompt_buffer.offset((*c).prompt_index
                                                                          ...
                                                                          isize).offset(1
                                                                                            ...
                                                                                            isize)
                                                as *const libc::c_void,
                                            size.wrapping_add(1 as libc::c_int
                                                                  as
                                                                  libc::c_ulong).wrapping_sub((*c).prompt_index).wrapping_mul(::std::mem::size_of::<utf8_data>()
                                                                                                                                  as
                                                                                                                                  libc::c_ulong));
                            ...
                            /* Tab */
                            {
                                if status_prompt_replace_complete(c,
                                                                  0 as
                                                                      *const libc::c_char)
                                       != 0 {
                                    current_block = 368077705793071303;
                    ...
                    _ => { current_block = 14272474440432613372; }
                }
            }
        }
    }
    match current_block {
        14272474440432613372 => {
            ...
            } else { utf8_to_data(key as utf8_char, &mut tmp); }
            (*c).prompt_buffer =
                xreallocarray((*c).prompt_buffer as *mut libc::c_void,
            ...
            if (*c).prompt_index == size {
                utf8_copy(&mut *(*c).prompt_buffer.offset((*c).prompt_index as
                                                              isize),
                          &mut tmp);
...
unsafe extern "C" fn status_prompt_add_history(mut line:
                                                   *const libc::c_char) {
    let mut size: size_t = 0;
    if status_prompt_hsize > 0 as libc::c_int as libc::c_uint &&
           strcmp(*status_prompt_hlist.offset(status_prompt_hsize.wrapping_sub(1
                                                                                   as
                                                                                   libc::c_int
                                                                                   as
                                                                                   libc::c_uint)
    ...
    if status_prompt_hsize == 100 as libc::c_int as libc::c_uint {
        free(*status_prompt_hlist.offset(0 as libc::c_int as isize) as
                 *mut libc::c_void);
        size =
            ((100 as libc::c_int - 1 as libc::c_int) as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<*mut libc::c_char>()
                                                 as libc::c_ulong);
        memmove(&mut *status_prompt_hlist.offset(0 as libc::c_int as isize) as
                    *mut *mut libc::c_char as *mut libc::c_void,
                &mut *status_prompt_hlist.offset(1 as libc::c_int as isize) as
                    *mut *mut libc::c_char as *const libc::c_void, size);
        let ref mut fresh0 =
            *status_prompt_hlist.offset(status_prompt_hsize.wrapping_sub(1 as
                                                                             libc::c_int
                                                                             as
                                                                             libc::c_uint)
                                            as isize);
    ...
    status_prompt_hlist =
        xreallocarray(status_prompt_hlist as *mut libc::c_void,
                      status_prompt_hsize.wrapping_add(1 as libc::c_int as
                                                           libc::c_uint) as
                          size_t,
 ...
 -> *mut *mut libc::c_char {
    ...
    *size = 0 as libc::c_int as u_int;
    ...
    while !(*cmdent).is_null() {
        ...
        if !(**cmdent).alias.is_null() &&
               strncmp((**cmdent).alias, s, slen) == 0 as libc::c_int {
            list =
                xreallocarray(list as *mut libc::c_void,
                              (*size).wrapping_add(1 as libc::c_int as
                                                       libc::c_uint) as
    ...
    if !o.is_null() {
        ...
        while !a.is_null() {
            ...
            if !cp.is_null() {
                valuelen =
                    cp.wrapping_offset_from(value) as libc::c_long as size_t;
                if !(slen > valuelen ||
                         strncmp(value, s, slen) != 0 as libc::c_int) {
                    list =
                        xreallocarray(list as *mut libc::c_void,
                                      (*size).wrapping_add(1 as libc::c_int as
                                                               libc::c_uint)
 ...
 -> *mut libc::c_char {
    ...
    while i < size {
        ...
        while j > 0 as libc::c_int as libc::c_ulong {
            if *out.offset(j.wrapping_sub(1 as libc::c_int as libc::c_ulong)
                               as isize) as libc::c_int !=
                   *(*list.offset(i as
                                      isize)).offset(j.wrapping_sub(1 as
                                                                        libc::c_int
                                                                        as
                                                                        libc::c_ulong)
                                                         as isize) as
                       libc::c_int {
                *out.offset(j.wrapping_sub(1 as libc::c_int as libc::c_ulong)
...
unsafe extern "C" fn status_prompt_menu_callback(mut menu: *mut menu,
                                                 mut idx: u_int,
                                                 mut key: key_code,
                                                 mut data:
                                                     *mut libc::c_void) {
    ...
    if key != 0xff000000000 as libc::c_ulonglong {
        idx =
            (idx as libc::c_uint).wrapping_add((*spm).start) as u_int as
                u_int;
...
unsafe extern "C" fn status_prompt_complete_list_menu(mut c: *mut client,
                                                      mut list:
                                                          *mut *mut libc::c_char,
                                                      mut size: u_int,
                                                      mut offset: u_int,
 ...
 -> libc::c_int {
    ...
    let mut i: u_int = 0;
    let mut py: u_int = 0;
    if size <= 1 as libc::c_int as libc::c_uint { return 0 as libc::c_int }
    if (*c).tty.sy.wrapping_sub(lines) < 3 as libc::c_int as libc::c_uint {
        return 0 as libc::c_int
    }
    spm =
        xmalloc(::std::mem::size_of::<status_prompt_menu>() as libc::c_ulong)
    ...
    (*spm).flag = flag;
    height =
        (*c).tty.sy.wrapping_sub(lines).wrapping_sub(2 as libc::c_int as
                                                         libc::c_uint);
    ...
    while i < size {
        ...
        item.key =
            ('0' as i32 as
                 libc::c_uint).wrapping_add(i.wrapping_sub((*spm).start)) as
                key_code;
        item.command = 0 as *const libc::c_char;
        menu_add_item(menu, &mut item, 0 as *mut cmdq_item, 0 as *mut client,
    ...
    if options_get_number((*(*c).session).options,
        ...
        py =
            (*c).tty.sy.wrapping_sub(3 as libc::c_int as
                                         libc::c_uint).wrapping_sub(height)
    }
    offset =
        (offset as
             libc::c_uint).wrapping_add(utf8_cstrwidth((*c).prompt_string)) as
            u_int as u_int;
    ...
    if menu_display(menu, 0x1 as libc::c_int | 0x2 as libc::c_int,
                    0 as *mut cmdq_item, offset, py, c,
                    0 as *mut cmd_find_state,
                    Some(status_prompt_menu_callback as
...
/* Show complete word menu. */
unsafe extern "C" fn status_prompt_complete_window_menu(mut c: *mut client,
                                                        mut s: *mut session,
                                                        mut word:
                                                            *const libc::c_char,
                                                        mut offset: u_int,
 ...
 -> *mut libc::c_char {
    ...
    while !wl.is_null() {
        ...
        } else { current_block_26 = 13797916685926291137; }
        match current_block_26 {
            13797916685926291137 => {
                ...
                if (*c).prompt_flags & 0x20 as libc::c_int != 0 {
                    ...
                    let fresh13 = size;
                    size = size.wrapping_add(1);
                    xasprintf(&mut *list.offset(fresh13 as isize) as
                                  *mut *mut libc::c_char,
                              b"%d\x00" as *const u8 as *const libc::c_char,
                              (*wl).idx);
                } else {
                    ...
                    let fresh14 = size;
                    size = size.wrapping_add(1);
                    xasprintf(&mut *list.offset(fresh14 as isize) as
                                  *mut *mut libc::c_char,
                ...
                item.key =
                    ('0' as i32 as
                         libc::c_uint).wrapping_add(size).wrapping_sub(1 as
                                                                           libc::c_int
                                                                           as
                                                                           libc::c_uint)
                        as key_code;
                item.command = 0 as *const libc::c_char;
                menu_add_item(menu, &mut item, 0 as *mut cmdq_item,
                              0 as *mut client, 0 as *mut cmd_find_state);
                free(tmp as *mut libc::c_void);
    ...
    if size == 1 as libc::c_int as libc::c_uint {
        ...
        if flag as libc::c_int != '\u{0}' as i32 {
            ...
            free(*list.offset(0 as libc::c_int as isize) as
                     *mut libc::c_void);
        } else { tmp = *list.offset(0 as libc::c_int as isize) }
...
/* Sort complete list. */
unsafe extern "C" fn status_prompt_complete_sort(mut a: *const libc::c_void,
...
/* Complete a session. */
unsafe extern "C" fn status_prompt_complete_session(mut list:
    ...
    while !loop_0.is_null() {
        if *s as libc::c_int == '\u{0}' as i32 ||
            ...
            *list =
            ...
            let fresh15 = *size;
            *size = (*size).wrapping_add(1);
            xasprintf(&mut *(*list).offset(fresh15 as isize) as
                          *mut *mut libc::c_char,
                      b"%s:\x00" as *const u8 as *const libc::c_char,
                      (*loop_0).name);
        } else if *s as libc::c_int == '$' as i32 {
            xsnprintf(n.as_mut_ptr(),
            ...
            if *s.offset(1 as libc::c_int as isize) as libc::c_int ==
                   '\u{0}' as i32 ||
                   strncmp(n.as_mut_ptr(),
                           s.offset(1 as libc::c_int as isize),
                           strlen(s).wrapping_sub(1 as libc::c_int as
                                                      libc::c_ulong)) ==
                       0 as libc::c_int {
                *list =
                    xreallocarray(*list as *mut libc::c_void,
                ...
                let fresh16 = *size;
                *size = (*size).wrapping_add(1);
                xasprintf(&mut *(*list).offset(fresh16 as isize) as
                              *mut *mut libc::c_char,
                          b"$%s:\x00" as *const u8 as *const libc::c_char,
                          n.as_mut_ptr());
            }
...
/* Complete word. */
unsafe extern "C" fn status_prompt_complete(mut c: *mut client,
 ...
 -> *mut libc::c_char {
    ...
    if *word as libc::c_int == '\u{0}' as i32 &&
           (*c).prompt_flags & (0x40 as libc::c_int | 0x20 as libc::c_int) ==
               0 as libc::c_int {
        return 0 as *mut libc::c_char
    }
    if (*c).prompt_flags & (0x40 as libc::c_int | 0x20 as libc::c_int) ==
           0 as libc::c_int &&
           strncmp(word, b"-t\x00" as *const u8 as *const libc::c_char,
                   2 as libc::c_int as libc::c_ulong) != 0 as libc::c_int &&
           strncmp(word, b"-s\x00" as *const u8 as *const libc::c_char,
                   2 as libc::c_int as libc::c_ulong) != 0 as libc::c_int {
        list =
            status_prompt_complete_list(&mut size, word,
                                        (offset ==
        ...
        if (*c).prompt_flags & 0x20 as libc::c_int != 0 {
            out =
                status_prompt_complete_window_menu(c, (*c).session, s, offset,
                                                   '\u{0}' as i32 as
                                                       libc::c_char)
        } else {
            ...
            if colon.is_null() {
                out =
                    status_prompt_complete_session(&mut list, &mut size, s,
                                                   flag)
            } else if strchr(colon.offset(1 as libc::c_int as isize),
                             '.' as i32).is_null() {
                ...
                match current_block {
                    ...
                    _ => {
                        out =
                            status_prompt_complete_window_menu(c, session,
                                                               colon.offset(1
                                                                                as
                                                                                libc::c_int
                                                                                as
    ...
    if size != 0 as libc::c_int as libc::c_uint {
        qsort(list as *mut libc::c_void, size as size_t,
              ::std::mem::size_of::<*mut libc::c_char>() as libc::c_ulong,
              Some(status_prompt_complete_sort as
                       unsafe extern "C" fn(_: *const libc::c_void,
                                            _: *const libc::c_void)
                           -> libc::c_int));
        i = 0 as libc::c_int as u_int;
        while i < size {
            log_debug(b"complete %u: %s\x00" as *const u8 as
                          *const libc::c_char, i, *list.offset(i as isize));
            i = i.wrapping_add(1)
        }
    }
    ...
    if !out.is_null() ||
           status_prompt_complete_list_menu(c, list, size, offset, flag) == 0
       {
        i = 0 as libc::c_int as u_int;
        while i < size {
