    ...
    unsafe {
        {
            let mut init =
                cmd_entry{name:
                              b"choose-tree\x00" as *const u8 as
                                  *const libc::c_char,
                          ...
                          usage:
                              b"[-GNrswZ] [-F format] [-f filter] [-O sort-order] [-t target-pane] [template]\x00"
    ...
    unsafe {
        {
            let mut init =
                cmd_entry{name:
                              b"choose-client\x00" as *const u8 as
                                  *const libc::c_char,
                          alias: 0 as *const libc::c_char,
                          args:
                              {
                          ...
                          usage:
                              b"[-NrZ] [-F format] [-f filter] [-O sort-order] [-t target-pane] [template]\x00"
                                  as *const u8 as *const libc::c_char,
                          source:
                              cmd_entry_flag{flag: 0,
                                             type_0: CMD_FIND_PANE,
    ...
    unsafe {
        {
            let mut init =
                cmd_entry{name:
                              b"choose-buffer\x00" as *const u8 as
                                  *const libc::c_char,
                          alias: 0 as *const libc::c_char,
                          args:
                              {
    ...
    unsafe {
        {
            let mut init =
                cmd_entry{name:
                              b"customize-mode\x00" as *const u8 as
                                  *const libc::c_char,
                          alias: 0 as *const libc::c_char,
                          args:
                              {
                          ...
                          usage:
                              b"[-NZ] [-F format] [-f filter] [-t target-pane]\x00"
                                  as *const u8 as *const libc::c_char,
                          source:
                              cmd_entry_flag{flag: 0,
                                             type_0: CMD_FIND_PANE,
 ...
 * Enter a mode.
 */
unsafe extern "C" fn cmd_choose_tree_exec(mut self_0: *mut cmd,
                                          mut item: *mut cmdq_item)
 -> cmd_retval {
    let mut args: *mut args = cmd_get_args(self_0);
    let mut target: *mut cmd_find_state = cmdq_get_target(item);
    let mut wp: *mut window_pane = (*target).wp;
    let mut mode: *const window_mode = 0 as *const window_mode;
    if cmd_get_entry(self_0) == &cmd_choose_buffer_entry as *const cmd_entry {
        if paste_get_top(0 as *mut *const libc::c_char).is_null() {
            return CMD_RETURN_NORMAL
        }
        mode = &window_buffer_mode
    } else if cmd_get_entry(self_0) ==
    ...
    } else { mode = &window_tree_mode }
    window_pane_set_mode(wp, 0 as *mut window_pane, mode, target, args);
    return CMD_RETURN_NORMAL;
}
