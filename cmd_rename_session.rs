    ...
    unsafe {
        {
            let mut init =
                cmd_entry{name:
                              b"rename-session\x00" as *const u8 as
                                  *const libc::c_char,
                          alias:
                          ...
                          usage:
                              b"[-t target-session] new-name\x00" as *const u8
                          ...
                          exec:
                              Some(cmd_rename_session_exec as
 ...
 * Change session name.
 */
unsafe extern "C" fn cmd_rename_session_exec(mut self_0: *mut cmd,
 ...
 -> cmd_retval {
    ...
    notify_session(b"session-renamed\x00" as *const u8 as *const libc::c_char,
                   s);
    return CMD_RETURN_NORMAL;
}
