    ...
    unsafe {
        {
            let mut init =
                cmd_entry{name:
                              b"respawn-pane\x00" as *const u8 as
                                  *const libc::c_char,
                          alias:
                              b"respawnp\x00" as *const u8 as
                                  *const libc::c_char,
                          args:
                              {
                                  let mut init =
                          ...
                          usage:
                              b"[-k] [-c start-directory] [-e environment] [-t target-pane] [command]\x00"
 ...
 */
unsafe extern "C" fn cmd_respawn_pane_exec(mut self_0: *mut cmd,
 ...
 -> cmd_retval {
    ...
    if spawn_pane(&mut sc, &mut cause).is_null() {
        cmdq_error(item,
                   b"respawn pane failed: %s\x00" as *const u8 as
