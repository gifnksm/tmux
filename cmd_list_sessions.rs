    ...
    unsafe {
        {
            let mut init =
                cmd_entry{name:
                              b"list-sessions\x00" as *const u8 as
                                  *const libc::c_char,
                          alias:
                          ...
                          usage:
                              b"[-F format] [-f filter]\x00" as *const u8 as
                                  *const libc::c_char,
                          source:
                          ...
                          exec:
                              Some(cmd_list_sessions_exec as
...
unsafe extern "C" fn cmd_list_sessions_exec(mut self_0: *mut cmd,
 ...
 -> cmd_retval {
    ...
    while !s.is_null() {
        ...
        format_defaults(ft, 0 as *mut client, s, 0 as *mut winlink,
