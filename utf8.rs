...
unsafe extern "C" fn utf8_data_cmp(mut ui1: *mut utf8_item,
                                   mut ui2: *mut utf8_item) -> libc::c_int {
    ...
    return memcmp((*ui1).data.as_mut_ptr() as *const libc::c_void,
                  (*ui2).data.as_mut_ptr() as *const libc::c_void,
                  (*ui1).size as libc::c_ulong);
}
unsafe extern "C" fn utf8_data_tree_RB_FIND(mut head: *mut utf8_data_tree,
...
unsafe extern "C" fn utf8_data_tree_RB_INSERT_COLOR(mut head:
                                                        *mut utf8_data_tree,
                                                    mut elm: *mut utf8_item) {
    ...
    loop  {
        ...
        if !(!parent.is_null() &&
                 (*parent).data_entry.rbe_color == 1 as libc::c_int) {
            break ;
        }
        ...
        if parent == (*gparent).data_entry.rbe_left {
            ...
            if !tmp.is_null() &&
                   (*tmp).data_entry.rbe_color == 1 as libc::c_int {
                ...
                if (*parent).data_entry.rbe_right == elm {
                    ...
                    (*parent).data_entry.rbe_right =
                        (*tmp).data_entry.rbe_left;
                    if !(*parent).data_entry.rbe_right.is_null() {
                        (*(*tmp).data_entry.rbe_left).data_entry.rbe_parent =
                            parent
                    }
                    (*tmp).data_entry.rbe_parent =
                        (*parent).data_entry.rbe_parent;
                    if !(*tmp).data_entry.rbe_parent.is_null() {
                        if parent ==
                               (*(*parent).data_entry.rbe_parent).data_entry.rbe_left
                           {
                            (*(*parent).data_entry.rbe_parent).data_entry.rbe_left
                                = tmp
                        } else {
                            (*(*parent).data_entry.rbe_parent).data_entry.rbe_right
                                = tmp
                        }
                ...
                if !(*gparent).data_entry.rbe_left.is_null() {
                    (*(*tmp).data_entry.rbe_right).data_entry.rbe_parent =
                        gparent
                }
                (*tmp).data_entry.rbe_parent =
                    (*gparent).data_entry.rbe_parent;
                if !(*tmp).data_entry.rbe_parent.is_null() {
                    if gparent ==
                           (*(*gparent).data_entry.rbe_parent).data_entry.rbe_left
                       {
                        (*(*gparent).data_entry.rbe_parent).data_entry.rbe_left
                            = tmp
                    } else {
                        (*(*gparent).data_entry.rbe_parent).data_entry.rbe_right
                            = tmp
                    }
                } else { (*head).rbh_root = tmp }
            ...
            if !tmp.is_null() &&
                ...
                if (*parent).data_entry.rbe_left == elm {
                    ...
                    (*parent).data_entry.rbe_left =
                        (*tmp).data_entry.rbe_right;
...
unsafe extern "C" fn utf8_data_tree_RB_INSERT(mut head: *mut utf8_data_tree,
                                              mut elm: *mut utf8_item)
 -> *mut utf8_item {
    let mut tmp: *mut utf8_item = 0 as *mut utf8_item;
    let mut parent: *mut utf8_item = 0 as *mut utf8_item;
    ...
    if !parent.is_null() {
        ...
        } else { (*parent).data_entry.rbe_right = elm }
...
static mut utf8_data_tree: utf8_data_tree =
    {
        let mut init =
            utf8_data_tree{rbh_root:
                               0 as *const utf8_item as *mut utf8_item,};
        init
    };
unsafe extern "C" fn utf8_index_cmp(mut ui1: *mut utf8_item,
                                    mut ui2: *mut utf8_item) -> libc::c_int {
    if (*ui1).index < (*ui2).index { return -(1 as libc::c_int) }
    if (*ui1).index > (*ui2).index { return 1 as libc::c_int }
    return 0 as libc::c_int;
}
unsafe extern "C" fn utf8_index_tree_RB_FIND(mut head: *mut utf8_index_tree,
                                             mut elm: *mut utf8_item)
 -> *mut utf8_item {
    let mut tmp: *mut utf8_item = (*head).rbh_root;
    let mut comp: libc::c_int = 0;
...
unsafe extern "C" fn utf8_index_tree_RB_INSERT(mut head: *mut utf8_index_tree,
                                               mut elm: *mut utf8_item)
 -> *mut utf8_item {
    let mut tmp: *mut utf8_item = 0 as *mut utf8_item;
    let mut parent: *mut utf8_item = 0 as *mut utf8_item;
    ...
    if !parent.is_null() {
        ...
        } else { (*parent).index_entry.rbe_right = elm }
    } else { (*head).rbh_root = elm }
    utf8_index_tree_RB_INSERT_COLOR(head, elm);
    return 0 as *mut utf8_item;
}
unsafe extern "C" fn utf8_index_tree_RB_INSERT_COLOR(mut head:
                                                         *mut utf8_index_tree,
                                                     mut elm:
                                                         *mut utf8_item) {
    let mut parent: *mut utf8_item = 0 as *mut utf8_item;
    ...
    loop  {
        ...
        if !(!parent.is_null() &&
                 (*parent).index_entry.rbe_color == 1 as libc::c_int) {
            break ;
        }
        ...
        if parent == (*gparent).index_entry.rbe_left {
            ...
            if !tmp.is_null() &&
                   (*tmp).index_entry.rbe_color == 1 as libc::c_int {
                ...
                if (*parent).index_entry.rbe_right == elm {
                    ...
                    (*parent).index_entry.rbe_right =
                        (*tmp).index_entry.rbe_left;
                    if !(*parent).index_entry.rbe_right.is_null() {
                        (*(*tmp).index_entry.rbe_left).index_entry.rbe_parent
                            = parent
                    }
                    (*tmp).index_entry.rbe_parent =
                        (*parent).index_entry.rbe_parent;
                    if !(*tmp).index_entry.rbe_parent.is_null() {
                        if parent ==
                               (*(*parent).index_entry.rbe_parent).index_entry.rbe_left
                           {
                            (*(*parent).index_entry.rbe_parent).index_entry.rbe_left
                                = tmp
                        } else {
                            (*(*parent).index_entry.rbe_parent).index_entry.rbe_right
                                = tmp
                        }
                    } else { (*head).rbh_root = tmp }
                ...
                (*gparent).index_entry.rbe_left =
                    (*tmp).index_entry.rbe_right;
                if !(*gparent).index_entry.rbe_left.is_null() {
                    (*(*tmp).index_entry.rbe_right).index_entry.rbe_parent =
                        gparent
                }
                (*tmp).index_entry.rbe_parent =
                    (*gparent).index_entry.rbe_parent;
                if !(*tmp).index_entry.rbe_parent.is_null() {
                    if gparent ==
                           (*(*gparent).index_entry.rbe_parent).index_entry.rbe_left
                       {
                        (*(*gparent).index_entry.rbe_parent).index_entry.rbe_left
                            = tmp
                    } else {
                        (*(*gparent).index_entry.rbe_parent).index_entry.rbe_right
                            = tmp
                    }
                } else { (*head).rbh_root = tmp }
...
static mut utf8_index_tree: utf8_index_tree =
    {
        let mut init =
            utf8_index_tree{rbh_root:
                                0 as *const utf8_item as *mut utf8_item,};
        init
    };
static mut utf8_next_index: u_int = 0;
/* Get a UTF-8 item from data. */
unsafe extern "C" fn utf8_item_by_data(mut data: *const libc::c_char,
                                       mut size: size_t) -> *mut utf8_item {
    let mut ui: utf8_item =
        utf8_item{index_entry:
                      C2RustUnnamed_1{rbe_left: 0 as *mut utf8_item,
                                      rbe_right: 0 as *mut utf8_item,
                                      rbe_parent: 0 as *mut utf8_item,
                                      rbe_color: 0,},
                  index: 0,
                  data_entry:
                      C2RustUnnamed_0{rbe_left: 0 as *mut utf8_item,
                                      rbe_right: 0 as *mut utf8_item,
                                      rbe_parent: 0 as *mut utf8_item,
                                      rbe_color: 0,},
                  data: [0; 21],
                  size: 0,};
    memcpy(ui.data.as_mut_ptr() as *mut libc::c_void,
...
/* Add a UTF-8 item. */
unsafe extern "C" fn utf8_put_item(mut data: *const libc::c_char,
                                   mut size: size_t, mut index: *mut u_int)
 -> libc::c_int {
    let mut ui: *mut utf8_item = 0 as *mut utf8_item;
    ui = utf8_item_by_data(data, size);
    if !ui.is_null() {
        *index = (*ui).index;
        log_debug(b"%s: found %.*s = %u\x00" as *const u8 as
                      *const libc::c_char,
                  (*::std::mem::transmute::<&[u8; 14],
                                            &[libc::c_char; 14]>(b"utf8_put_item\x00")).as_ptr(),
                  size as libc::c_int, data, *index);
        return 0 as libc::c_int
    }
    if utf8_next_index ==
           (0xffffff as libc::c_int + 1 as libc::c_int) as libc::c_uint {
        return -(1 as libc::c_int)
    }
    ui =
        xcalloc(1 as libc::c_int as size_t,
                ::std::mem::size_of::<utf8_item>() as libc::c_ulong) as
            *mut utf8_item;
    ...
    *index = (*ui).index;
    log_debug(b"%s: added %.*s = %u\x00" as *const u8 as *const libc::c_char,
              (*::std::mem::transmute::<&[u8; 14],
                                        &[libc::c_char; 14]>(b"utf8_put_item\x00")).as_ptr(),
              size as libc::c_int, data, *index);
    return 0 as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn utf8_from_data(mut ud: *const utf8_data,
                                        mut uc: *mut utf8_char)
 -> utf8_state {
    let mut current_block: u64;
    let mut index: u_int = 0;
    if (*ud).width as libc::c_int > 2 as libc::c_int {
        fatalx(b"invalid UTF-8 width: %u\x00" as *const u8 as
                   *const libc::c_char, (*ud).width as libc::c_int);
    }
    if !((*ud).size as libc::c_int > 21 as libc::c_int) {
        if (*ud).size as libc::c_int <= 3 as libc::c_int {
            index =
                ((*ud).data[2 as libc::c_int as usize] as utf8_char) <<
                    16 as libc::c_int |
                    ((*ud).data[1 as libc::c_int as usize] as utf8_char) <<
                        8 as libc::c_int |
                    (*ud).data[0 as libc::c_int as usize] as utf8_char;
            current_block = 10879442775620481940;
        } else if utf8_put_item((*ud).data.as_ptr() as *const libc::c_char,
                                (*ud).size as size_t, &mut index) !=
                      0 as libc::c_int {
        ...
        match current_block {
            ...
            _ => {
                *uc =
                    ((*ud).size as utf8_char) << 24 as libc::c_int |
                        ((*ud).width as
                             utf8_char).wrapping_add(1 as libc::c_int as
                                                         libc::c_uint) <<
                            29 as libc::c_int | index;
                log_debug(b"%s: (%d %d %.*s) -> %08x\x00" as *const u8 as
                              *const libc::c_char,
                          (*::std::mem::transmute::<&[u8; 15],
                                                    &[libc::c_char; 15]>(b"utf8_from_data\x00")).as_ptr(),
    ...
    if (*ud).width as libc::c_int == 0 as libc::c_int {
        *uc =
            (0 as libc::c_int as utf8_char) << 24 as libc::c_int |
                (0 as libc::c_int as
                     utf8_char).wrapping_add(1 as libc::c_int as libc::c_uint)
                    << 29 as libc::c_int
    } else if (*ud).width as libc::c_int == 1 as libc::c_int {
        *uc =
            (1 as libc::c_int as utf8_char) << 24 as libc::c_int |
                (1 as libc::c_int as
                     utf8_char).wrapping_add(1 as libc::c_int as libc::c_uint)
                    << 29 as libc::c_int | 0x20 as libc::c_int as libc::c_uint
    } else {
        *uc =
            (1 as libc::c_int as utf8_char) << 24 as libc::c_int |
                (1 as libc::c_int as
...
#[no_mangle]
pub unsafe extern "C" fn utf8_to_data(mut uc: utf8_char,
                                      mut ud: *mut utf8_data) {
    let mut ui: *mut utf8_item = 0 as *mut utf8_item;
    let mut index: u_int = 0;
    memset(ud as *mut libc::c_void, 0 as libc::c_int,
           ::std::mem::size_of::<utf8_data>() as libc::c_ulong);
    (*ud).have =
        (uc >> 24 as libc::c_int & 0x1f as libc::c_int as libc::c_uint) as
            u_char;
    (*ud).size = (*ud).have;
    (*ud).width =
        (uc >>
             29 as libc::c_int).wrapping_sub(1 as libc::c_int as libc::c_uint)
            as u_char;
    if (*ud).size as libc::c_int <= 3 as libc::c_int {
        (*ud).data[2 as libc::c_int as usize] =
            (uc >> 16 as libc::c_int) as u_char;
        (*ud).data[1 as libc::c_int as usize] =
            (uc >> 8 as libc::c_int & 0xff as libc::c_int as libc::c_uint) as
                u_char;
        (*ud).data[0 as libc::c_int as usize] =
            (uc & 0xff as libc::c_int as libc::c_uint) as u_char
    } else {
        index = uc & 0xffffff as libc::c_int as libc::c_uint;
        ui = utf8_item_by_index(index);
        if ui.is_null() {
            memset((*ud).data.as_mut_ptr() as *mut libc::c_void, ' ' as i32,
    ...
    log_debug(b"%s: %08x -> (%d %d %.*s)\x00" as *const u8 as
                  *const libc::c_char,
              (*::std::mem::transmute::<&[u8; 13],
                                        &[libc::c_char; 13]>(b"utf8_to_data\x00")).as_ptr(),
              uc, (*ud).width as libc::c_int, (*ud).size as libc::c_int,
...
pub unsafe extern "C" fn utf8_build_one(mut ch: u_char) -> utf8_char {
    return (1 as libc::c_int as utf8_char) << 24 as libc::c_int |
               (1 as libc::c_int as
                    utf8_char).wrapping_add(1 as libc::c_int as libc::c_uint)
                   << 29 as libc::c_int | ch as libc::c_uint;
}
    ...
    static mut empty: utf8_data =
        {
            let mut init =
                utf8_data{data:
                              [0 as libc::c_int as u_char, 0, 0, 0, 0, 0, 0,
...
unsafe extern "C" fn utf8_width(mut ud: *mut utf8_data,
                                mut width: *mut libc::c_int) -> utf8_state {
    let mut wc: wchar_t = 0;
    match mbtowc(&mut wc, (*ud).data.as_mut_ptr() as *const libc::c_char,
                 (*ud).size as size_t) {
        -1 => {
            log_debug(b"UTF-8 %.*s, mbtowc() %d\x00" as *const u8 as
                          *const libc::c_char, (*ud).size as libc::c_int,
                      (*ud).data.as_mut_ptr(), *__errno_location());
    ...
    *width = wcwidth(wc);
    ...
    log_debug(b"UTF-8 %.*s, wcwidth() %d\x00" as *const u8 as
                  *const libc::c_char, (*ud).size as libc::c_int,
              (*ud).data.as_mut_ptr(), *width);
    /*
...
pub unsafe extern "C" fn utf8_append(mut ud: *mut utf8_data, mut ch: u_char)
 -> utf8_state {
    ...
    if (*ud).width as libc::c_int == 0xff as libc::c_int { return UTF8_ERROR }
    if utf8_width(ud, &mut width) as libc::c_uint !=
 ...
 -> libc::c_int {
    ...
    while src < end {
        ...
        if *src.offset(0 as libc::c_int as isize) as libc::c_int == '$' as i32
            ...
            if *(*__ctype_b_loc()).offset(*src.offset(1 as libc::c_int as
                                                          isize) as u_char as
...
pub unsafe extern "C" fn utf8_stravis(mut dst: *mut *mut libc::c_char,
    ...
    buf =
        xreallocarray(0 as *mut libc::c_void, 4 as libc::c_int as size_t,
                      strlen(src).wrapping_add(1 as libc::c_int as
                                                   libc::c_ulong)) as
            *mut libc::c_char;
    len = utf8_strvis(buf, src, strlen(src), flag);
    *dst =
        xrealloc(buf as *mut libc::c_void, (len + 1 as libc::c_int) as size_t)
            as *mut libc::c_char;
    return len;
}
/* Same as utf8_strvis but allocate the buffer. */
#[no_mangle]
pub unsafe extern "C" fn utf8_stravisx(mut dst: *mut *mut libc::c_char,
                                       mut src: *const libc::c_char,
                                       mut srclen: size_t,
                                       mut flag: libc::c_int) -> libc::c_int {
    let mut buf: *mut libc::c_char = 0 as *mut libc::c_char;
    ...
    while *src as libc::c_int != '\u{0}' as i32 {
        ...
        if more as libc::c_uint == UTF8_MORE as libc::c_int as libc::c_uint {
            ...
            if more as libc::c_uint ==
                ...
                continue ;
            } else { src = src.offset(-(ud.have as libc::c_int as isize)) }
        }
...
pub unsafe extern "C" fn utf8_strwidth(mut s: *const utf8_data,
    ...
    while (*s.offset(i as isize)).size as libc::c_int != 0 as libc::c_int {
        if n != -(1 as libc::c_int) as libc::c_long && n == i { break ; }
        width =
            (width as
    ...
    while *src as libc::c_int != '\u{0}' as i32 {
        ...
        if more as libc::c_uint == UTF8_MORE as libc::c_int as libc::c_uint {
            loop  {
                ...
                more =
                    utf8_append(&mut *dst.offset(n as isize), *src as u_char)
            }
            if more as libc::c_uint ==
                   UTF8_DONE as libc::c_int as libc::c_uint {
                n = n.wrapping_add(1);
                ...
                src =
                    src.offset(-((*dst.offset(n as isize)).have as libc::c_int
                                     as isize))
            }
        }
    ...
    while *s as libc::c_int != '\u{0}' as i32 {
        ...
        if more as libc::c_uint == UTF8_MORE as libc::c_int as libc::c_uint {
            ...
            if more as libc::c_uint ==
                ...
                width =
                    (width as
                         libc::c_uint).wrapping_add(tmp.width as libc::c_uint)
                        as u_int as u_int;
                continue ;
            } else { s = s.offset(-(tmp.have as libc::c_int as isize)) }
        }
...
pub unsafe extern "C" fn utf8_padcstr(mut s: *const libc::c_char,
    ...
    slen = strlen(s);
    out =
        xmalloc(slen.wrapping_add(1 as libc::c_int as
...
#[no_mangle]
pub unsafe extern "C" fn utf8_rpadcstr(mut s: *const libc::c_char,
                                       mut width: u_int)
 -> *mut libc::c_char {
    let mut slen: size_t = 0;
    let mut out: *mut libc::c_char = 0 as *mut libc::c_char;
    ...
    memcpy(out.offset(i as isize) as *mut libc::c_void,
           s as *const libc::c_void, slen);
    *out.offset((i as libc::c_ulong).wrapping_add(slen) as isize) =
        '\u{0}' as i32 as libc::c_char;
    return out;
}
#[no_mangle]
pub unsafe extern "C" fn utf8_cstrhas(mut s: *const libc::c_char,
 ...
 -> libc::c_int {
    ...
    while (*loop_0).size as libc::c_int != 0 as libc::c_int {
        if !((*loop_0).size as libc::c_int != (*ud).size as libc::c_int) {
            if memcmp((*loop_0).data.as_mut_ptr() as *const libc::c_void,
                      (*ud).data.as_ptr() as *const libc::c_void,
                      (*loop_0).size as libc::c_ulong) == 0 as libc::c_int {
