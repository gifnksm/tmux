...
extern "C" {
    ...
    #[no_mangle]
    fn tty_term_string1(_: *mut tty_term, _: tty_code_code, _: libc::c_int) -> *const libc::c_char;
    #[no_mangle]
    fn tty_term_string2(
        _: *mut tty_term,
        _: tty_code_code,
    ...
    #[no_mangle]
    fn style_add(_: *mut grid_cell, _: *mut options, _: *const libc::c_char, _: *mut format_tree);
    #[no_mangle]
...
pub unsafe extern "C" fn tty_stop_tty(mut tty: *mut tty) {
    ...
    if tty_term_has((*tty).term, TTYC_SS) != 0 && (*tty).cstyle != 0 as libc::c_int as libc::c_uint
    {
...
pub unsafe extern "C" fn tty_update_mode(
    ...
    if changed & (0x20 as libc::c_int | 0x40 as libc::c_int | 0x1000 as libc::c_int) != 0
        && tty_term_has((*tty).term, TTYC_KMOUS) != 0
    {
...
unsafe extern "C" fn tty_clear_line(
    ...
    if tty_fake_bce(tty, defaults, bg) == 0 {
        ...
        if px == 0 as libc::c_int as libc::c_uint && tty_term_has((*tty).term, TTYC_EL1) != 0 {
            tty_cursor(
                tty,
                px.wrapping_add(nx)
...
pub unsafe extern "C" fn tty_cmd_reverseindex(mut tty: *mut tty, mut ctx: *const tty_ctx) {
    ...
    if tty_term_has((*tty).term, TTYC_RI) != 0 {
        ...
        tty_putcode1(tty, TTYC_RIN, 1 as libc::c_int);
    };
}
#[no_mangle]
...
pub unsafe extern "C" fn tty_cmd_scrollup(mut tty: *mut tty, mut ctx: *const tty_ctx) {
    ...
    tty_region_pane(tty, ctx, (*ctx).orupper, (*ctx).orlower);
    tty_margin_pane(tty, ctx);
    if (*ctx).num == 1 as libc::c_int as libc::c_uint || tty_term_has((*tty).term, TTYC_INDN) == 0 {
        if (*(*tty).term).flags & 0x4 as libc::c_int == 0 {
...
unsafe extern "C" fn tty_margin(mut tty: *mut tty, mut rleft: u_int, mut rright: u_int) {
        ...
        && rright == (*tty).sx.wrapping_sub(1 as libc::c_int as libc::c_uint)
    {
        ...
        tty_putcode2(tty, TTYC_CMG, rleft as libc::c_int, rright as libc::c_int);
    }
    (*tty).cy = (2147483647 as libc::c_int as libc::c_uint)
        .wrapping_mul(2 as libc::c_uint)
        .wrapping_add(1 as libc::c_uint);
...
pub unsafe extern "C" fn tty_attributes(
    ...
    if changed
        ...
        != 0
    {
        if changed & 0x4 as libc::c_int != 0 || tty_term_has((*tty).term, TTYC_SMULX) == 0 {
...
unsafe extern "C" fn tty_try_colour(
    ...
    if colour & 0x1000000 as libc::c_int != 0 {
        if *type_0 as libc::c_int == '3' as i32 && tty_term_has((*tty).term, TTYC_SETAF) != 0 {
    ...
    if colour & 0x2000000 as libc::c_int != 0 {
        ...
        if *type_0 as libc::c_int == '3' as i32 && tty_term_has((*tty).term, TTYC_SETRGBF) != 0 {
            tty_putcode3(
                tty,
                TTYC_SETRGBF,
                r as libc::c_int,
