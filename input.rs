...
extern "C" {
    ...
    #[no_mangle]
    fn screen_write_collect_add(_: *mut screen_write_ctx,
                                _: *const grid_cell);
    #[no_mangle]
    ...
    #[no_mangle]
    fn screen_write_alternateon(_: *mut screen_write_ctx, _: *mut grid_cell,
                                _: libc::c_int);
    #[no_mangle]
    fn screen_write_clearscreen(_: *mut screen_write_ctx, _: u_int);
    #[no_mangle]
    fn screen_write_alternateoff(_: *mut screen_write_ctx, _: *mut grid_cell,
                                 _: libc::c_int);
    #[no_mangle]
    ...
    #[no_mangle]
    fn window_pane_update_used_data(_: *mut window_pane,
                                    _: *mut window_pane_offset, _: size_t);
    #[no_mangle]
    ...
    fn window_pane_get_new_data(_: *mut window_pane,
     ...
     -> *mut libc::c_void;
    #[no_mangle]
    fn screen_write_start_callback(_: *mut screen_write_ctx, _: *mut screen,
    ...
    unsafe {
        {
            let mut init =
                input_state{name:
                                b"ground\x00" as *const u8 as
                                    *const libc::c_char,
                            enter:
                                Some(input_ground as
    ...
    unsafe {
        {
            let mut init =
                input_state{name:
                                b"esc_enter\x00" as *const u8 as
                                    *const libc::c_char,
                            enter:
                                Some(input_clear as
                                         unsafe extern "C" fn(_:
                            ...
                            exit: None,
                            transitions:
                                input_state_esc_enter_table.as_ptr(),};
            init
        }
    };
    ...
    unsafe {
        {
            let mut init =
                input_state{name:
                            ...
                            exit: None,
                            transitions:
                                input_state_esc_intermediate_table.as_ptr(),};
            init
        }
    };
    ...
    unsafe {
        {
            let mut init =
                input_state{name:
                                b"csi_enter\x00" as *const u8 as
                                    *const libc::c_char,
                            enter:
                                Some(input_clear as
                                         unsafe extern "C" fn(_:
                            ...
                            exit: None,
                            transitions:
                                input_state_csi_enter_table.as_ptr(),};
            init
        }
    };
    ...
    unsafe {
        {
            let mut init =
                input_state{name:
                            ...
                            exit: None,
                            transitions:
                                input_state_csi_parameter_table.as_ptr(),};
            init
        }
    };
    ...
    unsafe {
        {
            let mut init =
                input_state{name:
                            ...
                            exit: None,
                            transitions:
                                input_state_csi_intermediate_table.as_ptr(),};
            init
        }
    };
    ...
    unsafe {
        {
            let mut init =
                input_state{name:
                                b"csi_ignore\x00" as *const u8 as
                                    *const libc::c_char,
                            enter: None,
                            exit: None,
                            transitions:
                                input_state_csi_ignore_table.as_ptr(),};
            init
        }
    };
    ...
    unsafe {
        {
            let mut init =
                input_state{name:
                                b"dcs_enter\x00" as *const u8 as
                                    *const libc::c_char,
                            enter:
                                Some(input_enter_dcs as
                                         unsafe extern "C" fn(_:
                                                                  *mut input_ctx)
                                             -> ()),
                            exit: None,
                            transitions:
                                input_state_dcs_enter_table.as_ptr(),};
            init
        }
    };
    ...
    unsafe {
        {
            let mut init =
                input_state{name:
                            ...
                            exit: None,
                            transitions:
                                input_state_dcs_parameter_table.as_ptr(),};
            init
        }
    };
    ...
    unsafe {
        {
            let mut init =
                input_state{name:
                            ...
                            exit: None,
                            transitions:
                                input_state_dcs_intermediate_table.as_ptr(),};
            init
        }
    };
    ...
    unsafe {
        {
            let mut init =
                input_state{name:
                            ...
                            exit: None,
                            transitions:
                                input_state_dcs_handler_table.as_ptr(),};
            init
        }
    };
    ...
    unsafe {
        {
            let mut init =
                input_state{name:
                                b"dcs_escape\x00" as *const u8 as
                                    *const libc::c_char,
                            enter: None,
                            exit: None,
                            transitions:
                                input_state_dcs_escape_table.as_ptr(),};
            init
        }
    };
    ...
    unsafe {
        {
            let mut init =
                input_state{name:
                                b"dcs_ignore\x00" as *const u8 as
                                    *const libc::c_char,
                            enter: None,
                            exit: None,
                            transitions:
                                input_state_dcs_ignore_table.as_ptr(),};
            init
        }
    };
    ...
    unsafe {
        {
            let mut init =
                input_state{name:
                                b"osc_string\x00" as *const u8 as
                                    *const libc::c_char,
                            enter:
                                Some(input_enter_osc as
                                         unsafe extern "C" fn(_:
                                                                  *mut input_ctx)
                                             -> ()),
                            exit:
                                Some(input_exit_osc as
                                         unsafe extern "C" fn(_:
                                                                  *mut input_ctx)
                                             -> ()),
                            transitions:
                                input_state_osc_string_table.as_ptr(),};
            init
        }
    };
    ...
    unsafe {
        {
            let mut init =
                input_state{name:
                                b"apc_string\x00" as *const u8 as
                                    *const libc::c_char,
                            enter:
                                Some(input_enter_apc as
                                         unsafe extern "C" fn(_:
                                                                  *mut input_ctx)
                                             -> ()),
                            exit:
                                Some(input_exit_apc as
                                         unsafe extern "C" fn(_:
                                                                  *mut input_ctx)
                                             -> ()),
                            transitions:
                                input_state_apc_string_table.as_ptr(),};
            init
        }
    };
            ...
            let mut init =
                input_state{name:
                                b"rename_string\x00" as *const u8 as
                                    *const libc::c_char,
                            enter:
                                Some(input_enter_rename as
                                         unsafe extern "C" fn(_:
                                                                  *mut input_ctx)
                                             -> ()),
                            exit:
                                Some(input_exit_rename as
                                         unsafe extern "C" fn(_:
                                                                  *mut input_ctx)
                                             -> ()),
                            transitions:
                                input_state_rename_string_table.as_ptr(),};
            init
        }
    };
    ...
    unsafe {
        {
            let mut init =
                input_state{name:
                                b"consume_st\x00" as *const u8 as
                                    *const libc::c_char,
                            enter:
                                Some(input_enter_rename as
                                         unsafe extern "C" fn(_:
                            ...
                            exit: None,
                            transitions:
                                input_state_consume_st_table.as_ptr(),};
            init
        }
    };
/* ground state table. */
static mut input_state_ground_table: [input_transition; 10] =
    unsafe {
        [{
             let mut init =
                 input_transition{first: 0x18 as libc::c_int,
                                  last: 0x18 as libc::c_int,
                                  handler:
                                      Some(input_c0_dispatch as
                                               unsafe extern "C" fn(_:
                                                                        *mut input_ctx)
                                                   -> libc::c_int),
                                  state:
                                      &input_state_ground as
                                          *const input_state,};
             init
         },
         {
             let mut init =
                 input_transition{first: 0x1a as libc::c_int,
         ...
         {
             let mut init =
                 input_transition{first: 0x1b as libc::c_int,
                                  last: 0x1b as libc::c_int,
                                  handler: None,
                                  state:
                                      &input_state_esc_enter as
                                          *const input_state,};
             init
         },
         {
             let mut init =
                 input_transition{first: 0 as libc::c_int,
         ...
         {
             let mut init =
                 input_transition{first: 0x19 as libc::c_int,
         ...
         {
             let mut init =
                 input_transition{first: 0x1c as libc::c_int,
         ...
         {
             let mut init =
                 input_transition{first: 0x20 as libc::c_int,
         ...
         {
             let mut init =
                 input_transition{first: 0x7f as libc::c_int,
         ...
         {
             let mut init =
                 input_transition{first: 0x80 as libc::c_int,
                                  last: 0xff as libc::c_int,
                                  handler:
                                      Some(input_top_bit_set as
                                               unsafe extern "C" fn(_:
                                                                        *mut input_ctx)
                                                   -> libc::c_int),
                                  state: 0 as *const input_state,};
         ...
         {
             let mut init =
                 input_transition{first: -(1 as libc::c_int),
...
static mut input_state_esc_enter_table: [input_transition; 23] =
    unsafe {
        [{
         ...
         {
             let mut init =
                 input_transition{first: 0x30 as libc::c_int,
                                  last: 0x4f as libc::c_int,
                                  handler:
                                      Some(input_esc_dispatch as
                                               unsafe extern "C" fn(_:
                                                                        *mut input_ctx)
                                                   -> libc::c_int),
                                  state:
         ...
         {
             let mut init =
                 input_transition{first: 0x50 as libc::c_int,
                                  last: 0x50 as libc::c_int,
                                  handler: None,
                                  state:
                                      &input_state_dcs_enter as
                                          *const input_state,};
             init
         },
         {
             let mut init =
                 input_transition{first: 0x51 as libc::c_int,
         ...
         {
             let mut init =
                 input_transition{first: 0x58 as libc::c_int,
                                  last: 0x58 as libc::c_int,
                                  handler: None,
                                  state:
                                      &input_state_consume_st as
                                          *const input_state,};
             init
         },
         {
             let mut init =
                 input_transition{first: 0x59 as libc::c_int,
         ...
         {
             let mut init =
                 input_transition{first: 0x5a as libc::c_int,
         ...
         {
             let mut init =
                 input_transition{first: 0x5b as libc::c_int,
                                  last: 0x5b as libc::c_int,
                                  handler: None,
                                  state:
                                      &input_state_csi_enter as
                                          *const input_state,};
             init
         },
         {
             let mut init =
                 input_transition{first: 0x5c as libc::c_int,
         ...
         {
             let mut init =
                 input_transition{first: 0x5d as libc::c_int,
                                  last: 0x5d as libc::c_int,
                                  handler: None,
                                  state:
                                      &input_state_osc_string as
                                          *const input_state,};
             init
         },
         {
             let mut init =
                 input_transition{first: 0x5e as libc::c_int,
         ...
         {
             let mut init =
                 input_transition{first: 0x5f as libc::c_int,
                                  last: 0x5f as libc::c_int,
                                  handler: None,
                                  state:
                                      &input_state_apc_string as
                                          *const input_state,};
             init
         },
         {
             let mut init =
                 input_transition{first: 0x60 as libc::c_int,
         ...
         {
             let mut init =
                 input_transition{first: 0x6b as libc::c_int,
         ...
         {
             let mut init =
                 input_transition{first: 0x6c as libc::c_int,
                                  last: 0x7e as libc::c_int,
                                  handler:
                                      Some(input_esc_dispatch as
                                               unsafe extern "C" fn(_:
...
static mut input_state_csi_enter_table: [input_transition; 14] =
    unsafe {
        [{
         ...
         {
             let mut init =
                 input_transition{first: 0x3a as libc::c_int,
         ...
         {
             let mut init =
                 input_transition{first: 0x3b as libc::c_int,
         ...
         {
             let mut init =
                 input_transition{first: 0x3c as libc::c_int,
         ...
         {
             let mut init =
                 input_transition{first: 0x40 as libc::c_int,
                                  last: 0x7e as libc::c_int,
                                  handler:
                                      Some(input_csi_dispatch as
                                               unsafe extern "C" fn(_:
                                                                        *mut input_ctx)
                                                   -> libc::c_int),
                                  state:
...
static mut input_state_osc_string_table: [input_transition; 10] =
    unsafe {
        [{
         ...
         {
             let mut init =
                 input_transition{first: 0x7 as libc::c_int,
                                  last: 0x7 as libc::c_int,
                                  handler:
                                      Some(input_end_bel as
                                               unsafe extern "C" fn(_:
                                                                        *mut input_ctx)
                                                   -> libc::c_int),
                                  state:
         ...
         {
             let mut init =
                 input_transition{first: 0x8 as libc::c_int,
                                  last: 0x17 as libc::c_int,
                                  handler: None,
                                  state: 0 as *const input_state,};
             init
...
unsafe extern "C" fn input_table_compare(mut key: *const libc::c_void,
 ...
 -> libc::c_int {
    ...
    if (*ictx).ch != (*entry).ch { return (*ictx).ch - (*entry).ch }
...
unsafe extern "C" fn input_timer_callback(mut fd: libc::c_int,
    ...
    log_debug(b"%s: %s expired\x00" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn input_restore_state(mut ictx: *mut input_ctx) {
    let mut sctx: *mut screen_write_ctx = &mut (*ictx).ctx;
    memcpy(&mut (*ictx).cell as *mut input_cell as *mut libc::c_void,
    ...
    } else { screen_write_mode_clear(sctx, 0x2000 as libc::c_int); }
    screen_write_cursormove(sctx, (*ictx).old_cx as libc::c_int,
                            (*ictx).old_cy as libc::c_int, 0 as libc::c_int);
}
...
pub unsafe extern "C" fn input_init(mut wp: *mut window_pane,
 ...
 -> *mut input_ctx {
    ...
    event_set(&mut (*ictx).timer, -(1 as libc::c_int),
              0 as libc::c_int as libc::c_short,
              Some(input_timer_callback as
...
pub unsafe extern "C" fn input_free(mut ictx: *mut input_ctx) {
    ...
    while i < (*ictx).param_list_len {
        if (*ictx).param_list[i as usize].type_0 as libc::c_uint ==
            ...
            free((*ictx).param_list[i as usize].c2rust_unnamed.str_0 as
                     *mut libc::c_void);
        }
        i = i.wrapping_add(1)
    }
...
#[no_mangle]
pub unsafe extern "C" fn input_reset(mut ictx: *mut input_ctx,
    ...
    if clear != 0 && !wp.is_null() {
        ...
        } else { screen_write_start(sctx, &mut (*wp).base); }
...
/* Return pending data. */
#[no_mangle]
pub unsafe extern "C" fn input_pending(mut ictx: *mut input_ctx)
 -> *mut evbuffer {
    return (*ictx).since_ground;
}
/* Change input state. */
unsafe extern "C" fn input_set_state(mut ictx: *mut input_ctx,
...
/* Parse data. */
unsafe extern "C" fn input_parse(mut ictx: *mut input_ctx,
                                 mut buf: *mut u_char, mut len: size_t) {
    let mut sctx: *mut screen_write_ctx = &mut (*ictx).ctx;
    ...
    while off < len {
        ...
        /* Find the transition. */
        if (*ictx).state != state || itr.is_null() ||
               (*ictx).ch < (*itr).first || (*ictx).ch > (*itr).last {
            itr = (*(*ictx).state).transitions;
            while (*itr).first != -(1 as libc::c_int) &&
                      (*itr).last != -(1 as libc::c_int) {
                if (*ictx).ch >= (*itr).first && (*ictx).ch <= (*itr).last {
                    break ;
                }
                itr = itr.offset(1)
            }
            if (*itr).first == -(1 as libc::c_int) ||
                   (*itr).last == -(1 as libc::c_int) {
                /* No transition? Eh? */
        ...
        if (*itr).handler !=
               Some(input_print as
                        unsafe extern "C" fn(_: *mut input_ctx)
                            -> libc::c_int) {
        ...
        if !(*itr).state.is_null() { input_set_state(ictx, itr); }
...
/* Parse given input. */
#[no_mangle]
pub unsafe extern "C" fn input_parse_buffer(mut wp: *mut window_pane,
                                            mut buf: *mut u_char,
                                            mut len: size_t) {
    let mut ictx: *mut input_ctx = (*wp).ictx;
    let mut sctx: *mut screen_write_ctx = &mut (*ictx).ctx;
    if len == 0 as libc::c_int as libc::c_ulong { return }
    ...
    log_debug(b"%s: %%%u %s, %zu bytes: %.*s\x00" as *const u8 as
              ...
              (*::std::mem::transmute::<&[u8; 19],
                                        &[libc::c_char; 19]>(b"input_parse_buffer\x00")).as_ptr(),
              (*wp).id, (*(*ictx).state).name, len, len as libc::c_int, buf);
    input_parse(ictx, buf, len);
    screen_write_stop(sctx);
}
/* Parse given input for screen. */
#[no_mangle]
pub unsafe extern "C" fn input_parse_screen(mut ictx: *mut input_ctx,
                                            mut s: *mut screen,
...
unsafe extern "C" fn input_split(mut ictx: *mut input_ctx) -> libc::c_int {
    ...
    ip =
        &mut *(*ictx).param_list.as_mut_ptr().offset(0 as libc::c_int as
                                                         isize) as
            *mut input_param;
    ...
    loop  {
        ...
        if *out as libc::c_int == '\u{0}' as i32 {
            ...
            (*ip).c2rust_unnamed.num =
                strtonum(out, 0 as libc::c_int as libc::c_longlong,
        ...
        ip =
            &mut *(*ictx).param_list.as_mut_ptr().offset((*ictx).param_list_len
                                                             as isize) as
                *mut input_param;
    ...
    while i < (*ictx).param_list_len {
        ip =
            &mut *(*ictx).param_list.as_mut_ptr().offset(i as isize) as
                *mut input_param;
...
unsafe extern "C" fn input_get(mut ictx: *mut input_ctx, mut validx: u_int,
    ...
    if validx >= (*ictx).param_list_len { return defval }
    ip =
        &mut *(*ictx).param_list.as_mut_ptr().offset(validx as isize) as
            *mut input_param;
    if (*ip).type_0 as libc::c_uint ==
           INPUT_MISSING as libc::c_int as libc::c_uint {
        return defval
    ...
    if retval < minval { return minval }
    return retval;
}
/* Reply to terminal query. */
unsafe extern "C" fn input_reply(mut ictx: *mut input_ctx,
    ...
    if (*ictx).input_space > 32 as libc::c_int as libc::c_ulong {
        ...
        (*ictx).input_buf =
            xrealloc((*ictx).input_buf as *mut libc::c_void,
                     32 as libc::c_int as size_t) as *mut u_char
    };
}
...
unsafe extern "C" fn input_print(mut ictx: *mut input_ctx) -> libc::c_int {
    let mut sctx: *mut screen_write_ctx =
        &mut (*ictx).ctx; /* can't be valid UTF-8 */
    let mut set: libc::c_int = 0;
    (*ictx).utf8started = 0 as libc::c_int;
    set =
        if (*ictx).cell.set == 0 as libc::c_int {
            (*ictx).cell.g0set
        } else { (*ictx).cell.g1set };
    if set == 1 as libc::c_int {
        (*ictx).cell.cell.attr =
            ((*ictx).cell.cell.attr as libc::c_int | 0x80 as libc::c_int) as
                u_short
    } else {
        (*ictx).cell.cell.attr =
            ((*ictx).cell.cell.attr as libc::c_int & !(0x80 as libc::c_int))
                as u_short
    }
 ...
 -> libc::c_int {
    if (*ictx).interm_len ==
                ...
                libc::c_ulong).wrapping_sub(1 as libc::c_int as libc::c_ulong)
       {
        ...
        (*ictx).interm_buf[(*ictx).interm_len as usize] =
            '\u{0}' as i32 as u_char
    }
    return 0 as libc::c_int;
}
 ...
 -> libc::c_int {
    if (*ictx).param_len ==
                ...
                libc::c_ulong).wrapping_sub(1 as libc::c_int as libc::c_ulong)
       {
        ...
        (*ictx).param_buf[(*ictx).param_len as usize] =
            '\u{0}' as i32 as u_char
    }
    return 0 as libc::c_int;
}
...
unsafe extern "C" fn input_input(mut ictx: *mut input_ctx) -> libc::c_int {
    ...
    while (*ictx).input_len.wrapping_add(1 as libc::c_int as libc::c_ulong) >=
              available {
        available =
            (available as
        ...
        (*ictx).input_buf =
            xrealloc((*ictx).input_buf as *mut libc::c_void, available) as
                *mut u_char;
...
unsafe extern "C" fn input_c0_dispatch(mut ictx: *mut input_ctx)
 -> libc::c_int {
    ...
    match (*ictx).ch {
        0 => { current_block_13 = 18386322304582297246; }
        7 => {
            /* BEL */
            if !wp.is_null() {
        ...
        9 => {
            ...
            if (*s).cx >=
                ...
                loop 
                    ...
                    if *(*s).tabs.offset(((*s).cx >> 3 as libc::c_int) as
                                             isize) as libc::c_int &
                           (1 as libc::c_int) <<
        ...
        10 | 12 => { current_block_13 = 4414197365169205075; }
        13 => {
            /* CR */
    ...
    match current_block_13 {
        ...
        /* FF */
        {
            screen_write_linefeed(sctx, 0 as libc::c_int,
...
unsafe extern "C" fn input_esc_dispatch(mut ictx: *mut input_ctx)
 -> libc::c_int {
    ...
    if (*ictx).flags & 0x1 as libc::c_int != 0 { return 0 as libc::c_int }
    ...
    entry =
        bsearch(ictx as *const libc::c_void,
                ...
                Some(input_table_compare as
                         unsafe extern "C" fn(_: *const libc::c_void,
                                              _: *const libc::c_void)
                             -> libc::c_int)) as *mut input_table_entry;
    if entry.is_null() {
        log_debug(b"%s: unknown \'%c\'\x00" as *const u8 as
                      *const libc::c_char,
                  (*::std::mem::transmute::<&[u8; 19],
    ...
    match (*entry).type_0 {
        9 => {
            if !wp.is_null() { window_pane_reset_palette(wp); }
            input_reset_cell(ictx);
            screen_write_reset(sctx);
        }
        6 => {
        ...
        1 => { screen_write_mode_set(sctx, 0x8 as libc::c_int); }
        2 => { screen_write_mode_clear(sctx, 0x8 as libc::c_int); }
        4 => { input_save_state(ictx); }
        3 => { input_restore_state(ictx); }
...
unsafe extern "C" fn input_csi_dispatch(mut ictx: *mut input_ctx)
 -> libc::c_int {
    ...
    if input_split(ictx) != 0 as libc::c_int { return 0 as libc::c_int }
    entry =
        bsearch(ictx as *const libc::c_void,
                input_csi_table.as_ptr() as *const libc::c_void,
                (::std::mem::size_of::<[input_table_entry; 39]>() as
                     libc::c_ulong).wrapping_div(::std::mem::size_of::<input_table_entry>()
                                                     as libc::c_ulong),
                ::std::mem::size_of::<input_table_entry>() as libc::c_ulong,
                Some(input_table_compare as
    ...
    match (*entry).type_0 {
        0 => {
            ...
            n =
                input_get(ictx, 0 as libc::c_int as u_int, 1 as libc::c_int,
                          1 as libc::c_int);
                ...
                while cx > 0 as libc::c_int as libc::c_uint &&
                    ...
                    loop  {
                        ...
                        if !(cx > 0 as libc::c_int as libc::c_uint &&
                                 *(*s).tabs.offset((cx >> 3 as libc::c_int) as
                                                       isize) as libc::c_int &
                                     (1 as libc::c_int) <<
                                         (cx &
        ...
        6 => {
            n =
                input_get(ictx, 0 as libc::c_int as u_int, 1 as libc::c_int,
                          1 as libc::c_int);
            m =
                input_get(ictx, 1 as libc::c_int as u_int, 1 as libc::c_int,
                          1 as libc::c_int);
            if n != -(1 as libc::c_int) && m != -(1 as libc::c_int) {
                screen_write_cursormove(sctx, m - 1 as libc::c_int,
                                        n - 1 as libc::c_int,
                                        1 as libc::c_int);
            }
        }
        22 => {
            n =
                input_get(ictx, 0 as libc::c_int as u_int, 0 as libc::c_int,
                          0 as libc::c_int);
            m =
                input_get(ictx, 1 as libc::c_int as u_int, 0 as libc::c_int,
                          0 as libc::c_int);
            if n == 0 as libc::c_int ||
                   n == 4 as libc::c_int && m == 0 as libc::c_int {
                screen_write_mode_clear(sctx, 0x8000 as libc::c_int);
            } else if n == 4 as libc::c_int &&
                          (m == 1 as libc::c_int || m == 2 as libc::c_int) {
        ...
        35 => { input_csi_dispatch_winops(ictx); }
        7 => {
            n =
                input_get(ictx, 0 as libc::c_int as u_int, 1 as libc::c_int,
                          1 as libc::c_int);
        ...
        8 => {
            match input_get(ictx, 0 as libc::c_int as u_int, 0 as libc::c_int,
                            0 as libc::c_int) {
                -1 => { }
                0 => {
                    input_reply(ictx,
                                b"\x1b[?1;2c\x00" as *const u8 as
                                    *const libc::c_char);
                }
                _ => {
                    log_debug(b"%s: unknown \'%c\'\x00" as *const u8 as
        ...
        9 => {
            match input_get(ictx, 0 as libc::c_int as u_int, 0 as libc::c_int,
                ...
                0 => {
                    input_reply(ictx,
                                b"\x1b[>84;0;0c\x00" as *const u8 as
                                    *const libc::c_char);
                }
                _ => {
                    log_debug(b"%s: unknown \'%c\'\x00" as *const u8 as
        ...
        14 => {
            match input_get(ictx, 0 as libc::c_int as u_int, 0 as libc::c_int,
                ...
                5 => {
                    input_reply(ictx,
                                b"\x1b[0n\x00" as *const u8 as
                                    *const libc::c_char);
                }
                6 => {
                    input_reply(ictx,
                                b"\x1b[%u;%uR\x00" as *const u8 as
                                    *const libc::c_char,
                                (*s).cy.wrapping_add(1 as libc::c_int as
                                                         libc::c_uint),
                                (*s).cx.wrapping_add(1 as libc::c_int as
                                                         libc::c_uint));
                }
                _ => {
                    log_debug(b"%s: unknown \'%c\'\x00" as *const u8 as
        ...
        16 => {
            match input_get(ictx, 0 as libc::c_int as u_int, 0 as libc::c_int,
                ...
                3 => {
                    if input_get(ictx, 1 as libc::c_int as u_int,
        ...
        18 => {
            n =
                input_get(ictx, 0 as libc::c_int as u_int, 1 as libc::c_int,
                          1 as libc::c_int);
            if n != -(1 as libc::c_int) {
                screen_write_cursormove(sctx, n - 1 as libc::c_int,
                                        -(1 as libc::c_int),
                                        1 as libc::c_int);
            }
        }
        ...
        23 => { input_restore_state(ictx); }
        25 => { input_csi_dispatch_rm(ictx); }
        26 => { input_csi_dispatch_rm_private(ictx); }
        27 => { input_save_state(ictx); }
        29 => { input_csi_dispatch_sgr(ictx); }
        30 => { input_csi_dispatch_sm(ictx); }
        31 => { input_csi_dispatch_sm_private(ictx); }
        32 => {
            n =
                input_get(ictx, 0 as libc::c_int as u_int, 1 as libc::c_int,
                          1 as libc::c_int);
        ...
        33 => {
            match input_get(ictx, 0 as libc::c_int as u_int, 0 as libc::c_int,
                ...
                0 => {
                    if (*s).cx < (*(*s).grid).sx {
                        let ref mut fresh6 =
                            *(*s).tabs.offset(((*s).cx >> 3 as libc::c_int) as
                                                  isize);
                        *fresh6 =
                ...
                3 => {
                    ...
                    while _start <= _stop {
                        let ref mut fresh7 =
                            *_name.offset((_start >> 3 as libc::c_int) as
                                              isize);
                        *fresh7 =
                            (*fresh7 as libc::c_int &
                                 !((1 as libc::c_int) <<
                                       (_start & 0x7 as libc::c_int))) as
                                bitstr_t;
                        _start += 1
                    }
                }
        ...
        34 => {
            n =
                input_get(ictx, 0 as libc::c_int as u_int, 1 as libc::c_int,
                          1 as libc::c_int);
            if n != -(1 as libc::c_int) {
                screen_write_cursormove(sctx, -(1 as libc::c_int),
                                        n - 1 as libc::c_int,
                                        1 as libc::c_int);
            }
        }
        ...
        36 => {
            ...
            if n == 0 as libc::c_int {
                input_reply(ictx,
                            b"\x1bP>|tmux %s\x1b\\\x00" as *const u8 as
                                *const libc::c_char, getversion());
            }
        }
        _ => { }
    }
...
unsafe extern "C" fn input_csi_dispatch_rm(mut ictx: *mut input_ctx) {
    ...
    while i < (*ictx).param_list_len {
        match input_get(ictx, i, 0 as libc::c_int, -(1 as libc::c_int)) {
            ...
            34 => { screen_write_mode_set(sctx, 0x80 as libc::c_int); }
            _ => {
                log_debug(b"%s: unknown \'%c\'\x00" as *const u8 as
                              *const libc::c_char,
...
unsafe extern "C" fn input_csi_dispatch_rm_private(mut ictx: *mut input_ctx) {
    ...
    while i < (*ictx).param_list_len {
        match input_get(ictx, i, 0 as libc::c_int, -(1 as libc::c_int)) {
            ...
            3 => {
                /* DECCOLM */
                screen_write_cursormove(sctx, 0 as libc::c_int,
            ...
            12 => { screen_write_mode_clear(sctx, 0x80 as libc::c_int); }
            25 => {
                /* TCEM */
            ...
            1004 => { screen_write_mode_clear(sctx, 0x800 as libc::c_int); }
            1005 => { screen_write_mode_clear(sctx, 0x100 as libc::c_int); }
            1006 => { screen_write_mode_clear(sctx, 0x200 as libc::c_int); }
            47 | 1047 => {
                screen_write_alternateoff(sctx, gc, 0 as libc::c_int);
            }
            1049 => { screen_write_alternateoff(sctx, gc, 1 as libc::c_int); }
            2004 => { screen_write_mode_clear(sctx, 0x400 as libc::c_int); }
            _ => {
                log_debug(b"%s: unknown \'%c\'\x00" as *const u8 as
                              *const libc::c_char,
...
unsafe extern "C" fn input_csi_dispatch_sm(mut ictx: *mut input_ctx) {
    ...
    while i < (*ictx).param_list_len {
        match input_get(ictx, i, 0 as libc::c_int, -(1 as libc::c_int)) {
            ...
            34 => { screen_write_mode_clear(sctx, 0x80 as libc::c_int); }
            _ => {
                log_debug(b"%s: unknown \'%c\'\x00" as *const u8 as
                              *const libc::c_char,
                          (*::std::mem::transmute::<&[u8; 22],
...
unsafe extern "C" fn input_csi_dispatch_sm_private(mut ictx: *mut input_ctx) {
    ...
    while i < (*ictx).param_list_len {
        match input_get(ictx, i, 0 as libc::c_int, -(1 as libc::c_int)) {
            ...
            12 => { screen_write_mode_set(sctx, 0x80 as libc::c_int); }
            25 => {
                /* TCEM */
                screen_write_mode_set(sctx,
                                      0x1 as libc::c_int); /* force update */
            }
            1000 => {
                screen_write_mode_clear(sctx,
                                        0x20 as libc::c_int |
            ...
            1004 => {
                if !((*(*sctx).s).mode & 0x800 as libc::c_int != 0) {
                    ...
                    if !wp.is_null() { (*wp).flags |= 0x20 as libc::c_int }
                }
            }
            1005 => { screen_write_mode_set(sctx, 0x100 as libc::c_int); }
            1006 => { screen_write_mode_set(sctx, 0x200 as libc::c_int); }
            47 | 1047 => {
                screen_write_alternateon(sctx, gc, 0 as libc::c_int);
            }
            1049 => { screen_write_alternateon(sctx, gc, 1 as libc::c_int); }
            2004 => { screen_write_mode_set(sctx, 0x400 as libc::c_int); }
            _ => {
                log_debug(b"%s: unknown \'%c\'\x00" as *const u8 as
                              *const libc::c_char,
                          (*::std::mem::transmute::<&[u8; 30],
...
unsafe extern "C" fn input_csi_dispatch_winops(mut ictx: *mut input_ctx) {
    ...
    loop  {
        n =
            input_get(ictx, m as u_int, 0 as libc::c_int,
                      -(1 as libc::c_int));
        if !(n != -(1 as libc::c_int)) { break ; }
        ...
        match n {
            ...
            3 | 4 | 8 => {
                m += 1;
                if input_get(ictx, m as u_int, 0 as libc::c_int,
                             -(1 as libc::c_int)) == -(1 as libc::c_int) {
                    return
                }
                current_block_21 = 5991938557911941140;
            }
            9 | 10 => { current_block_21 = 5991938557911941140; }
            22 => {
                m += 1;
                match input_get(ictx, m as u_int, 0 as libc::c_int,
                                -(1 as libc::c_int)) {
                    -1 => { return }
            ...
            23 => {
                ...
                match input_get(ictx, m as u_int, 0 as libc::c_int,
                    ...
                    0 | 2 => {
                        ...
                        if !wp.is_null() {
                            notify_pane(b"pane-title-changed\x00" as *const u8
                                            as *const libc::c_char, wp);
...
unsafe extern "C" fn input_csi_dispatch_sgr_256_do(mut ictx: *mut input_ctx,
 ...
 -> libc::c_int {
    ...
    if c == -(1 as libc::c_int) || c > 255 as libc::c_int {
        ...
        } else if fgbg == 48 as libc::c_int { (*gc).bg = 8 as libc::c_int }
...
unsafe extern "C" fn input_csi_dispatch_sgr_256(mut ictx: *mut input_ctx,
    ...
    c =
        input_get(ictx, (*i).wrapping_add(1 as libc::c_int as libc::c_uint),
                  0 as libc::c_int, -(1 as libc::c_int));
...
unsafe extern "C" fn input_csi_dispatch_sgr_rgb(mut ictx: *mut input_ctx,
    ...
    r =
        input_get(ictx, (*i).wrapping_add(1 as libc::c_int as libc::c_uint),
                  0 as libc::c_int, -(1 as libc::c_int));
    g =
        input_get(ictx, (*i).wrapping_add(2 as libc::c_int as libc::c_uint),
                  0 as libc::c_int, -(1 as libc::c_int));
    b =
        input_get(ictx, (*i).wrapping_add(3 as libc::c_int as libc::c_uint),
                  0 as libc::c_int, -(1 as libc::c_int));
...
unsafe extern "C" fn input_csi_dispatch_sgr_colon(mut ictx: *mut input_ctx,
    ...
    let mut s: *mut libc::c_char =
        (*ictx).param_list[i as usize].c2rust_unnamed.str_0;
    ...
    loop  {
        ...
        log_debug(b"%s: %u = %d\x00" as *const u8 as *const libc::c_char,
                  ...
                  p[n.wrapping_sub(1 as libc::c_int as libc::c_uint) as
                        usize]);
    }
    free(copy as *mut libc::c_void);
    if n == 0 as libc::c_int as libc::c_uint { return }
    if p[0 as libc::c_int as usize] == 4 as libc::c_int {
        if n != 2 as libc::c_int as libc::c_uint { return }
        match p[1 as libc::c_int as usize] {
            0 => {
                (*gc).attr =
                    ((*gc).attr as libc::c_int &
                         !(0x4 as libc::c_int | 0x200 as libc::c_int |
                ...
                (*gc).attr =
                    ((*gc).attr as libc::c_int &
                         !(0x4 as libc::c_int | 0x200 as libc::c_int |
                               ...
                               0x1000 as libc::c_int)) as u_short;
                (*gc).attr =
                    ((*gc).attr as libc::c_int | 0x4 as libc::c_int) as
                        u_short
            }
            2 => {
                (*gc).attr =
                    ((*gc).attr as libc::c_int &
                         !(0x4 as libc::c_int | 0x200 as libc::c_int |
                               ...
                               0x1000 as libc::c_int)) as u_short;
                (*gc).attr =
                    ((*gc).attr as libc::c_int | 0x200 as libc::c_int) as
                        u_short
            }
            3 => {
                (*gc).attr =
                    ((*gc).attr as libc::c_int &
                         !(0x4 as libc::c_int | 0x200 as libc::c_int |
                               ...
                               0x1000 as libc::c_int)) as u_short;
                (*gc).attr =
                    ((*gc).attr as libc::c_int | 0x400 as libc::c_int) as
                        u_short
            }
            4 => {
                (*gc).attr =
                    ((*gc).attr as libc::c_int &
                         !(0x4 as libc::c_int | 0x200 as libc::c_int |
                               ...
                               0x1000 as libc::c_int)) as u_short;
                (*gc).attr =
                    ((*gc).attr as libc::c_int | 0x800 as libc::c_int) as
                        u_short
            }
            5 => {
                (*gc).attr =
                    ((*gc).attr as libc::c_int &
                         !(0x4 as libc::c_int | 0x200 as libc::c_int |
                               ...
                               0x1000 as libc::c_int)) as u_short;
                (*gc).attr =
                    ((*gc).attr as libc::c_int | 0x1000 as libc::c_int) as
                        u_short
            }
            _ => { }
        }
    ...
    match p[1 as libc::c_int as usize] {
        2 => {
            if !(n < 3 as libc::c_int as libc::c_uint) {
                ...
                } else { i = 3 as libc::c_int as u_int }
                if !(n < i.wrapping_add(3 as libc::c_int as libc::c_uint)) {
                    input_csi_dispatch_sgr_rgb_do(ictx,
                                                  p[0 as libc::c_int as
                                                        usize], p[i as usize],
                                                  p[i.wrapping_add(1 as
                                                                       libc::c_int
                                                                       as
                                                                       libc::c_uint)
                                                        as usize],
                                                  p[i.wrapping_add(2 as
                                                                       libc::c_int
                                                                       as
                                                                       libc::c_uint)
                                                        as usize]);
        ...
        5 => {
            if !(n < 3 as libc::c_int as libc::c_uint) {
                input_csi_dispatch_sgr_256_do(ictx,
        ...
        if (*ictx).param_list[i as usize].type_0 as libc::c_uint ==
            ...
            if !(n == -(1 as libc::c_int)) {
                if n == 38 as libc::c_int || n == 48 as libc::c_int ||
                       n == 58 as libc::c_int {
                    i = i.wrapping_add(1);
                    match input_get(ictx, i, 0 as libc::c_int,
                                    -(1 as libc::c_int)) {
                        2 => { input_csi_dispatch_sgr_rgb(ictx, n, &mut i); }
                        5 => { input_csi_dispatch_sgr_256(ictx, n, &mut i); }
                        _ => { }
                    }
                } else {
                    match n {
                        ...
                        1 => {
                            (*gc).attr =
                                ((*gc).attr as libc::c_int |
                                     0x1 as libc::c_int) as u_short
                        }
                        2 => {
                            (*gc).attr =
                                ((*gc).attr as libc::c_int |
                                     0x2 as libc::c_int) as u_short
                        }
                        3 => {
                            (*gc).attr =
                                ((*gc).attr as libc::c_int |
                                     0x40 as libc::c_int) as u_short
                        }
                        4 => {
                            (*gc).attr =
                                ((*gc).attr as libc::c_int &
                            ...
                            (*gc).attr =
                                ((*gc).attr as libc::c_int |
                                     0x4 as libc::c_int) as u_short
                        }
                        5 => {
                            (*gc).attr =
                                ((*gc).attr as libc::c_int |
                                     0x8 as libc::c_int) as u_short
                        }
                        7 => {
                            (*gc).attr =
                                ((*gc).attr as libc::c_int |
                                     0x10 as libc::c_int) as u_short
                        }
                        8 => {
                            (*gc).attr =
                                ((*gc).attr as libc::c_int |
                                     0x20 as libc::c_int) as u_short
                        }
                        9 => {
                            (*gc).attr =
                                ((*gc).attr as libc::c_int |
                        ...
                        53 => {
                            (*gc).attr =
                                ((*gc).attr as libc::c_int |
                                     0x2000 as libc::c_int) as u_short
                        }
                        55 => {
                            (*gc).attr =
                                ((*gc).attr as libc::c_int &
...
unsafe extern "C" fn input_end_bel(mut ictx: *mut input_ctx) -> libc::c_int {
    log_debug(b"%s\x00" as *const u8 as *const libc::c_char,
              (*::std::mem::transmute::<&[u8; 14],
                                        &[libc::c_char; 14]>(b"input_end_bel\x00")).as_ptr());
...
unsafe extern "C" fn input_dcs_dispatch(mut ictx: *mut input_ctx)
 -> libc::c_int {
    ...
    if len >= prefixlen as libc::c_ulong &&
           strncmp(buf as *const libc::c_char, prefix.as_ptr(),
                   prefixlen as libc::c_ulong) == 0 as libc::c_int {
        screen_write_rawstring(sctx, buf.offset(prefixlen as isize),
                               len.wrapping_sub(prefixlen as libc::c_ulong) as
                                   u_int);
    }
    return 0 as libc::c_int;
}
...
unsafe extern "C" fn input_exit_osc(mut ictx: *mut input_ctx) {
    ...
    match option {
        0 | 2 => {
            if screen_set_title((*sctx).s, p as *const libc::c_char) != 0 &&
                   !wp.is_null() {
                notify_pane(b"pane-title-changed\x00" as *const u8 as
                                *const libc::c_char, wp);
                server_redraw_window_borders((*wp).window);
                server_status_window((*wp).window);
            }
        }
        4 => { input_osc_4(ictx, p as *const libc::c_char); }
        7 => {
        ...
        10 => { input_osc_10(ictx, p as *const libc::c_char); }
        11 => { input_osc_11(ictx, p as *const libc::c_char); }
        12 => {
            if utf8_isvalid(p as *const libc::c_char) != 0 &&
        ...
        52 => { input_osc_52(ictx, p as *const libc::c_char); }
        104 => { input_osc_104(ictx, p as *const libc::c_char); }
        112 => {
...
unsafe extern "C" fn input_exit_apc(mut ictx: *mut input_ctx) {
    ...
    log_debug(b"%s: \"%s\"\x00" as *const u8 as *const libc::c_char,
              ...
              (*ictx).input_buf);
    if screen_set_title((*sctx).s, (*ictx).input_buf as *const libc::c_char)
           != 0 && !wp.is_null() {
        notify_pane(b"pane-title-changed\x00" as *const u8 as
                        *const libc::c_char, wp);
        server_redraw_window_borders((*wp).window);
...
unsafe extern "C" fn input_exit_rename(mut ictx: *mut input_ctx) {
    ...
    if (*ictx).flags & 0x1 as libc::c_int != 0 { return }
    if options_get_number((*(*ictx).wp).options,
    ...
    log_debug(b"%s: \"%s\"\x00" as *const u8 as *const libc::c_char,
              ...
              (*ictx).input_buf);
    if utf8_isvalid((*ictx).input_buf as *const libc::c_char) == 0 { return }
    if (*ictx).input_len == 0 as libc::c_int as libc::c_ulong {
        o =
            options_get_only((*(*wp).window).options,
    ...
    options_set_number((*(*wp).window).options,
                       b"automatic-rename\x00" as *const u8 as
                           *const libc::c_char,
...
unsafe extern "C" fn input_top_bit_set(mut ictx: *mut input_ctx)
 -> libc::c_int {
    ...
    log_debug(b"%s %hhu \'%*s\' (width %hhu)\x00" as *const u8 as
              ...
              (*ud).size as libc::c_int, (*ud).size as libc::c_int,
              (*ud).data.as_mut_ptr(), (*ud).width as libc::c_int);
    utf8_copy(&mut (*ictx).cell.cell.data, ud);
    screen_write_collect_add(sctx, &mut (*ictx).cell.cell);
    return 0 as libc::c_int;
}
/* Parse colour from OSC. */
unsafe extern "C" fn input_osc_parse_colour(mut p: *const libc::c_char,
                                            mut r: *mut u_int,
                                            mut g: *mut u_int,
                                            mut b: *mut u_int)
 -> libc::c_int {
    ...
    if sscanf(p, b"rgb:%x/%x/%x\x00" as *const u8 as *const libc::c_char, r,
              g, b) != 3 as libc::c_int {
        return 0 as libc::c_int
    }
    ...
    log_debug(b"%s: %s = %02x%02x%02x\x00" as *const u8 as
                  *const libc::c_char,
              (*::std::mem::transmute::<&[u8; 23],
                                        &[libc::c_char; 23]>(b"input_osc_parse_colour\x00")).as_ptr(),
              s, *r, *g, *b);
    return 1 as libc::c_int;
}
/* Reply to a colour request. */
unsafe extern "C" fn input_osc_colour_reply(mut ictx: *mut input_ctx,
                                            mut n: u_int,
                                            mut c: libc::c_int) {
    let mut r: u_char = 0;
    let mut g: u_char = 0;
    ...
    if c == 8 as libc::c_int || !c & 0x2000000 as libc::c_int != 0 { return }
    colour_split_rgb(c, &mut r, &mut g, &mut b);
    if (*ictx).input_end as libc::c_uint ==
           INPUT_END_BEL as libc::c_int as libc::c_uint {
        end = b"\x07\x00" as *const u8 as *const libc::c_char
    } else { end = b"\x1b\\\x00" as *const u8 as *const libc::c_char }
    input_reply(ictx,
                b"\x1b]%u;rgb:%02hhx/%02hhx/%02hhx%s\x00" as *const u8 as
                    *const libc::c_char, n, r as libc::c_int,
                g as libc::c_int, b as libc::c_int, end);
}
/* Handle the OSC 4 sequence for setting (multiple) palette entries. */
unsafe extern "C" fn input_osc_4(mut ictx: *mut input_ctx,
    ...
    loop  {
        ...
        if input_osc_parse_colour(s, &mut r, &mut g, &mut b) == 0 {
            ...
            window_pane_set_palette(wp, idx as u_int,
                                    colour_join_rgb(r as u_char, g as u_char,
                                                    b as u_char));
            s = next
        }
    }
    match current_block {
        12820755034573918988 => {
            log_debug(b"bad OSC 4: %s\x00" as *const u8 as
                          *const libc::c_char, p);
            free(copy as *mut libc::c_void);
            return;
        }
        _ => { free(copy as *mut libc::c_void); return }
    };
}
/* Handle the OSC 10 sequence for setting and querying foreground colour. */
unsafe extern "C" fn input_osc_10(mut ictx: *mut input_ctx,
                                  mut p: *const libc::c_char) {
    let mut wp: *mut window_pane = (*ictx).wp;
    let mut defaults: grid_cell =
    ...
    let mut b: u_int = 0;
    if wp.is_null() { return }
    if strcmp(p, b"?\x00" as *const u8 as *const libc::c_char) ==
           0 as libc::c_int {
...
unsafe extern "C" fn input_osc_11(mut ictx: *mut input_ctx,
                                  mut p: *const libc::c_char) {
    let mut wp: *mut window_pane = (*ictx).wp;
    let mut defaults: grid_cell =
        grid_cell{data: utf8_data{data: [0; 21], have: 0, size: 0, width: 0,},
...
unsafe extern "C" fn input_osc_52(mut ictx: *mut input_ctx,
                                  mut p: *const libc::c_char) {
    let mut wp: *mut window_pane = (*ictx).wp;
    ...
    if state != 2 as libc::c_int { return }
    end = strchr(p, ';' as i32);
    if end.is_null() { return }
    end = end.offset(1);
    if *end as libc::c_int == '\u{0}' as i32 { return }
    log_debug(b"%s: %s\x00" as *const u8 as *const libc::c_char,
              (*::std::mem::transmute::<&[u8; 13],
                                        &[libc::c_char; 13]>(b"input_osc_52\x00")).as_ptr(),
              end);
    if strcmp(end, b"?\x00" as *const u8 as *const libc::c_char) ==
           0 as libc::c_int {
        ...
        if !pb.is_null() {
            ...
            outlen =
                (4 as libc::c_int as
                     libc::c_ulong).wrapping_mul(len.wrapping_add(2 as
                                                                      libc::c_int
                                                                      as
            ...
            outlen =
                __b64_ntop(buf as *const libc::c_uchar, len,
                           out as *mut libc::c_char, outlen as size_t);
            if outlen == -(1 as libc::c_int) {
                free(out as *mut libc::c_void);
                return
            }
        } else { outlen = 0 as libc::c_int; out = 0 as *mut u_char }
        bufferevent_write((*ictx).event,
                          b"\x1b]52;;\x00" as *const u8 as *const libc::c_char
                              as *const libc::c_void,
                          6 as libc::c_int as size_t);
        if outlen != 0 as libc::c_int {
            bufferevent_write((*ictx).event, out as *const libc::c_void,
                              outlen as size_t);
        }
        if (*ictx).input_end as libc::c_uint ==
               INPUT_END_BEL as libc::c_int as libc::c_uint {
            bufferevent_write((*ictx).event,
                              b"\x07\x00" as *const u8 as *const libc::c_char
                                  as *const libc::c_void,
    ...
    len =
        strlen(end).wrapping_div(4 as libc::c_int as
    ...
    notify_pane(b"pane-set-clipboard\x00" as *const u8 as *const libc::c_char,
                wp);
    paste_add(0 as *const libc::c_char, out as *mut libc::c_char,
              outlen as size_t);
}
/* Handle the OSC 104 sequence for unsetting (multiple) palette entries. */
unsafe extern "C" fn input_osc_104(mut ictx: *mut input_ctx,
                                   mut p: *const libc::c_char) {
    let mut current_block: u64;
    let mut wp: *mut window_pane = (*ictx).wp;
    let mut copy: *mut libc::c_char = 0 as *mut libc::c_char;
    ...
    match current_block {
        13905477316042032337 => {
            log_debug(b"bad OSC 104: %s\x00" as *const u8 as
                          *const libc::c_char, p);
            free(copy as *mut libc::c_void);
            return;
        }
