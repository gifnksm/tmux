...
extern "C" {
    ...
    #[no_mangle]
    fn tty_window_offset(_: *mut tty, _: *mut u_int, _: *mut u_int,
                         _: *mut u_int, _: *mut u_int) -> libc::c_int;
    #[no_mangle]
    ...
    #[no_mangle]
    fn cmd_parse_from_arguments(_: libc::c_int, _: *mut *mut libc::c_char,
    ...
    fn key_bindings_dispatch(_: *mut key_binding, _: *mut cmdq_item,
                             _: *mut client, _: *mut key_event,
                             _: *mut cmd_find_state) -> *mut cmdq_item;
    #[no_mangle]
    ...
    #[no_mangle]
    fn status_get_range(_: *mut client, _: u_int, _: u_int)
     -> *mut style_range;
    #[no_mangle]
    ...
    #[no_mangle]
    fn client_files_RB_MINMAX(_: *mut client_files, _: libc::c_int)
     -> *mut client_file;
    #[no_mangle]
    ...
    #[no_mangle]
    fn client_files_RB_FIND(_: *mut client_files, _: *mut client_file)
     -> *mut client_file;
    #[no_mangle]
    fn resize_window(_: *mut window, _: u_int, _: u_int, _: libc::c_int,
                     _: libc::c_int);
    #[no_mangle]
    ...
    fn window_pane_key(_: *mut window_pane, _: *mut client, _: *mut session,
                       _: *mut winlink, _: key_code, _: *mut mouse_event)
     -> libc::c_int;
    #[no_mangle]
    ...
    #[no_mangle]
    fn window_pane_get_new_data(_: *mut window_pane,
                                _: *mut window_pane_offset, _: *mut size_t)
     -> *mut libc::c_void;
    #[no_mangle]
    ...
    #[no_mangle]
    fn control_pane_offset(_: *mut client, _: *mut window_pane,
                           _: *mut libc::c_int) -> *mut window_pane_offset;
    #[no_mangle]
...
unsafe extern "C" fn server_client_window_cmp(mut cw1: *mut client_window,
                                              mut cw2: *mut client_window)
 -> libc::c_int {
    if (*cw1).window < (*cw2).window { return -(1 as libc::c_int) }
    if (*cw1).window > (*cw2).window { return 1 as libc::c_int }
    return 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn client_windows_RB_NFIND(mut head:
                                                     *mut client_windows,
...
#[no_mangle]
pub unsafe extern "C" fn client_windows_RB_INSERT(mut head:
                                                      *mut client_windows,
                                                  mut elm: *mut client_window)
 -> *mut client_window {
...
#[no_mangle]
pub unsafe extern "C" fn client_windows_RB_INSERT_COLOR(mut head:
                                                            *mut client_windows,
                                                        mut elm:
                                                            *mut client_window) {
    let mut parent: *mut client_window = 0 as *mut client_window;
...
#[no_mangle]
pub unsafe extern "C" fn client_windows_RB_FIND(mut head: *mut client_windows,
                                                mut elm: *mut client_window)
 -> *mut client_window {
    let mut tmp: *mut client_window = (*head).rbh_root;
    let mut comp: libc::c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn client_windows_RB_MINMAX(mut head:
                                                      *mut client_windows,
                                                  mut val: libc::c_int)
 -> *mut client_window {
    let mut tmp: *mut client_window = (*head).rbh_root;
...
#[no_mangle]
pub unsafe extern "C" fn client_windows_RB_PREV(mut elm: *mut client_window)
 -> *mut client_window {
...
#[no_mangle]
pub unsafe extern "C" fn client_windows_RB_NEXT(mut elm: *mut client_window)
 -> *mut client_window {
...
#[no_mangle]
pub unsafe extern "C" fn client_windows_RB_REMOVE(mut head:
                                                      *mut client_windows,
                                                  mut elm: *mut client_window)
 -> *mut client_window {
...
#[no_mangle]
pub unsafe extern "C" fn client_windows_RB_REMOVE_COLOR(mut head:
                                                            *mut client_windows,
                                                        mut parent:
                                                            *mut client_window,
                                                        mut elm:
        ...
        if (*parent).entry.rbe_left == elm {
            ...
            if ((*tmp).entry.rbe_left.is_null() ||
                ...
                if (*tmp).entry.rbe_right.is_null() ||
                       (*(*tmp).entry.rbe_right).entry.rbe_color ==
                           0 as libc::c_int {
                    let mut oleft: *mut client_window =
                        0 as *mut client_window;
            ...
            if ((*tmp).entry.rbe_left.is_null() ||
                ...
                if (*tmp).entry.rbe_left.is_null() ||
                       (*(*tmp).entry.rbe_left).entry.rbe_color ==
                           0 as libc::c_int {
                    let mut oright: *mut client_window =
                        0 as *mut client_window;
...
pub unsafe extern "C" fn server_client_how_many() -> u_int {
    ...
    while !c.is_null() {
        if !(*c).session.is_null() &&
               !(*c).flags &
                   (0x200 as libc::c_int | 0x40 as libc::c_int |
                        0x4 as libc::c_int) as libc::c_ulong != 0 {
            n = n.wrapping_add(1)
        }
        c = (*c).entry.tqe_next
    }
...
unsafe extern "C" fn server_client_overlay_timer(mut fd: libc::c_int,
...
#[no_mangle]
pub unsafe extern "C" fn server_client_set_overlay(mut c: *mut client,
                                                   mut delay: u_int,
                                                   mut checkcb:
                                                       overlay_check_cb,
                                                   mut modecb:
    ...
    if (*c).overlay_draw.is_some() { server_client_clear_overlay(c); }
    tv.tv_sec =
        delay.wrapping_div(1000 as libc::c_int as libc::c_uint) as __time_t;
    tv.tv_usec =
        delay.wrapping_rem(1000 as libc::c_int as libc::c_uint) as
            libc::c_long * 1000 as libc::c_long;
    if event_initialized(&mut (*c).overlay_timer) != 0 {
        event_del(&mut (*c).overlay_timer);
    }
    event_set(&mut (*c).overlay_timer, -(1 as libc::c_int),
              0 as libc::c_int as libc::c_short,
              Some(server_client_overlay_timer as
...
pub unsafe extern "C" fn server_client_set_key_table(mut c: *mut client,
                                                     mut name:
                                                         *const libc::c_char) {
    if name.is_null() { name = server_client_get_key_table(c) }
...
pub unsafe extern "C" fn server_client_get_key_table(mut c: *mut client)
 -> *const libc::c_char {
    ...
    if s.is_null() { return b"root\x00" as *const u8 as *const libc::c_char }
    name =
...
unsafe extern "C" fn server_client_is_default_key_table(mut c: *mut client,
                                                        mut table:
                                                            *mut key_table)
 -> libc::c_int {
    return (strcmp((*table).name, server_client_get_key_table(c)) ==
...
pub unsafe extern "C" fn server_client_create(mut fd: libc::c_int)
 -> *mut client {
    ...
    (*c).peer =
        proc_add_peer(server_proc, fd,
                      Some(server_client_dispatch as
                               unsafe extern "C" fn(_: *mut imsg,
                                                    _: *mut libc::c_void)
                                   -> ()), c as *mut libc::c_void);
    if gettimeofday(&mut (*c).creation_time, 0 as *mut libc::c_void) !=
           0 as libc::c_int {
    ...
    (*(*c).keytable).references = (*(*c).keytable).references.wrapping_add(1);
    event_set(&mut (*c).repeat_timer, -(1 as libc::c_int),
              0 as libc::c_int as libc::c_short,
              Some(server_client_repeat_timer as
                       unsafe extern "C" fn(_: libc::c_int, _: libc::c_short,
                                            _: *mut libc::c_void) -> ()),
              c as *mut libc::c_void);
    event_set(&mut (*c).click_timer, -(1 as libc::c_int),
              0 as libc::c_int as libc::c_short,
              Some(server_client_click_timer as
                       unsafe extern "C" fn(_: libc::c_int, _: libc::c_short,
                                            _: *mut libc::c_void) -> ()),
              c as *mut libc::c_void);
...
pub unsafe extern "C" fn server_client_open(mut c: *mut client,
 ...
 -> libc::c_int {
    let mut ttynam: *const libc::c_char =
    ...
    if strcmp((*c).ttyname, ttynam) == 0 as libc::c_int ||
           (isatty(0 as libc::c_int) != 0 &&
                { ttynam = ttyname(0 as libc::c_int); !ttynam.is_null() } &&
                strcmp((*c).ttyname, ttynam) == 0 as libc::c_int ||
                isatty(1 as libc::c_int) != 0 &&
                    { ttynam = ttyname(1 as libc::c_int); !ttynam.is_null() }
                    && strcmp((*c).ttyname, ttynam) == 0 as libc::c_int ||
                isatty(2 as libc::c_int) != 0 &&
                    { ttynam = ttyname(2 as libc::c_int); !ttynam.is_null() }
                    && strcmp((*c).ttyname, ttynam) == 0 as libc::c_int) {
        xasprintf(cause,
...
pub unsafe extern "C" fn server_client_lost(mut c: *mut client) {
    let mut cf: *mut client_file =
        0 as *mut client_file; /* may be more file descriptors now */
    ...
    while !cf.is_null() &&
              { cf1 = client_files_RB_NEXT(cf); (1 as libc::c_int) != 0 } {
    ...
    while !cw.is_null() &&
              { cw1 = client_windows_RB_NEXT(cw); (1 as libc::c_int) != 0 } {
    ...
    } else { clients.tqh_last = (*c).entry.tqe_prev }
    *(*c).entry.tqe_prev = (*c).entry.tqe_next;
    ...
    if (*c).out_fd != -(1 as libc::c_int) { close((*c).out_fd); }
...
pub unsafe extern "C" fn server_client_unref(mut c: *mut client) {
    ...
    if (*c).references == 0 as libc::c_int {
        event_once(-(1 as libc::c_int), 0x1 as libc::c_int as libc::c_short,
                   Some(server_client_free as
                            unsafe extern "C" fn(_: libc::c_int,
                                                 _: libc::c_short,
                                                 _: *mut libc::c_void) -> ()),
                   c as *mut libc::c_void, 0 as *const timeval);
    };
}
/* $OpenBSD$ */
/*
...
pub unsafe extern "C" fn server_client_suspend(mut c: *mut client) {
    ...
    proc_send((*c).peer, MSG_SUSPEND, -(1 as libc::c_int),
              0 as *const libc::c_void, 0 as libc::c_int as size_t);
}
/* Detach a client. */
#[no_mangle]
...
pub unsafe extern "C" fn server_client_exec(mut c: *mut client,
    ...
    if *cmd as libc::c_int == '\u{0}' as i32 { return }
    ...
    proc_send((*c).peer, MSG_EXEC, -(1 as libc::c_int),
              msg as *const libc::c_void, cmdsize.wrapping_add(shellsize));
...
unsafe extern "C" fn server_client_check_mouse(mut c: *mut client,
 ...
 -> key_code {
    ...
    log_debug(b"%s mouse %02x at %u,%u (last %u,%u) (%d)\x00" as *const u8 as
                  *const libc::c_char, (*c).name, (*m).b, (*m).x, (*m).y,
              (*m).lx, (*m).ly, (*c).tty.mouse_drag_flag);
    /* What type of event is this? */
    if (*event).key == KEYC_DOUBLECLICK as libc::c_ulong as libc::c_ulonglong
       {
        type_0 = DOUBLE;
        x = (*m).x;
        y = (*m).y;
        ...
        if (*c).flags & 0x100000 as libc::c_int as libc::c_ulong != 0 {
            ...
            if (*m).b == (*c).click_button {
                ...
                y = (*m).y;
                b = (*m).b;
                log_debug(b"second-click at %u,%u\x00" as *const u8 as
                              *const libc::c_char, x, y);
        ...
        match current_block {
            ...
            _ => {
                if 300 as libc::c_int != 0 as libc::c_int {
                    memcpy(&mut (*c).click_event as *mut mouse_event as
                               *mut libc::c_void, m as *const libc::c_void,
                           ::std::mem::size_of::<mouse_event>() as
                               libc::c_ulong);
                    (*c).click_button = (*m).b;
                    log_debug(b"click timer started\x00" as *const u8 as
                                  *const libc::c_char);
                    tv.tv_sec =
                        (300 as libc::c_int / 1000 as libc::c_int) as
                            __time_t;
                    tv.tv_usec =
                        (300 as libc::c_int % 1000 as libc::c_int) as
                            libc::c_long * 1000 as libc::c_long;
    ...
    if (*m).statusat != -(1 as libc::c_int) && y >= (*m).statusat as u_int &&
       ...
       {
        sr =
            status_get_range(c, x,
                             y.wrapping_sub((*m).statusat as libc::c_uint));
        if sr.is_null() {
            ...
            match (*sr).type_0 as libc::c_uint {
                ...
                3 => {
                    wl =
                        winlink_find_by_index(&mut (*s).windows,
                                              (*sr).argument as libc::c_int);
                    if wl.is_null() {
                        return 0xfe000000000 as libc::c_ulonglong
                    }
    ...
    if where_0 as libc::c_uint == NOWHERE as libc::c_int as libc::c_uint {
        ...
        } else if (*m).statusat > 0 as libc::c_int &&
                      y >= (*m).statusat as u_int {
            py = ((*m).statusat - 1 as libc::c_int) as u_int
        } else { py = y }
        tty_window_offset(&mut (*c).tty, &mut (*m).ox, &mut (*m).oy, &mut sx,
                          &mut sy);
        log_debug(b"mouse window @%u at %u,%u (%ux%u)\x00" as *const u8 as
                      *const libc::c_char, (*(*(*s).curw).window).id, (*m).ox,
                  (*m).oy, sx, sy);
        if px > sx || py > sy { return 0xfe000000000 as libc::c_ulonglong }
        ...
        if !(*(*(*s).curw).window).flags & 0x8 as libc::c_int != 0 {
            ...
            while !wp.is_null() {
                if (*wp).xoff.wrapping_add((*wp).sx) == px &&
                       (*wp).yoff <=
                           (1 as libc::c_int as libc::c_uint).wrapping_add(py)
                       && (*wp).yoff.wrapping_add((*wp).sy) >= py ||
                       (*wp).yoff.wrapping_add((*wp).sy) == py &&
                           (*wp).xoff <=
                               (1 as libc::c_int as
                                    libc::c_uint).wrapping_add(px) &&
                           (*wp).xoff.wrapping_add((*wp).sx) >= px {
                    break ;
                }
                wp = (*wp).entry.tqe_next
            }
            if !wp.is_null() { where_0 = BORDER }
        }
        ...
        if where_0 as libc::c_uint == NOWHERE as libc::c_int as libc::c_uint {
            ...
            if !wp.is_null() {
                where_0 = PANE
            } else { return 0xfe000000000 as libc::c_ulonglong }
        }
        if where_0 as libc::c_uint == PANE as libc::c_int as libc::c_uint {
            log_debug(b"mouse %u,%u on pane %%%u\x00" as *const u8 as
                          *const libc::c_char, x, y, (*wp).id);
        } else if where_0 as libc::c_uint ==
                      BORDER as libc::c_int as libc::c_uint {
            log_debug(b"mouse on pane %%%u border\x00" as *const u8 as
                          *const libc::c_char, (*wp).id);
        }
        (*m).wp = (*wp).id as libc::c_int;
        (*m).w = (*(*wp).window).id as libc::c_int
    } else { (*m).wp = -(1 as libc::c_int) }
    ...
    if type_0 as libc::c_uint != DRAG as libc::c_int as libc::c_uint &&
        ...
        match (*c).tty.mouse_drag_flag {
            1 => {
                ...
                if where_0 as libc::c_uint ==
                    ...
                    key =
                        KEYC_MOUSEDRAGEND1_STATUS as libc::c_ulong as key_code
                }
                if where_0 as libc::c_uint ==
                       STATUS_LEFT as libc::c_int as libc::c_uint {
                    key =
                        KEYC_MOUSEDRAGEND1_STATUS_LEFT as libc::c_ulong as
                            key_code
                }
                if where_0 as libc::c_uint ==
                       STATUS_RIGHT as libc::c_int as libc::c_uint {
                    key =
                        KEYC_MOUSEDRAGEND1_STATUS_RIGHT as libc::c_ulong as
                            key_code
                }
                if where_0 as libc::c_uint ==
                       STATUS_DEFAULT as libc::c_int as libc::c_uint {
                    key =
                        KEYC_MOUSEDRAGEND1_STATUS_DEFAULT as libc::c_ulong as
                            key_code
                }
                if where_0 as libc::c_uint ==
                       BORDER as libc::c_int as libc::c_uint {
                    key =
                        KEYC_MOUSEDRAGEND1_BORDER as libc::c_ulong as key_code
                }
            }
            2 => {
                if where_0 as libc::c_uint ==
                ...
                if where_0 as libc::c_uint ==
                       STATUS as libc::c_int as libc::c_uint {
                    key =
                        KEYC_MOUSEDRAGEND2_STATUS as libc::c_ulong as key_code
                }
                if where_0 as libc::c_uint ==
                       STATUS_LEFT as libc::c_int as libc::c_uint {
                    key =
                        KEYC_MOUSEDRAGEND2_STATUS_LEFT as libc::c_ulong as
                            key_code
                }
                if where_0 as libc::c_uint ==
                       STATUS_RIGHT as libc::c_int as libc::c_uint {
                    key =
                        KEYC_MOUSEDRAGEND2_STATUS_RIGHT as libc::c_ulong as
                            key_code
                }
                if where_0 as libc::c_uint ==
                       STATUS_DEFAULT as libc::c_int as libc::c_uint {
                    key =
                        KEYC_MOUSEDRAGEND2_STATUS_DEFAULT as libc::c_ulong as
                            key_code
                }
                if where_0 as libc::c_uint ==
                       BORDER as libc::c_int as libc::c_uint {
                    key =
                        KEYC_MOUSEDRAGEND2_BORDER as libc::c_ulong as key_code
                }
            }
            3 => {
                if where_0 as libc::c_uint ==
                ...
                if where_0 as libc::c_uint ==
                       STATUS as libc::c_int as libc::c_uint {
                    key =
                        KEYC_MOUSEDRAGEND3_STATUS as libc::c_ulong as key_code
                }
                if where_0 as libc::c_uint ==
                       STATUS_LEFT as libc::c_int as libc::c_uint {
                    key =
                        KEYC_MOUSEDRAGEND3_STATUS_LEFT as libc::c_ulong as
                            key_code
                }
                if where_0 as libc::c_uint ==
                       STATUS_RIGHT as libc::c_int as libc::c_uint {
                    key =
                        KEYC_MOUSEDRAGEND3_STATUS_RIGHT as libc::c_ulong as
                            key_code
                }
                if where_0 as libc::c_uint ==
                       STATUS_DEFAULT as libc::c_int as libc::c_uint {
                    key =
                        KEYC_MOUSEDRAGEND3_STATUS_DEFAULT as libc::c_ulong as
                            key_code
                }
                if where_0 as libc::c_uint ==
                       BORDER as libc::c_int as libc::c_uint {
                    key =
                        KEYC_MOUSEDRAGEND3_BORDER as libc::c_ulong as key_code
                }
            }
            _ => { key = KEYC_MOUSE as libc::c_ulong as key_code }
        }
        ...
        match type_0 as libc::c_uint {
            1 => {
                if where_0 as libc::c_uint ==
                       PANE as libc::c_int as libc::c_uint {
                    key = KEYC_MOUSEMOVE_PANE as libc::c_ulong as key_code
                }
                if where_0 as libc::c_uint ==
                       STATUS as libc::c_int as libc::c_uint {
                    key = KEYC_MOUSEMOVE_STATUS as libc::c_ulong as key_code
                }
                if where_0 as libc::c_uint ==
                       STATUS_LEFT as libc::c_int as libc::c_uint {
                    key =
                        KEYC_MOUSEMOVE_STATUS_LEFT as libc::c_ulong as
                            key_code
                }
                if where_0 as libc::c_uint ==
                       STATUS_RIGHT as libc::c_int as libc::c_uint {
                    key =
                        KEYC_MOUSEMOVE_STATUS_RIGHT as libc::c_ulong as
                            key_code
                }
                if where_0 as libc::c_uint ==
                       STATUS_DEFAULT as libc::c_int as libc::c_uint {
                    key =
                        KEYC_MOUSEMOVE_STATUS_DEFAULT as libc::c_ulong as
                            key_code
                }
                if where_0 as libc::c_uint ==
                       BORDER as libc::c_int as libc::c_uint {
                    key = KEYC_MOUSEMOVE_BORDER as libc::c_ulong as key_code
                }
            }
            4 => {
                if (*c).tty.mouse_drag_update.is_some() {
                    key = KEYC_DRAGGING as libc::c_ulong as key_code
                } else {
                    match b & 3 as libc::c_int as libc::c_uint {
                        0 => {
                            if where_0 as libc::c_uint ==
                                   PANE as libc::c_int as libc::c_uint {
                                key =
                                    KEYC_MOUSEDRAG1_PANE as libc::c_ulong as
                                        key_code
                            }
                            if where_0 as libc::c_uint ==
                                   STATUS as libc::c_int as libc::c_uint {
                                key =
                                    KEYC_MOUSEDRAG1_STATUS as libc::c_ulong as
                                        key_code
                            }
                            if where_0 as libc::c_uint ==
                                   STATUS_LEFT as libc::c_int as libc::c_uint
                               {
                                key =
                                    KEYC_MOUSEDRAG1_STATUS_LEFT as
                                        libc::c_ulong as key_code
                            }
                            if where_0 as libc::c_uint ==
                                   STATUS_RIGHT as libc::c_int as libc::c_uint
                               {
                                key =
                                    KEYC_MOUSEDRAG1_STATUS_RIGHT as
                                        libc::c_ulong as key_code
                            }
                            if where_0 as libc::c_uint ==
                                   STATUS_DEFAULT as libc::c_int as
                                       libc::c_uint {
                                key =
                                    KEYC_MOUSEDRAG1_STATUS_DEFAULT as
                                        libc::c_ulong as key_code
                            }
                            if where_0 as libc::c_uint ==
                                   BORDER as libc::c_int as libc::c_uint {
                                key =
                                    KEYC_MOUSEDRAG1_BORDER as libc::c_ulong as
                                        key_code
                            }
                        }
                        1 => {
                            if where_0 as libc::c_uint ==
                                   PANE as libc::c_int as libc::c_uint {
                                key =
                                    KEYC_MOUSEDRAG2_PANE as libc::c_ulong as
                                        key_code
                            }
                            if where_0 as libc::c_uint ==
                                   STATUS as libc::c_int as libc::c_uint {
                                key =
                                    KEYC_MOUSEDRAG2_STATUS as libc::c_ulong as
                                        key_code
                            }
                            if where_0 as libc::c_uint ==
                                   STATUS_LEFT as libc::c_int as libc::c_uint
                               {
                                key =
                                    KEYC_MOUSEDRAG2_STATUS_LEFT as
                                        libc::c_ulong as key_code
                            }
                            if where_0 as libc::c_uint ==
                                   STATUS_RIGHT as libc::c_int as libc::c_uint
                               {
                                key =
                                    KEYC_MOUSEDRAG2_STATUS_RIGHT as
                                        libc::c_ulong as key_code
                            }
                            if where_0 as libc::c_uint ==
                                   STATUS_DEFAULT as libc::c_int as
                                       libc::c_uint {
                                key =
                                    KEYC_MOUSEDRAG2_STATUS_DEFAULT as
                                        libc::c_ulong as key_code
                            }
                            if where_0 as libc::c_uint ==
                                   BORDER as libc::c_int as libc::c_uint {
                                key =
                                    KEYC_MOUSEDRAG2_BORDER as libc::c_ulong as
                                        key_code
                            }
                        }
                        2 => {
                            if where_0 as libc::c_uint ==
                                   PANE as libc::c_int as libc::c_uint {
                                key =
                                    KEYC_MOUSEDRAG3_PANE as libc::c_ulong as
                                        key_code
                            }
                            if where_0 as libc::c_uint ==
                                   STATUS as libc::c_int as libc::c_uint {
                                key =
                                    KEYC_MOUSEDRAG3_STATUS as libc::c_ulong as
                                        key_code
                            }
                            if where_0 as libc::c_uint ==
                                   STATUS_LEFT as libc::c_int as libc::c_uint
                               {
                                key =
                                    KEYC_MOUSEDRAG3_STATUS_LEFT as
                                        libc::c_ulong as key_code
                            }
                            if where_0 as libc::c_uint ==
                                   STATUS_RIGHT as libc::c_int as libc::c_uint
                               {
                                key =
                                    KEYC_MOUSEDRAG3_STATUS_RIGHT as
                                        libc::c_ulong as key_code
                            }
                            if where_0 as libc::c_uint ==
                                   STATUS_DEFAULT as libc::c_int as
                                       libc::c_uint {
                                key =
                                    KEYC_MOUSEDRAG3_STATUS_DEFAULT as
                                        libc::c_ulong as key_code
                            }
                            if where_0 as libc::c_uint ==
                                   BORDER as libc::c_int as libc::c_uint {
                                key =
                                    KEYC_MOUSEDRAG3_BORDER as libc::c_ulong as
                                        key_code
                            }
                        }
                        _ => { }
		 ...
		 */
            ...
            5 => {
                if b & 3 as libc::c_int as libc::c_uint ==
                    ...
                    if where_0 as libc::c_uint ==
                           STATUS_LEFT as libc::c_int as libc::c_uint {
                        key =
                            KEYC_WHEELUP_STATUS_LEFT as libc::c_ulong as
                                key_code
                    }
                    if where_0 as libc::c_uint ==
                           STATUS_RIGHT as libc::c_int as libc::c_uint {
                        key =
                            KEYC_WHEELUP_STATUS_RIGHT as libc::c_ulong as
                                key_code
                    }
                    if where_0 as libc::c_uint ==
                           STATUS_DEFAULT as libc::c_int as libc::c_uint {
                        key =
                            KEYC_WHEELUP_STATUS_DEFAULT as libc::c_ulong as
                                key_code
                    }
                    if where_0 as libc::c_uint ==
                           BORDER as libc::c_int as libc::c_uint {
                    ...
                    if where_0 as libc::c_uint ==
                           STATUS as libc::c_int as libc::c_uint {
                        key =
                            KEYC_WHEELDOWN_STATUS as libc::c_ulong as key_code
                    }
                    if where_0 as libc::c_uint ==
                           STATUS_LEFT as libc::c_int as libc::c_uint {
                        key =
                            KEYC_WHEELDOWN_STATUS_LEFT as libc::c_ulong as
                                key_code
                    }
                    if where_0 as libc::c_uint ==
                           STATUS_RIGHT as libc::c_int as libc::c_uint {
                        key =
                            KEYC_WHEELDOWN_STATUS_RIGHT as libc::c_ulong as
                                key_code
                    }
                    if where_0 as libc::c_uint ==
                           STATUS_DEFAULT as libc::c_int as libc::c_uint {
                        key =
                            KEYC_WHEELDOWN_STATUS_DEFAULT as libc::c_ulong as
                                key_code
                    }
                    if where_0 as libc::c_uint ==
                           BORDER as libc::c_int as libc::c_uint {
                        key =
                            KEYC_WHEELDOWN_BORDER as libc::c_ulong as key_code
                    }
                }
            }
            3 => {
                match b & 3 as libc::c_int as libc::c_uint {
                    0 => {
                        if where_0 as libc::c_uint ==
                               PANE as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEUP1_PANE as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEUP1_STATUS as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_LEFT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEUP1_STATUS_LEFT as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_RIGHT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEUP1_STATUS_RIGHT as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_DEFAULT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEUP1_STATUS_DEFAULT as libc::c_ulong
                                    as key_code
                        }
                        if where_0 as libc::c_uint ==
                               BORDER as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEUP1_BORDER as libc::c_ulong as
                                    key_code
                        }
                    }
                    1 => {
                        if where_0 as libc::c_uint ==
                               PANE as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEUP2_PANE as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEUP2_STATUS as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_LEFT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEUP2_STATUS_LEFT as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_RIGHT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEUP2_STATUS_RIGHT as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_DEFAULT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEUP2_STATUS_DEFAULT as libc::c_ulong
                                    as key_code
                        }
                        if where_0 as libc::c_uint ==
                               BORDER as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEUP2_BORDER as libc::c_ulong as
                                    key_code
                        }
                    }
                    2 => {
                        if where_0 as libc::c_uint ==
                               PANE as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEUP3_PANE as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEUP3_STATUS as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_LEFT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEUP3_STATUS_LEFT as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_RIGHT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEUP3_STATUS_RIGHT as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_DEFAULT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEUP3_STATUS_DEFAULT as libc::c_ulong
                                    as key_code
                        }
                        if where_0 as libc::c_uint ==
                               BORDER as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEUP3_BORDER as libc::c_ulong as
                                    key_code
                        }
                    }
                    _ => { }
                ...
                match b & 3 as libc::c_int as libc::c_uint {
                    0 => {
                        if where_0 as libc::c_uint ==
                               PANE as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEDOWN1_PANE as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEDOWN1_STATUS as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_LEFT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEDOWN1_STATUS_LEFT as libc::c_ulong
                                    as key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_RIGHT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEDOWN1_STATUS_RIGHT as libc::c_ulong
                                    as key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_DEFAULT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEDOWN1_STATUS_DEFAULT as
                                    libc::c_ulong as key_code
                        }
                        if where_0 as libc::c_uint ==
                               BORDER as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEDOWN1_BORDER as libc::c_ulong as
                                    key_code
                        }
                    }
                    1 => {
                        if where_0 as libc::c_uint ==
                               PANE as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEDOWN2_PANE as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEDOWN2_STATUS as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_LEFT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEDOWN2_STATUS_LEFT as libc::c_ulong
                                    as key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_RIGHT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEDOWN2_STATUS_RIGHT as libc::c_ulong
                                    as key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_DEFAULT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEDOWN2_STATUS_DEFAULT as
                                    libc::c_ulong as key_code
                        }
                        if where_0 as libc::c_uint ==
                               BORDER as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEDOWN2_BORDER as libc::c_ulong as
                                    key_code
                        }
                    }
                    2 => {
                        ...
                        if where_0 as libc::c_uint ==
                               STATUS as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEDOWN3_STATUS as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_LEFT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEDOWN3_STATUS_LEFT as libc::c_ulong
                                    as key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_RIGHT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEDOWN3_STATUS_RIGHT as libc::c_ulong
                                    as key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_DEFAULT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEDOWN3_STATUS_DEFAULT as
                                    libc::c_ulong as key_code
                        }
                        if where_0 as libc::c_uint ==
                               BORDER as libc::c_int as libc::c_uint {
                            key =
                                KEYC_MOUSEDOWN3_BORDER as libc::c_ulong as
                                    key_code
                        }
                    }
                    _ => { }
                ...
                match b & 3 as libc::c_int as libc::c_uint {
                    0 => {
                        if where_0 as libc::c_uint ==
                               PANE as libc::c_int as libc::c_uint {
                            key =
                                KEYC_SECONDCLICK1_PANE as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS as libc::c_int as libc::c_uint {
                            key =
                                KEYC_SECONDCLICK1_STATUS as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_LEFT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_SECONDCLICK1_STATUS_LEFT as libc::c_ulong
                                    as key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_RIGHT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_SECONDCLICK1_STATUS_RIGHT as
                                    libc::c_ulong as key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_DEFAULT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_SECONDCLICK1_STATUS_DEFAULT as
                                    libc::c_ulong as key_code
                        }
                        if where_0 as libc::c_uint ==
                               BORDER as libc::c_int as libc::c_uint {
                            key =
                                KEYC_SECONDCLICK1_BORDER as libc::c_ulong as
                                    key_code
                        }
                    }
                    1 => {
                        if where_0 as libc::c_uint ==
                               PANE as libc::c_int as libc::c_uint {
                            key =
                                KEYC_SECONDCLICK2_PANE as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS as libc::c_int as libc::c_uint {
                            key =
                                KEYC_SECONDCLICK2_STATUS as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_LEFT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_SECONDCLICK2_STATUS_LEFT as libc::c_ulong
                                    as key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_RIGHT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_SECONDCLICK2_STATUS_RIGHT as
                                    libc::c_ulong as key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_DEFAULT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_SECONDCLICK2_STATUS_DEFAULT as
                                    libc::c_ulong as key_code
                        }
                        if where_0 as libc::c_uint ==
                               BORDER as libc::c_int as libc::c_uint {
                            key =
                                KEYC_SECONDCLICK2_BORDER as libc::c_ulong as
                                    key_code
                        }
                    }
                    2 => {
                        if where_0 as libc::c_uint ==
                               PANE as libc::c_int as libc::c_uint {
                            key =
                                KEYC_SECONDCLICK3_PANE as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS as libc::c_int as libc::c_uint {
                            key =
                                KEYC_SECONDCLICK3_STATUS as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_LEFT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_SECONDCLICK3_STATUS_LEFT as libc::c_ulong
                                    as key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_RIGHT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_SECONDCLICK3_STATUS_RIGHT as
                                    libc::c_ulong as key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_DEFAULT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_SECONDCLICK3_STATUS_DEFAULT as
                                    libc::c_ulong as key_code
                        }
                        if where_0 as libc::c_uint ==
                               BORDER as libc::c_int as libc::c_uint {
                            key =
                                KEYC_SECONDCLICK3_BORDER as libc::c_ulong as
                                    key_code
                        }
                    }
                    _ => { }
                ...
                match b & 3 as libc::c_int as libc::c_uint {
                    0 => {
                        ...
                        if where_0 as libc::c_uint ==
                               STATUS as libc::c_int as libc::c_uint {
                            key =
                                KEYC_DOUBLECLICK1_STATUS as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_LEFT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_DOUBLECLICK1_STATUS_LEFT as libc::c_ulong
                                    as key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_RIGHT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_DOUBLECLICK1_STATUS_RIGHT as
                                    libc::c_ulong as key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_DEFAULT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_DOUBLECLICK1_STATUS_DEFAULT as
                                    libc::c_ulong as key_code
                        }
                        if where_0 as libc::c_uint ==
                               BORDER as libc::c_int as libc::c_uint {
                            key =
                                KEYC_DOUBLECLICK1_BORDER as libc::c_ulong as
                                    key_code
                        }
                    }
                    1 => {
                        if where_0 as libc::c_uint ==
                               PANE as libc::c_int as libc::c_uint {
                            key =
                                KEYC_DOUBLECLICK2_PANE as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS as libc::c_int as libc::c_uint {
                            key =
                                KEYC_DOUBLECLICK2_STATUS as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_LEFT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_DOUBLECLICK2_STATUS_LEFT as libc::c_ulong
                                    as key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_RIGHT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_DOUBLECLICK2_STATUS_RIGHT as
                                    libc::c_ulong as key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_DEFAULT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_DOUBLECLICK2_STATUS_DEFAULT as
                                    libc::c_ulong as key_code
                        }
                        if where_0 as libc::c_uint ==
                               BORDER as libc::c_int as libc::c_uint {
                            key =
                                KEYC_DOUBLECLICK2_BORDER as libc::c_ulong as
                                    key_code
                        }
                    }
                    2 => {
                        if where_0 as libc::c_uint ==
                               PANE as libc::c_int as libc::c_uint {
                            key =
                                KEYC_DOUBLECLICK3_PANE as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS as libc::c_int as libc::c_uint {
                            key =
                                KEYC_DOUBLECLICK3_STATUS as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_LEFT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_DOUBLECLICK3_STATUS_LEFT as libc::c_ulong
                                    as key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_RIGHT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_DOUBLECLICK3_STATUS_RIGHT as
                                    libc::c_ulong as key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_DEFAULT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_DOUBLECLICK3_STATUS_DEFAULT as
                                    libc::c_ulong as key_code
                        }
                        if where_0 as libc::c_uint ==
                               BORDER as libc::c_int as libc::c_uint {
                            key =
                                KEYC_DOUBLECLICK3_BORDER as libc::c_ulong as
                                    key_code
                        }
                    }
                    _ => { }
                ...
                match b & 3 as libc::c_int as libc::c_uint {
                    0 => {
                        if where_0 as libc::c_uint ==
                               PANE as libc::c_int as libc::c_uint {
                            key =
                                KEYC_TRIPLECLICK1_PANE as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS as libc::c_int as libc::c_uint {
                            key =
                                KEYC_TRIPLECLICK1_STATUS as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_LEFT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_TRIPLECLICK1_STATUS_LEFT as libc::c_ulong
                                    as key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_RIGHT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_TRIPLECLICK1_STATUS_RIGHT as
                                    libc::c_ulong as key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_DEFAULT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_TRIPLECLICK1_STATUS_DEFAULT as
                                    libc::c_ulong as key_code
                        }
                        if where_0 as libc::c_uint ==
                               BORDER as libc::c_int as libc::c_uint {
                            key =
                                KEYC_TRIPLECLICK1_BORDER as libc::c_ulong as
                                    key_code
                        }
                    }
                    1 => {
                        if where_0 as libc::c_uint ==
                               PANE as libc::c_int as libc::c_uint {
                            key =
                                KEYC_TRIPLECLICK2_PANE as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS as libc::c_int as libc::c_uint {
                            key =
                                KEYC_TRIPLECLICK2_STATUS as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_LEFT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_TRIPLECLICK2_STATUS_LEFT as libc::c_ulong
                                    as key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_RIGHT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_TRIPLECLICK2_STATUS_RIGHT as
                                    libc::c_ulong as key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_DEFAULT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_TRIPLECLICK2_STATUS_DEFAULT as
                                    libc::c_ulong as key_code
                        }
                        if where_0 as libc::c_uint ==
                               BORDER as libc::c_int as libc::c_uint {
                            key =
                                KEYC_TRIPLECLICK2_BORDER as libc::c_ulong as
                                    key_code
                        }
                    }
                    2 => {
                        if where_0 as libc::c_uint ==
                               PANE as libc::c_int as libc::c_uint {
                            key =
                                KEYC_TRIPLECLICK3_PANE as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS as libc::c_int as libc::c_uint {
                            key =
                                KEYC_TRIPLECLICK3_STATUS as libc::c_ulong as
                                    key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_LEFT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_TRIPLECLICK3_STATUS_LEFT as libc::c_ulong
                                    as key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_RIGHT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_TRIPLECLICK3_STATUS_RIGHT as
                                    libc::c_ulong as key_code
                        }
                        if where_0 as libc::c_uint ==
                               STATUS_DEFAULT as libc::c_int as libc::c_uint {
                            key =
                                KEYC_TRIPLECLICK3_STATUS_DEFAULT as
                                    libc::c_ulong as key_code
                        }
                        if where_0 as libc::c_uint ==
                               BORDER as libc::c_int as libc::c_uint {
                            key =
                                KEYC_TRIPLECLICK3_BORDER as libc::c_ulong as
                                    key_code
                        }
                    }
                    _ => { }
    ...
    if log_get_level() != 0 as libc::c_int {
        log_debug(b"mouse key is %s\x00" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn server_client_assume_paste(mut s: *mut session)
 -> libc::c_int {
    ...
    if t == 0 as libc::c_int { return 0 as libc::c_int }
    ...
    if tv.tv_sec == 0 as libc::c_int as libc::c_long &&
        ...
        if (*s).flags & 0x1 as libc::c_int != 0 { return 1 as libc::c_int }
...
unsafe extern "C" fn server_client_update_latest(mut c: *mut client) {
    ...
    if (*c).session.is_null() { return }
    w = (*(*(*c).session).curw).window;
    if (*w).latest == c as *mut libc::c_void { return }
 ...
 */
unsafe extern "C" fn server_client_key_callback(mut item: *mut cmdq_item,
 ...
 -> cmd_retval {
    ...
    if !(s.is_null() ||
        ...
        if key == KEYC_MOUSE as libc::c_ulong as libc::c_ulonglong ||
               key == KEYC_DOUBLECLICK as libc::c_ulong as libc::c_ulonglong {
		 ...
		 */
                    if key & 0xfffffffffff as libc::c_ulonglong ==
                           KEYC_DRAGGING as libc::c_ulong as libc::c_ulonglong
                       {
            ...
            _ => {
                ...
                if !(key & 0xfffffffffff as libc::c_ulonglong >=
                         ...
                         (key & 0xfffffffffff as libc::c_ulonglong) <
                             KEYC_BSPACE as libc::c_ulong as
                                 libc::c_ulonglong) ||
                       cmd_find_from_mouse(&mut fs, m, 0 as libc::c_int) !=
                           0 as libc::c_int {
	 ...
	 */
                    if server_client_is_default_key_table(c, (*c).keytable) !=
                           0 && !wp.is_null() &&
                           { wme = (*wp).modes.tqh_first; !wme.is_null() } &&
                           (*(*wme).mode).key_table.is_some() {
                        table =
                            key_bindings_get_table((*(*wme).mode).key_table.expect("non-null function pointer")(wme),
                                                   1 as libc::c_int)
		 ...
		 */
                                    if (*c).flags &
                                        ...
                                        break ;
                                              ...
                                              KEYC_ANY as libc::c_ulong as
                                                  libc::c_ulonglong {
                                    key0 =
                                        KEYC_ANY as libc::c_ulong as key_code
                                } else {
                                    /*
	 ...
	 */
                                    log_debug(b"not found in key table %s\x00"
                                                  ...
                                                  *const libc::c_char,
                                              (*table).name);
                                    if server_client_is_default_key_table(c,
                                                                          table)
                                           == 0 ||
                                           (*c).flags &
                                               0x20 as libc::c_int as
	 ...
	 */
                                ...
                                3938820862080741272 => {
                                    log_debug(b"found in key table %s (not repeating)\x00"
                                                  as *const u8 as
                                                  *const libc::c_char,
                                              (*table).name);
                                    server_client_set_key_table(c,
                                ...
                                5028470053297453708 => {
                                    log_debug(b"trying in root table\x00" as
                                                  *const u8 as
                                                  *const libc::c_char);
                                    server_client_set_key_table(c,
                                                                0 as
                                ...
                                _ => {
                                    log_debug(b"found in key table %s\x00" as
                                                  *const u8 as
                                                  *const libc::c_char,
                                              (*table).name);
                                    /*
		 ...
		 */
                                    ...
                                    key_bindings_dispatch(bd, item, c, event,
                                                          &mut fs);
                ...
                match current_block {
                    ...
                    _ => {
                        if !((*c).flags &
                                 0x800 as libc::c_int as libc::c_ulong != 0) {
                            if !wp.is_null() {
    ...
    if !s.is_null() &&
           key != KEYC_FOCUS_OUT as libc::c_ulong as libc::c_ulonglong {
 ...
 -> libc::c_int {
    ...
    if !(*c).flags & 0x800 as libc::c_int as libc::c_ulong != 0 {
        ...
        if (*c).overlay_key.is_some() {
            match (*c).overlay_key.expect("non-null function pointer")(c,
                                                                       event)
                {
	 ...
	 */
    item =
        cmdq_get_callback1(b"server_client_key_callback\x00" as *const u8 as
                               *const libc::c_char,
                           Some(server_client_key_callback as
    ...
    while !w.is_null() {
        ...
        while !wp.is_null() {
            if (*wp).fd != -(1 as libc::c_int) {
                if focus != 0 { server_client_check_pane_focus(wp); }
...
unsafe extern "C" fn server_client_check_window_resize(mut w: *mut window) {
    let mut wl: *mut winlink = 0 as *mut winlink;
    if !(*w).flags & 0x20 as libc::c_int != 0 { return }
    ...
    log_debug(b"%s: resizing window @%u\x00" as *const u8 as
                  *const libc::c_char,
              (*::std::mem::transmute::<&[u8; 34],
                                        &[libc::c_char; 34]>(b"server_client_check_window_resize\x00")).as_ptr(),
              (*w).id);
    resize_window(w, (*w).new_sx, (*w).new_sy, (*w).new_xpixel as libc::c_int,
                  (*w).new_ypixel as libc::c_int);
}
/* Resize timer event. */
unsafe extern "C" fn server_client_resize_timer(mut fd: libc::c_int,
                                                mut events: libc::c_short,
                                                mut data: *mut libc::c_void) {
    let mut wp: *mut window_pane = data as *mut window_pane;
    log_debug(b"%s: %%%u resize timer expired\x00" as *const u8 as
                  *const libc::c_char,
              (*::std::mem::transmute::<&[u8; 27],
                                        &[libc::c_char; 27]>(b"server_client_resize_timer\x00")).as_ptr(),
              (*wp).id);
    event_del(&mut (*wp).resize_timer);
}
/* Start the resize timer. */
unsafe extern "C" fn server_client_start_resize_timer(mut wp:
                                                          *mut window_pane) {
    let mut tv: timeval =
        {
            let mut init =
    ...
    log_debug(b"%s: %%%u resize timer started\x00" as *const u8 as
                  *const libc::c_char,
              (*::std::mem::transmute::<&[u8; 33],
                                        &[libc::c_char; 33]>(b"server_client_start_resize_timer\x00")).as_ptr(),
              (*wp).id);
    event_add(&mut (*wp).resize_timer, &mut tv);
}
/* Force timer event. */
unsafe extern "C" fn server_client_force_timer(mut fd: libc::c_int,
                                               mut events: libc::c_short,
                                               mut data: *mut libc::c_void) {
    let mut wp: *mut window_pane = data as *mut window_pane;
    log_debug(b"%s: %%%u force timer expired\x00" as *const u8 as
                  *const libc::c_char,
              (*::std::mem::transmute::<&[u8; 26],
                                        &[libc::c_char; 26]>(b"server_client_force_timer\x00")).as_ptr(),
              (*wp).id);
    event_del(&mut (*wp).force_timer);
    (*wp).flags |= 0x2000 as libc::c_int;
}
/* Start the force timer. */
unsafe extern "C" fn server_client_start_force_timer(mut wp:
                                                         *mut window_pane) {
    let mut tv: timeval =
        {
            let mut init =
    ...
    log_debug(b"%s: %%%u force timer started\x00" as *const u8 as
                  *const libc::c_char,
              (*::std::mem::transmute::<&[u8; 32],
                                        &[libc::c_char; 32]>(b"server_client_start_force_timer\x00")).as_ptr(),
              (*wp).id);
    event_add(&mut (*wp).force_timer, &mut tv);
}
/* Check if pane should be resized. */
unsafe extern "C" fn server_client_check_pane_resize(mut wp:
                                                         *mut window_pane) {
    if event_initialized(&mut (*wp).resize_timer) == 0 {
        event_set(&mut (*wp).resize_timer, -(1 as libc::c_int),
                  0 as libc::c_int as libc::c_short,
                  Some(server_client_resize_timer as
                           unsafe extern "C" fn(_: libc::c_int,
                                                _: libc::c_short,
                                                _: *mut libc::c_void) -> ()),
    ...
    if event_initialized(&mut (*wp).force_timer) == 0 {
        event_set(&mut (*wp).force_timer, -(1 as libc::c_int),
                  0 as libc::c_int as libc::c_short,
                  Some(server_client_force_timer as
                           unsafe extern "C" fn(_: libc::c_int,
                                                _: libc::c_short,
                                                _: *mut libc::c_void) -> ()),
                  wp as *mut libc::c_void);
    }
    if !(*wp).flags & 0x8 as libc::c_int != 0 { return }
    log_debug(b"%s: %%%u needs to be resized\x00" as *const u8 as
                  *const libc::c_char,
              (*::std::mem::transmute::<&[u8; 32],
                                        &[libc::c_char; 32]>(b"server_client_check_pane_resize\x00")).as_ptr(),
              (*wp).id);
    if event_pending(&mut (*wp).resize_timer,
                     0x1 as libc::c_int as libc::c_short, 0 as *mut timeval)
           != 0 {
        log_debug(b"%s: %%%u resize timer is running\x00" as *const u8 as
                      *const libc::c_char,
                  (*::std::mem::transmute::<&[u8; 32],
                                            &[libc::c_char; 32]>(b"server_client_check_pane_resize\x00")).as_ptr(),
                  (*wp).id);
    ...
    if !(*wp).flags & 0x10 as libc::c_int != 0 {
		 ...
		 */
        log_debug(b"%s: resizing %%%u now\x00" as *const u8 as
                      *const libc::c_char,
                  (*::std::mem::transmute::<&[u8; 32],
                                            &[libc::c_char; 32]>(b"server_client_check_pane_resize\x00")).as_ptr(),
                  (*wp).id);
        ...
        log_debug(b"%s: resizing %%%u after forced resize\x00" as *const u8 as
                      *const libc::c_char,
                  (*::std::mem::transmute::<&[u8; 32],
                                            &[libc::c_char; 32]>(b"server_client_check_pane_resize\x00")).as_ptr(),
                  (*wp).id);
    ...
    } else if event_pending(&mut (*wp).force_timer,
                            0x1 as libc::c_int as libc::c_short,
                            0 as *mut timeval) == 0 {
        log_debug(b"%s: forcing resize of %%%u\x00" as *const u8 as
                      *const libc::c_char,
                  (*::std::mem::transmute::<&[u8; 32],
                                            &[libc::c_char; 32]>(b"server_client_check_pane_resize\x00")).as_ptr(),
                  (*wp).id);
...
unsafe extern "C" fn server_client_check_pane_buffer(mut wp:
                                                         *mut window_pane) {
        ...
        if !(*c).session.is_null() {
            ...
            if !(*c).flags & 0x2000 as libc::c_int as libc::c_ulong != 0 {
                ...
                if wpo.is_null() {
                    ...
                    if flag == 0 { off = 0 as libc::c_int }
                    window_pane_get_new_data(wp, wpo, &mut new_size);
                    log_debug(b"%s: %s has %zu bytes used and %zu left for %%%u\x00"
                                  as *const u8 as *const libc::c_char,
                              (*::std::mem::transmute::<&[u8; 32],
                                                        &[libc::c_char; 32]>(b"server_client_check_pane_buffer\x00")).as_ptr(),
                              (*c).name,
                              (*wpo).used.wrapping_sub((*wp).base_offset),
                              new_size, (*wp).id);
                    if (*wpo).used < minimum { minimum = (*wpo).used }
                }
            }
        }
        c = (*c).entry.tqe_next
    ...
    minimum =
        (minimum as libc::c_ulong).wrapping_sub((*wp).base_offset) as size_t
            as size_t;
    if !(minimum == 0 as libc::c_int as libc::c_ulong) {
        /* Drain the buffer. */
        log_debug(b"%s: %%%u has %zu minimum (of %zu) bytes used\x00" as
                      *const u8 as *const libc::c_char,
                  (*::std::mem::transmute::<&[u8; 32],
                                            &[libc::c_char; 32]>(b"server_client_check_pane_buffer\x00")).as_ptr(),
                  (*wp).id, minimum, evbuffer_get_length(evb));
	 ...
	 */
        if (*wp).base_offset >
               (18446744073709551615 as libc::c_ulong).wrapping_sub(minimum) {
            log_debug(b"%s: %%%u base offset has wrapped\x00" as *const u8 as
                          *const libc::c_char,
                      (*::std::mem::transmute::<&[u8; 32],
                                                &[libc::c_char; 32]>(b"server_client_check_pane_buffer\x00")).as_ptr(),
                      (*wp).id);
            (*wp).offset.used =
                ((*wp).offset.used as
                     libc::c_ulong).wrapping_sub((*wp).base_offset) as size_t
                    as size_t;
            if (*wp).pipe_fd != -(1 as libc::c_int) {
                (*wp).pipe_offset.used =
                    ((*wp).pipe_offset.used as
                         libc::c_ulong).wrapping_sub((*wp).base_offset) as
                        size_t as size_t
            }
            c = clients.tqh_first;
            while !c.is_null() {
                if !((*c).session.is_null() ||
                         !(*c).flags & 0x2000 as libc::c_int as libc::c_ulong
                             != 0) {
                    wpo = control_pane_offset(c, wp, &mut flag);
                    if !wpo.is_null() && flag == 0 {
                        (*wpo).used =
                            ((*wpo).used as
                                 libc::c_ulong).wrapping_sub((*wp).base_offset)
                                as size_t as size_t
                    }
                }
                c = (*c).entry.tqe_next
            ...
            (*wp).base_offset =
                ((*wp).base_offset as libc::c_ulong).wrapping_add(minimum) as
                    size_t as size_t
        }
    }
    /*
	 ...
	 */
    log_debug(b"%s: pane %%%u is %s\x00" as *const u8 as *const libc::c_char,
              (*::std::mem::transmute::<&[u8; 32],
                                        &[libc::c_char; 32]>(b"server_client_check_pane_buffer\x00")).as_ptr(),
              (*wp).id,
              if off != 0 {
...
unsafe extern "C" fn server_client_check_pane_focus(mut wp:
                                                        *mut window_pane) {
    let mut current_block: u64;
    let mut c: *mut client = 0 as *mut client;
	 ...
	 */
        c = clients.tqh_first;
        loop  {
            if c.is_null() { current_block = 12717618590137386175; break ; }
            if !((*c).session.is_null() ||
                     (*c).flags & 0x8000 as libc::c_int as libc::c_ulong == 0)
               {
        ...
        match current_block {
            ...
            _ => {
                if push != 0 || (*wp).flags & 0x4 as libc::c_int == 0 {
                    ...
                    notify_pane(b"pane-focus-in\x00" as *const u8 as
    ...
    if push != 0 || (*wp).flags & 0x4 as libc::c_int != 0 {
        ...
        notify_pane(b"pane-focus-out\x00" as *const u8 as *const libc::c_char,
                    wp);
    }
    (*wp).flags &= !(0x4 as libc::c_int);
}
...
unsafe extern "C" fn server_client_reset_state(mut c: *mut client) {
    ...
    let mut sy: u_int = 0;
    if (*c).flags &
           (0x2000 as libc::c_int | 0x40 as libc::c_int) as libc::c_ulong != 0
       {
        return
    }
    ...
    if (*c).overlay_draw.is_some() {
        if (*c).overlay_mode.is_some() {
            s =
                (*c).overlay_mode.expect("non-null function pointer")(c,
                                                                      &mut cx,
                                                                      &mut cy)
        }
    } else { s = (*wp).screen }
    if !s.is_null() { mode = (*s).mode }
    log_debug(b"%s: client %s mode %x\x00" as *const u8 as
                  *const libc::c_char,
              (*::std::mem::transmute::<&[u8; 26],
                                        &[libc::c_char; 26]>(b"server_client_reset_state\x00")).as_ptr(),
              (*c).name, mode);
    ...
    if (*c).overlay_draw.is_none() {
        ...
        if (*wp).xoff.wrapping_add((*s).cx) >= ox &&
            ...
            if status_at_line(c) == 0 as libc::c_int {
                cy =
                    (cy as libc::c_uint).wrapping_add(status_line_size(c)) as
                        u_int as u_int
            }
        }
        if cursor == 0 { mode &= !(0x1 as libc::c_int) }
    }
    log_debug(b"%s: cursor to %u,%u\x00" as *const u8 as *const libc::c_char,
              (*::std::mem::transmute::<&[u8; 26],
                                        &[libc::c_char; 26]>(b"server_client_reset_state\x00")).as_ptr(),
              cx, cy);
    ...
    if options_get_number(oo,
        ...
        if !mode & 0x1000 as libc::c_int != 0 { mode |= 0x40 as libc::c_int }
    }
...
unsafe extern "C" fn server_client_click_timer(mut fd: libc::c_int,
    ...
    if (*c).flags & 0x200000 as libc::c_int as libc::c_ulong != 0 {
		 ...
		 */
        event =
            xmalloc(::std::mem::size_of::<key_event>() as libc::c_ulong) as
                *mut key_event;
        (*event).key = KEYC_DOUBLECLICK as libc::c_ulong as key_code;
        memcpy(&mut (*event).m as *mut mouse_event as *mut libc::c_void,
               &mut (*c).click_event as *mut mouse_event as
                   *const libc::c_void,
    ...
    (*c).flags &=
        !(0x100000 as libc::c_int | 0x200000 as libc::c_int) as libc::c_ulong;
}
...
unsafe extern "C" fn server_client_check_exit(mut c: *mut client) {
    ...
    if (*c).flags &
           (0x200 as libc::c_int | 0x100 as libc::c_int) as libc::c_ulong != 0
       {
        return
    }
    if !(*c).flags & 0x4 as libc::c_int as libc::c_ulong != 0 { return }
    if (*c).flags & 0x2000 as libc::c_int as libc::c_ulong != 0 {
        control_discard(c);
        if control_all_done(c) == 0 { return }
    }
    cf = client_files_RB_MINMAX(&mut (*c).files, -(1 as libc::c_int));
    while !cf.is_null() {
        if evbuffer_get_length((*cf).buffer) !=
    ...
    match (*c).exit_type as libc::c_uint {
        0 => {
            if !(*c).exit_message.is_null() {
                msize =
                    strlen((*c).exit_message).wrapping_add(1 as libc::c_int as
                                                               libc::c_ulong);
                size =
                    (::std::mem::size_of::<libc::c_int>() as
                         libc::c_ulong).wrapping_add(msize)
            } else {
                size = ::std::mem::size_of::<libc::c_int>() as libc::c_ulong
            }
            data = xmalloc(size) as *mut libc::c_char;
            memcpy(data as *mut libc::c_void,
                   &mut (*c).retval as *mut libc::c_int as
                       *const libc::c_void,
                   ::std::mem::size_of::<libc::c_int>() as libc::c_ulong);
            if !(*c).exit_message.is_null() {
                memcpy(data.offset(::std::mem::size_of::<libc::c_int>() as
                                       libc::c_ulong as isize) as
                           *mut libc::c_void,
                       (*c).exit_message as *const libc::c_void, msize);
            }
            proc_send((*c).peer, MSG_EXIT, -(1 as libc::c_int),
                      data as *const libc::c_void, size);
            free(data as *mut libc::c_void);
        }
        1 => {
            proc_send((*c).peer, MSG_SHUTDOWN, -(1 as libc::c_int),
                      0 as *const libc::c_void, 0 as libc::c_int as size_t);
        }
        2 => {
            proc_send((*c).peer, (*c).exit_msgtype, -(1 as libc::c_int),
...
unsafe extern "C" fn server_client_check_redraw(mut c: *mut client) {
    ...
    static mut ev: event =
        event{ev_evcallback:
                  event_callback{evcb_active_next:
                                 ...
                                 evcb_closure: 0,
                                 evcb_cb_union:
                                     C2RustUnnamed_6{evcb_callback: None,},
                                 evcb_arg:
                                     0 as *const libc::c_void as
                                         *mut libc::c_void,},
              ev_timeout_pos:
                  C2RustUnnamed_4{ev_next_with_common_timeout:
                                      C2RustUnnamed_5{tqe_next:
                                                          0 as *const event as
                                                              *mut event,
                                                      tqe_prev:
                                                          0 as
              ...
              ev_:
                  C2RustUnnamed{ev_io:
                                    C2RustUnnamed_2{ev_io_next:
                                                        C2RustUnnamed_3{le_next:
                                                                            0
                                                                                as
                                                                                *const event
                                                                                as
    ...
    if (*c).flags &
           (0x8 as libc::c_int | 0x10 as libc::c_int |
                0x1000000 as libc::c_int | 0x400 as libc::c_int |
                0x2000000 as libc::c_int | 0x20000000 as libc::c_int) as
               libc::c_ulong != 0 {
        log_debug(b"%s: redraw%s%s%s%s%s\x00" as *const u8 as
                  ...
                  if (*c).flags & 0x2000000 as libc::c_int as libc::c_ulong !=
                         0 {
                      b" overlay\x00" as *const u8 as *const libc::c_char
                  } else { b"\x00" as *const u8 as *const libc::c_char },
                  if (*c).flags & 0x20000000 as libc::c_int as libc::c_ulong
                         != 0 {
    ...
    if (*c).flags &
        ...
        if needed != 0 { new_flags |= 0x20000000 as libc::c_int }
    }
    if needed != 0 &&
           {
        ...
        if event_initialized(&mut ev) == 0 {
            event_set(&mut ev, -(1 as libc::c_int),
                      0 as libc::c_int as libc::c_short,
                      Some(server_client_redraw_timer as
                               unsafe extern "C" fn(_: libc::c_int,
                                                    _: libc::c_short,
                                                    _: *mut libc::c_void)
                                   -> ()), 0 as *mut libc::c_void);
        }
        if event_pending(&mut ev, 0x1 as libc::c_int as libc::c_short,
                         0 as *mut timeval) == 0 {
        ...
        if !(*c).flags & 0x8 as libc::c_int as libc::c_ulong != 0 {
            ...
            while !wp.is_null() {
                if (*wp).flags & 0x1 as libc::c_int != 0 {
                    log_debug(b"%s: pane %%%u needs redraw\x00" as *const u8
                                  as *const libc::c_char, (*c).name,
                              (*wp).id);
                    (*c).redraw_panes |=
                        ((1 as libc::c_int) << bit) as libc::c_ulong
                }
    ...
    (*tty).flags =
        (*tty).flags & !(0x80 as libc::c_int | 0x2 as libc::c_int) |
            0x1 as libc::c_int;
    if !(*c).flags & 0x8 as libc::c_int as libc::c_ulong != 0 {
        /*
        ...
        while !wp.is_null() {
            ...
            } else if (*c).flags & 0x20000000 as libc::c_int as libc::c_ulong
                          != 0 {
                redraw =
                    ((*c).redraw_panes &
                         ((1 as libc::c_int) << bit) as libc::c_ulong != 0) as
                        libc::c_int
            }
            bit = bit.wrapping_add(1);
            if !(redraw == 0) {
                log_debug(b"%s: redrawing pane %%%u\x00" as *const u8 as
                              *const libc::c_char,
                          (*::std::mem::transmute::<&[u8; 27],
                                                    &[libc::c_char; 27]>(b"server_client_check_redraw\x00")).as_ptr(),
                          (*wp).id);
    ...
    (*tty).flags =
        (*tty).flags & !(0x1 as libc::c_int) | flags & 0x1 as libc::c_int;
    ...
    (*c).flags &=
        !(0x8 as libc::c_int | 0x10 as libc::c_int | 0x1000000 as libc::c_int
              ...
              0x20000000 as libc::c_int | 0x80000 as libc::c_int) as
            libc::c_ulong;
    if needed != 0 {
        /*
    ...
    template =
        options_get_string((*s).options,
                           b"set-titles-string\x00" as *const u8 as
                               *const libc::c_char);
    ft =
        format_create(c, 0 as *mut cmdq_item, 0 as libc::c_int,
                      0 as libc::c_int);
...
unsafe extern "C" fn server_client_dispatch(mut imsg: *mut imsg,
    ...
    if (*c).flags & 0x200 as libc::c_int as libc::c_ulong != 0 { return }
    if imsg.is_null() { server_client_lost(c); return }
    datalen =
        ((*imsg).hdr.len as
    ...
    match (*imsg).hdr.type_0 {
        ...
        205 => {
            ...
            tty_close(&mut (*c).tty);
            proc_send((*c).peer, MSG_EXITED, -(1 as libc::c_int),
                      0 as *const libc::c_void, 0 as libc::c_int as size_t);
        }
        216 | 215 => {
            if datalen != 0 as libc::c_int as libc::c_long {
            ...
            if !((*c).flags & 0x40 as libc::c_int as libc::c_ulong == 0) {
                ...
                if !((*c).fd == -(1 as libc::c_int) || (*c).session.is_null())
                   {
                    s = (*c).session;
                    if gettimeofday(&mut (*c).activity_time,
                                    0 as *mut libc::c_void) !=
                           0 as libc::c_int {
                        fatal(b"gettimeofday failed\x00" as *const u8 as
                                  *const libc::c_char);
        ...
        305 => { server_client_dispatch_write_ready(c, imsg); }
        301 => { server_client_dispatch_read_data(c, imsg); }
        302 => { server_client_dispatch_read_done(c, imsg); }
        _ => { }
    };
}
...
unsafe extern "C" fn server_client_dispatch_command(mut c: *mut client,
    ...
    memcpy(&mut data as *mut msg_command as *mut libc::c_void, (*imsg).data,
           ::std::mem::size_of::<msg_command>() as libc::c_ulong);
    buf =
        ((*imsg).data as
             *mut libc::c_char).offset(::std::mem::size_of::<msg_command>() as
                                           libc::c_ulong as isize);
    len =
        ((*imsg).hdr.len as
             libc::c_ulong).wrapping_sub(::std::mem::size_of::<imsg_hdr>() as
                                             libc::c_ulong).wrapping_sub(::std::mem::size_of::<msg_command>()
                                                                             as
                                                                             libc::c_ulong);
...
unsafe extern "C" fn server_client_dispatch_identify(mut c: *mut client,
    ...
    match (*imsg).hdr.type_0 {
        109 => {
            if datalen !=
                   ::std::mem::size_of::<libc::c_int>() as libc::c_ulong {
                fatalx(b"bad MSG_IDENTIFY_FEATURES size\x00" as *const u8 as
                           *const libc::c_char);
            }
            memcpy(&mut feat as *mut libc::c_int as *mut libc::c_void,
                   data as *const libc::c_void,
                   ::std::mem::size_of::<libc::c_int>() as libc::c_ulong);
            (*c).term_features |= feat;
            log_debug(b"client %p IDENTIFY_FEATURES %s\x00" as *const u8 as
                          *const libc::c_char, c, tty_get_features(feat));
        }
        100 => {
            if datalen !=
                   ::std::mem::size_of::<libc::c_int>() as libc::c_ulong {
            ...
            memcpy(&mut flags as *mut libc::c_int as *mut libc::c_void,
                   data as *const libc::c_void,
                   ::std::mem::size_of::<libc::c_int>() as libc::c_ulong);
            (*c).flags |= flags as libc::c_ulong;
            log_debug(b"client %p IDENTIFY_FLAGS %#x\x00" as *const u8 as
                          *const libc::c_char, c, flags);
        }
        111 => {
            if datalen != ::std::mem::size_of::<uint64_t>() as libc::c_ulong {
                fatalx(b"bad MSG_IDENTIFY_LONGFLAGS size\x00" as *const u8 as
                           *const libc::c_char);
            }
            memcpy(&mut longflags as *mut uint64_t as *mut libc::c_void,
                   data as *const libc::c_void,
                   ::std::mem::size_of::<uint64_t>() as libc::c_ulong);
            (*c).flags |= longflags;
            log_debug(b"client %p IDENTIFY_LONGFLAGS %#llx\x00" as *const u8
                          as *const libc::c_char, c,
                      longflags as libc::c_ulonglong);
        }
        101 => {
            if datalen == 0 as libc::c_int as libc::c_ulong ||
                   *data.offset(datalen.wrapping_sub(1 as libc::c_int as
                                                         libc::c_ulong) as
                                    isize) as libc::c_int != '\u{0}' as i32 {
            ...
            if *data as libc::c_int == '\u{0}' as i32 {
                (*c).term_name =
                    xstrdup(b"unknown\x00" as *const u8 as
                                *const libc::c_char)
            } else { (*c).term_name = xstrdup(data) }
            log_debug(b"client %p IDENTIFY_TERM %s\x00" as *const u8 as
        ...
        102 => {
            if datalen == 0 as libc::c_int as libc::c_ulong ||
                   *data.offset(datalen.wrapping_sub(1 as libc::c_int as
                                                         libc::c_ulong) as
                                    isize) as libc::c_int != '\u{0}' as i32 {
                fatalx(b"bad MSG_IDENTIFY_TTYNAME string\x00" as *const u8 as
                           *const libc::c_char);
            }
            (*c).ttyname = xstrdup(data);
            log_debug(b"client %p IDENTIFY_TTYNAME %s\x00" as *const u8 as
                          *const libc::c_char, c, data);
        }
        108 => {
            if datalen == 0 as libc::c_int as libc::c_ulong ||
            ...
            if access(data, 1 as libc::c_int) == 0 as libc::c_int {
                ...
                if !home.is_null() {
                    ...
                    (*c).cwd =
                        xstrdup(b"/\x00" as *const u8 as *const libc::c_char)
                }
            }
        ...
        104 => {
            ...
            (*c).fd = (*imsg).fd;
            log_debug(b"client %p IDENTIFY_STDIN %d\x00" as *const u8 as
                          *const libc::c_char, c, (*imsg).fd);
        }
        110 => {
            if datalen != 0 as libc::c_int as libc::c_ulong {
                fatalx(b"bad MSG_IDENTIFY_STDOUT size\x00" as *const u8 as
                           *const libc::c_char);
            }
            (*c).out_fd = (*imsg).fd;
            log_debug(b"client %p IDENTIFY_STDOUT %d\x00" as *const u8 as
                          *const libc::c_char, c, (*imsg).fd);
        }
        105 => {
            if datalen == 0 as libc::c_int as libc::c_ulong ||
                   *data.offset(datalen.wrapping_sub(1 as libc::c_int as
                                                         libc::c_ulong) as
                                    isize) as libc::c_int != '\u{0}' as i32 {
                fatalx(b"bad MSG_IDENTIFY_ENVIRON string\x00" as *const u8 as
                           *const libc::c_char);
            }
            if !strchr(data, '=' as i32).is_null() {
                environ_put((*c).environ, data, 0 as libc::c_int);
            }
            log_debug(b"client %p IDENTIFY_ENVIRON %s\x00" as *const u8 as
                          *const libc::c_char, c, data);
        }
        107 => {
            if datalen != ::std::mem::size_of::<pid_t>() as libc::c_ulong {
                fatalx(b"bad MSG_IDENTIFY_CLIENTPID size\x00" as *const u8 as
                           *const libc::c_char);
            }
            memcpy(&mut (*c).pid as *mut pid_t as *mut libc::c_void,
                   data as *const libc::c_void,
                   ::std::mem::size_of::<pid_t>() as libc::c_ulong);
            log_debug(b"client %p IDENTIFY_CLIENTPID %ld\x00" as *const u8 as
                          *const libc::c_char, c, (*c).pid as libc::c_long);
        }
        _ => { }
    }
    ...
    (*c).name = name;
    log_debug(b"client %p name is %s\x00" as *const u8 as *const libc::c_char,
              c, (*c).name);
    if (*c).flags & 0x2000 as libc::c_int as libc::c_ulong != 0 {
        control_start(c);
    ...
    if !(*c).flags & 0x4 as libc::c_int as libc::c_ulong != 0 &&
           cfg_finished == 0 && c == clients.tqh_first {
        start_cfg();
    };
}
...
unsafe extern "C" fn server_client_dispatch_write_ready(mut c: *mut client,
    ...
    if msglen != ::std::mem::size_of::<msg_write_ready>() as libc::c_ulong {
        fatalx(b"bad MSG_WRITE_READY size\x00" as *const u8 as
                   *const libc::c_char);
    }
...
unsafe extern "C" fn server_client_dispatch_read_data(mut c: *mut client,
                                                      mut imsg: *mut imsg) {
    ...
    let mut bsize: size_t =
        msglen.wrapping_sub(::std::mem::size_of::<msg_read_data>() as
                                libc::c_ulong);
    if msglen < ::std::mem::size_of::<msg_read_data>() as libc::c_ulong {
        fatalx(b"bad MSG_READ_DATA size\x00" as *const u8 as
                   *const libc::c_char);
    }
    find.stream = (*msg).stream;
    cf = client_files_RB_FIND(&mut (*c).files, &mut find);
    if cf.is_null() { return }
    log_debug(b"%s: file %d read %zu bytes\x00" as *const u8 as
                  *const libc::c_char, (*c).name, (*cf).stream, bsize);
    if (*cf).error == 0 as libc::c_int {
        if evbuffer_add((*cf).buffer, bdata, bsize) != 0 as libc::c_int {
            (*cf).error = 12 as libc::c_int;
            file_fire_done(cf);
        } else { file_fire_read(cf); }
    };
}
/* Handle read done message. */
unsafe extern "C" fn server_client_dispatch_read_done(mut c: *mut client,
                                                      mut imsg: *mut imsg) {
    ...
    if msglen != ::std::mem::size_of::<msg_read_done>() as libc::c_ulong {
        fatalx(b"bad MSG_READ_DONE size\x00" as *const u8 as
                   *const libc::c_char);
    }
    find.stream = (*msg).stream;
    cf = client_files_RB_FIND(&mut (*c).files, &mut find);
    if cf.is_null() { return }
    log_debug(b"%s: file %d read done\x00" as *const u8 as
                  *const libc::c_char, (*c).name, (*cf).stream);
    (*cf).error = (*msg).error;
    file_fire_done(cf);
}
...
pub unsafe extern "C" fn server_client_get_cwd(mut c: *mut client,
 ...
 -> *const libc::c_char {
    let mut home: *const libc::c_char = 0 as *const libc::c_char;
    if cfg_finished == 0 && !cfg_client.is_null() { return (*cfg_client).cwd }
    if !c.is_null() && (*c).session.is_null() && !(*c).cwd.is_null() {
        return (*c).cwd
    }
    if !s.is_null() && !(*s).cwd.is_null() { return (*s).cwd }
    if !c.is_null() && { s = (*c).session; !s.is_null() } &&
           !(*s).cwd.is_null() {
        return (*s).cwd
    }
    home = find_home();
    if !home.is_null() { return home }
    return b"/\x00" as *const u8 as *const libc::c_char;
}
/* Get control client flags. */
unsafe extern "C" fn server_client_control_flags(mut c: *mut client,
                                                 mut next:
                                                     *const libc::c_char)
 -> uint64_t {
    if strcmp(next, b"pause-after\x00" as *const u8 as *const libc::c_char) ==
           0 as libc::c_int {
        (*c).pause_age = 0 as libc::c_int as u_int;
        return 0x100000000 as libc::c_ulonglong as uint64_t
    }
    if sscanf(next, b"pause-after=%u\x00" as *const u8 as *const libc::c_char,
              &mut (*c).pause_age as *mut u_int) == 1 as libc::c_int {
        (*c).pause_age =
            ((*c).pause_age as
                 libc::c_uint).wrapping_mul(1000 as libc::c_int as
                                                libc::c_uint) as u_int as
                u_int;
        return 0x100000000 as libc::c_ulonglong as uint64_t
    }
    if strcmp(next, b"no-output\x00" as *const u8 as *const libc::c_char) ==
           0 as libc::c_int {
        return 0x4000000 as libc::c_int as uint64_t
    }
    if strcmp(next, b"wait-exit\x00" as *const u8 as *const libc::c_char) ==
           0 as libc::c_int {
...
/* Set client flags. */
#[no_mangle]
pub unsafe extern "C" fn server_client_set_flags(mut c: *mut client,
                                                 mut flags:
                                                     *const libc::c_char) {
    ...
    loop  {
        ...
        if not != 0 { next = next.offset(1) }
        if (*c).flags & 0x2000 as libc::c_int as libc::c_ulong != 0 {
            flag = server_client_control_flags(c, next)
        } else { flag = 0 as libc::c_int as uint64_t }
        if strcmp(next, b"read-only\x00" as *const u8 as *const libc::c_char)
               == 0 as libc::c_int {
            flag = 0x800 as libc::c_int as uint64_t
        } else if strcmp(next,
                         b"ignore-size\x00" as *const u8 as
                             *const libc::c_char) == 0 as libc::c_int {
            flag = 0x20000 as libc::c_int as uint64_t
        } else if strcmp(next,
                         b"active-pane\x00" as *const u8 as
                             *const libc::c_char) == 0 as libc::c_int {
            flag = 0x80000000 as libc::c_ulonglong as uint64_t
        }
        if flag == 0 as libc::c_int as libc::c_ulong { continue ; }
        log_debug(b"client %s set flag %s\x00" as *const u8 as
                      *const libc::c_char, (*c).name, next);
        if not != 0 { (*c).flags &= !flag } else { (*c).flags |= flag }
        if flag == 0x4000000 as libc::c_int as libc::c_ulong {
            control_reset_offsets(c);
        }
    }
    free(copy as *mut libc::c_void);
    proc_send((*c).peer, MSG_FLAGS, -(1 as libc::c_int),
              &mut (*c).flags as *mut uint64_t as *const libc::c_void,
              ::std::mem::size_of::<uint64_t>() as libc::c_ulong);
}
/* Get client flags. This is only flags useful to show to users. */
#[no_mangle]
pub unsafe extern "C" fn server_client_get_flags(mut c: *mut client)
 -> *const libc::c_char {
    ...
    if (*c).flags as libc::c_ulonglong & 0x100000000 as libc::c_ulonglong != 0
       {
        xsnprintf(tmp.as_mut_ptr(),
                  ...
                  (*c).pause_age.wrapping_div(1000 as libc::c_int as
                                                  libc::c_uint));
        strlcat(s.as_mut_ptr(), tmp.as_mut_ptr(),
                ::std::mem::size_of::<[libc::c_char; 256]>() as
                    libc::c_ulong);
    }
    if (*c).flags & 0x800 as libc::c_int as libc::c_ulong != 0 {
...
/* Get client window. */
unsafe extern "C" fn server_client_get_client_window(mut c: *mut client,
                                                     mut id: u_int)
 -> *mut client_window {
...
#[no_mangle]
pub unsafe extern "C" fn server_client_get_pane(mut c: *mut client)
 -> *mut window_pane {
    let mut s: *mut session = (*c).session;
    let mut cw: *mut client_window = 0 as *mut client_window;
    if s.is_null() { return 0 as *mut window_pane }
    if !(*c).flags as libc::c_ulonglong & 0x80000000 as libc::c_ulonglong != 0
       {
        return (*(*(*s).curw).window).active
    }
    cw = server_client_get_client_window(c, (*(*(*s).curw).window).id);
    if cw.is_null() { return (*(*(*s).curw).window).active }
    return (*cw).pane;
}
/* Set client active pane. */
#[no_mangle]
pub unsafe extern "C" fn server_client_set_pane(mut c: *mut client,
    ...
    (*cw).pane = wp;
    log_debug(b"%s pane now %%%u\x00" as *const u8 as *const libc::c_char,
              (*c).name, (*wp).id);
}
