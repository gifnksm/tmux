...
extern "C" {
    ...
    #[no_mangle]
    fn options_is_string(_: *mut options_entry) -> libc::c_int;
    #[no_mangle]
    ...
    unsafe {
        {
            let mut init =
                cmd_entry{name:
                              b"show-options\x00" as *const u8 as
                                  *const libc::c_char,
                          alias:
                          ...
                          usage:
                              b"[-AgHpqsvw] [-t target-pane] [option]\x00" as
    ...
    unsafe {
        {
            let mut init =
                cmd_entry{name:
                          ...
                          usage:
                              b"[-gv] [-t target-window] [option]\x00" as
                                  *const u8 as *const libc::c_char,
                          source:
                              cmd_entry_flag{flag: 0,
                                             type_0: CMD_FIND_PANE,
    ...
    unsafe {
        {
            let mut init =
                cmd_entry{name:
                              b"show-hooks\x00" as *const u8 as
                                  *const libc::c_char,
                          ...
                          usage:
                              b"[-gpw] [-t target-pane]\x00" as *const u8 as
                                  *const libc::c_char,
                          source:
                              cmd_entry_flag{flag: 0,
                                             type_0: CMD_FIND_PANE,
...
unsafe extern "C" fn cmd_show_options_exec(mut self_0: *mut cmd,
 ...
 -> cmd_retval {
    ...
    if (*args).argc == 0 as libc::c_int {
        scope =
            options_scope_from_flags(args, window, target, &mut oo,
                                     &mut cause);
...
unsafe extern "C" fn cmd_show_options_print(mut self_0: *mut cmd,
    ...
    if idx != -(1 as libc::c_int) {
        xasprintf(&mut tmp as *mut *mut libc::c_char,
                  b"%s[%d]\x00" as *const u8 as *const libc::c_char, name,
                  idx);
        name = tmp
 ...
 -> cmd_retval {
    ...
    while !o.is_null() {
        if options_table_entry(o).is_null() {
            cmd_show_options_print(self_0, item, o, -(1 as libc::c_int),
                                   0 as libc::c_int);
        }
        o = options_next(o)
    }
