    ...
    len =
        xsnprintf(buf.as_mut_ptr(),
                  ::std::mem::size_of::<[libc::c_char; 512]>() as
                      libc::c_ulong,
                  b"%s%s%s%s%s%s%s%s%s%s%s%s%s%s\x00" as *const u8 as
                      *const libc::c_char,
                  ...
                  if attr & 0x200 as libc::c_int != 0 {
                      b"double-underscore,\x00" as *const u8 as
                          *const libc::c_char
                  } else { b"\x00" as *const u8 as *const libc::c_char },
                  if attr & 0x400 as libc::c_int != 0 {
                      b"curly-underscore,\x00" as *const u8 as
                          *const libc::c_char
                  } else { b"\x00" as *const u8 as *const libc::c_char },
                  if attr & 0x800 as libc::c_int != 0 {
                      b"dotted-underscore,\x00" as *const u8 as
                          *const libc::c_char
                  } else { b"\x00" as *const u8 as *const libc::c_char },
                  if attr & 0x1000 as libc::c_int != 0 {
                      b"dashed-underscore,\x00" as *const u8 as
                          *const libc::c_char
                  } else { b"\x00" as *const u8 as *const libc::c_char },
...
pub unsafe extern "C" fn attributes_fromstring(mut str: *const libc::c_char)
 -> libc::c_int {
    ...
    if *str as libc::c_int == '\u{0}' as i32 ||
           strcspn(str, delimiters.as_ptr()) ==
               0 as libc::c_int as libc::c_ulong {
        return -(1 as libc::c_int)
    }
    if !strchr(delimiters.as_ptr(),
               *str.offset(strlen(str).wrapping_sub(1 as libc::c_int as
                                                        libc::c_ulong) as
                               isize) as libc::c_int).is_null() {
        return -(1 as libc::c_int)
    }
    if strcasecmp(str, b"default\x00" as *const u8 as *const libc::c_char) ==
           0 as libc::c_int ||
           strcasecmp(str, b"none\x00" as *const u8 as *const libc::c_char) ==
               0 as libc::c_int {
