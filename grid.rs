...
static mut grid_cleared_entry: grid_cell_entry =
    {
        let mut init =
            grid_cell_entry{flags: 0x40 as libc::c_int as u_char,
                            c2rust_unnamed:
                                C2RustUnnamed{data:
                                                  {
                                                      let mut init =
                                                          C2RustUnnamed_0{attr:
                                                                              0
                                                                                  as
                                                                                  libc::c_int
                                                                                  as
...
unsafe extern "C" fn grid_store_cell(mut gce: *mut grid_cell_entry,
                                     ...
                                     mut c: u_char) {
    (*gce).flags =
        ((*gc).flags as libc::c_int & !(0x40 as libc::c_int)) as u_char;
    (*gce).c2rust_unnamed.data.fg =
        ((*gc).fg & 0xff as libc::c_int) as u_char;
    if (*gc).fg & 0x1000000 as libc::c_int != 0 {
        (*gce).flags =
            ((*gce).flags as libc::c_int | 0x1 as libc::c_int) as u_char
    }
    (*gce).c2rust_unnamed.data.bg =
        ((*gc).bg & 0xff as libc::c_int) as u_char;
    if (*gc).bg & 0x1000000 as libc::c_int != 0 {
        (*gce).flags =
            ((*gce).flags as libc::c_int | 0x2 as libc::c_int) as u_char
    }
...
unsafe extern "C" fn grid_get_extended_cell(mut gl: *mut grid_line,
                                            mut gce: *mut grid_cell_entry,
                                            mut flags: libc::c_int) {
    let mut at: u_int =
        (*gl).extdsize.wrapping_add(1 as libc::c_int as libc::c_uint);
    (*gl).extddata =
        xreallocarray((*gl).extddata as *mut libc::c_void, at as size_t,
                      ::std::mem::size_of::<grid_extd_entry>() as
                          libc::c_ulong) as *mut grid_extd_entry;
    (*gl).extdsize = at;
    (*gce).c2rust_unnamed.offset =
        at.wrapping_sub(1 as libc::c_int as libc::c_uint);
...
unsafe extern "C" fn grid_extended_cell(mut gl: *mut grid_line,
 ...
 -> *mut grid_extd_entry {
    ...
    let mut flags: libc::c_int =
        (*gc).flags as libc::c_int & !(0x40 as libc::c_int);
    ...
    gee =
        &mut *(*gl).extddata.offset((*gce).c2rust_unnamed.offset as isize) as
            *mut grid_extd_entry;
    (*gee).data = uc;
    (*gee).attr = (*gc).attr;
...
unsafe extern "C" fn grid_compact_line(mut gl: *mut grid_line) {
    ...
    let mut px: u_int = 0;
    let mut idx: u_int = 0;
    if (*gl).extdsize == 0 as libc::c_int as libc::c_uint { return }
    ...
    while px < (*gl).cellsize {
        ...
        if (*gce).flags as libc::c_int & 0x8 as libc::c_int != 0 {
            gee =
                &mut *(*gl).extddata.offset((*gce).c2rust_unnamed.offset as
                                                isize) as
                    *mut grid_extd_entry;
            memcpy(&mut *new_extddata.offset(idx as isize) as
                       *mut grid_extd_entry as *mut libc::c_void,
...
/* Get line data. */
#[no_mangle]
pub unsafe extern "C" fn grid_get_line(mut gd: *mut grid, mut line: u_int)
 -> *mut grid_line {
    return &mut *(*gd).linedata.offset(line as isize) as *mut grid_line;
}
/* Adjust number of lines. */
#[no_mangle]
pub unsafe extern "C" fn grid_adjust_lines(mut gd: *mut grid,
                                           mut lines: u_int) {
    (*gd).linedata =
        xreallocarray((*gd).linedata as *mut libc::c_void, lines as size_t,
...
unsafe extern "C" fn grid_clear_cell(mut gd: *mut grid, mut px: u_int,
    ...
    memcpy(gce as *mut libc::c_void,
           &grid_cleared_entry as *const grid_cell_entry as
               *const libc::c_void,
    ...
    if bg != 8 as libc::c_int as libc::c_uint {
        if bg & 0x2000000 as libc::c_int as libc::c_uint != 0 {
            ...
            if bg & 0x1000000 as libc::c_int as libc::c_uint != 0 {
                (*gce).flags =
                    ((*gce).flags as libc::c_int | 0x2 as libc::c_int) as
                        u_char
            }
...
#[no_mangle]
pub unsafe extern "C" fn grid_cells_look_equal(mut gc1: *const grid_cell,
...
#[no_mangle]
pub unsafe extern "C" fn grid_cells_equal(mut gc1: *const grid_cell,
                                          mut gc2: *const grid_cell)
 -> libc::c_int {
    if grid_cells_look_equal(gc1, gc2) == 0 { return 0 as libc::c_int }
    ...
    return (memcmp((*gc1).data.data.as_ptr() as *const libc::c_void,
                   (*gc2).data.data.as_ptr() as *const libc::c_void,
                   (*gc1).data.size as libc::c_ulong) == 0 as libc::c_int) as
               libc::c_int;
}
/* Free one line. */
...
pub unsafe extern "C" fn grid_destroy(mut gd: *mut grid) {
    grid_free_lines(gd, 0 as libc::c_int as u_int,
...
pub unsafe extern "C" fn grid_compare(mut ga: *mut grid, mut gb: *mut grid)
 -> libc::c_int {
    ...
    while yy < (*ga).sy {
        ...
        if (*gla).cellsize != (*glb).cellsize { return 1 as libc::c_int }
...
unsafe extern "C" fn grid_trim_history(mut gd: *mut grid, mut ny: u_int) {
    ...
    memmove(&mut *(*gd).linedata.offset(0 as libc::c_int as isize) as
                *mut grid_line as *mut libc::c_void,
...
pub unsafe extern "C" fn grid_collect_history(mut gd: *mut grid) {
    let mut ny: u_int = 0;
    if (*gd).hsize == 0 as libc::c_int as libc::c_uint ||
           (*gd).hsize < (*gd).hlimit {
        return
    }
...
#[no_mangle]
pub unsafe extern "C" fn grid_remove_history(mut gd: *mut grid,
                                             mut ny: u_int) {
    let mut yy: u_int = 0;
    if ny > (*gd).hsize { return }
    yy = 0 as libc::c_int as u_int;
    while yy < ny {
        grid_free_line(gd,
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn grid_scroll_history(mut gd: *mut grid,
                                             mut bg: u_int) {
    let mut yy: u_int = 0;
    yy = (*gd).hsize.wrapping_add((*gd).sy);
    (*gd).linedata =
        xreallocarray((*gd).linedata as *mut libc::c_void,
                      yy.wrapping_add(1 as libc::c_int as libc::c_uint) as
                          size_t,
                      ::std::mem::size_of::<grid_line>() as libc::c_ulong) as
            *mut grid_line;
...
pub unsafe extern "C" fn grid_scroll_history_region(mut gd: *mut grid,
    ...
    memmove(gl_history.offset(1 as libc::c_int as isize) as *mut libc::c_void,
...
unsafe extern "C" fn grid_expand_line(mut gd: *mut grid, mut py: u_int,
    ...
    xx = (*gl).cellsize;
    while xx < sx { grid_clear_cell(gd, xx, py, bg); xx = xx.wrapping_add(1) }
    (*gl).cellsize = sx;
}
/* Empty a line and set background colour if needed. */
#[no_mangle]
pub unsafe extern "C" fn grid_empty_line(mut gd: *mut grid, mut py: u_int,
                                         mut bg: u_int) {
...
#[no_mangle]
pub unsafe extern "C" fn grid_set_padding(mut gd: *mut grid, mut px: u_int,
                                          mut py: u_int) {
...
pub unsafe extern "C" fn grid_set_cells(mut gd: *mut grid, mut px: u_int,
    ...
    while (i as libc::c_ulong) < slen {
        ...
        } else { grid_store_cell(gce, gc, *s.offset(i as isize) as u_char); }
        i = i.wrapping_add(1)
    };
}
/* Clear area. */
...
pub unsafe extern "C" fn grid_clear(mut gd: *mut grid, mut px: u_int,
    ...
    while yy < py.wrapping_add(ny) {
        ...
        sx = (*gd).sx;
        if sx > (*gl).cellsize { sx = (*gl).cellsize }
        ox = nx;
        if bg == 8 as libc::c_int as libc::c_uint ||
               bg == 9 as libc::c_int as libc::c_uint {
            if px > sx {
                ...
                if px.wrapping_add(nx) > sx { ox = sx.wrapping_sub(px) }
                current_block_21 = 2838571290723028321;
            }
        } else { current_block_21 = 2838571290723028321; }
        match current_block_21 {
            2838571290723028321 => {
                grid_expand_line(gd, yy, px.wrapping_add(ox),
                                 8 as libc::c_int as u_int);
                xx = px;
...
pub unsafe extern "C" fn grid_clear_lines(mut gd: *mut grid, mut py: u_int,
    ...
    if py != 0 as libc::c_int as libc::c_uint {
        (*(*gd).linedata.offset(py.wrapping_sub(1 as libc::c_int as
                                                    libc::c_uint) as
                                    isize)).flags &= !(0x1 as libc::c_int)
    };
}
...
pub unsafe extern "C" fn grid_move_lines(mut gd: *mut grid, mut dy: u_int,
                                         ...
                                         mut bg: u_int) {
    let mut yy: u_int = 0;
    if ny == 0 as libc::c_int as libc::c_uint || py == dy { return }
    if grid_check_y(gd,
    ...
    if grid_check_y(gd,
                    (*::std::mem::transmute::<&[u8; 16],
                                              &[libc::c_char; 16]>(b"grid_move_lines\x00")).as_ptr(),
                    dy.wrapping_add(ny).wrapping_sub(1 as libc::c_int as
                                                         libc::c_uint)) !=
           0 as libc::c_int {
        return
    }
    ...
    while yy < dy.wrapping_add(ny) {
        if !(yy >= py && yy < py.wrapping_add(ny)) { grid_free_line(gd, yy); }
        yy = yy.wrapping_add(1)
    }
    if dy != 0 as libc::c_int as libc::c_uint {
        (*(*gd).linedata.offset(dy.wrapping_sub(1 as libc::c_int as
                                                    libc::c_uint) as
                                    isize)).flags &= !(0x1 as libc::c_int)
    }
...
pub unsafe extern "C" fn grid_move_cells(mut gd: *mut grid, mut dx: u_int,
    ...
    let mut gl: *mut grid_line = 0 as *mut grid_line;
    let mut xx: u_int = 0;
    if nx == 0 as libc::c_int as libc::c_uint || px == dx { return }
    if grid_check_y(gd,
                    (*::std::mem::transmute::<&[u8; 16],
    ...
    memmove(&mut *(*gl).celldata.offset(dx as isize) as *mut grid_cell_entry
                as *mut libc::c_void,
            &mut *(*gl).celldata.offset(px as isize) as *mut grid_cell_entry
        ...
        *values.offset(fresh10 as isize) = b as libc::c_int
        ...
        match (*gc).fg {
            0 | 1 | 2 | 3 | 4 | 5 | 6 | 7 => {
                let fresh11 = n;
                n = n.wrapping_add(1);
                *values.offset(fresh11 as isize) =
                    (*gc).fg + 30 as libc::c_int
            }
            8 => {
                let fresh12 = n;
                n = n.wrapping_add(1);
        ...
        *values.offset(fresh21 as isize) = b as libc::c_int
        ...
        match (*gc).bg {
            0 | 1 | 2 | 3 | 4 | 5 | 6 | 7 => {
                let fresh22 = n;
                n = n.wrapping_add(1);
                *values.offset(fresh22 as isize) =
                    (*gc).bg + 40 as libc::c_int
            }
            8 => {
                let fresh23 = n;
                n = n.wrapping_add(1);
            ...
            90 | 91 | 92 | 93 | 94 | 95 | 96 | 97 => {
                let fresh24 = n;
                n = n.wrapping_add(1);
                *values.offset(fresh24 as isize) =
...
unsafe extern "C" fn grid_string_cells_code(mut lastgc: *const grid_cell,
    ...
    let mut attrs: [C2RustUnnamed_1; 13] =
        [{
             let mut init =
                 C2RustUnnamed_1{mask: 0x1 as libc::c_int as u_int,
                                 code: 1 as libc::c_int as u_int,};
             init
         },
         {
             let mut init =
                 C2RustUnnamed_1{mask: 0x2 as libc::c_int as u_int,
                                 code: 2 as libc::c_int as u_int,};
             init
         },
         {
             let mut init =
                 C2RustUnnamed_1{mask: 0x40 as libc::c_int as u_int,
                                 code: 3 as libc::c_int as u_int,};
             init
         },
         {
             let mut init =
                 C2RustUnnamed_1{mask: 0x4 as libc::c_int as u_int,
                                 code: 4 as libc::c_int as u_int,};
             init
         },
         {
             let mut init =
                 C2RustUnnamed_1{mask: 0x8 as libc::c_int as u_int,
                                 code: 5 as libc::c_int as u_int,};
             init
         },
         {
             let mut init =
                 C2RustUnnamed_1{mask: 0x10 as libc::c_int as u_int,
                                 code: 7 as libc::c_int as u_int,};
             init
         },
         {
             let mut init =
                 C2RustUnnamed_1{mask: 0x20 as libc::c_int as u_int,
                                 code: 8 as libc::c_int as u_int,};
             init
         },
         {
             let mut init =
                 C2RustUnnamed_1{mask: 0x100 as libc::c_int as u_int,
                                 code: 9 as libc::c_int as u_int,};
             init
         },
         {
             let mut init =
                 C2RustUnnamed_1{mask: 0x200 as libc::c_int as u_int,
                                 code: 42 as libc::c_int as u_int,};
             init
         },
         {
             let mut init =
                 C2RustUnnamed_1{mask: 0x400 as libc::c_int as u_int,
                                 code: 43 as libc::c_int as u_int,};
             init
         },
         {
             let mut init =
                 C2RustUnnamed_1{mask: 0x800 as libc::c_int as u_int,
                                 code: 44 as libc::c_int as u_int,};
             init
         },
         {
             let mut init =
                 C2RustUnnamed_1{mask: 0x1000 as libc::c_int as u_int,
                                 code: 45 as libc::c_int as u_int,};
             init
         },
         {
             let mut init =
                 C2RustUnnamed_1{mask: 0x2000 as libc::c_int as u_int,
    ...
    while i <
              (::std::mem::size_of::<[C2RustUnnamed_1; 13]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<C2RustUnnamed_1>()
                                                   as libc::c_ulong) {
        if attr & attrs[i as usize].mask == 0 &&
               lastattr & attrs[i as usize].mask != 0 {
            let fresh25 = n;
            n = n.wrapping_add(1);
...
pub unsafe extern "C" fn grid_string_cells(mut gd: *mut grid, mut px: u_int,
 ...
 -> *mut libc::c_char {
    ...
    xx = px;
    while xx < px.wrapping_add(nx) {
        if gl.is_null() || xx >= (*gl).cellsize { break ; }
        grid_get_cell(gd, xx, py, &mut gc);
        if !(gc.flags as libc::c_int & 0x4 as libc::c_int != 0) {
            if with_codes != 0 {
                grid_string_cells_code(*lastgc, &mut gc, code.as_mut_ptr(),
    ...
    if trim != 0 {
        while off > 0 as libc::c_int as libc::c_ulong &&
                  *buf.offset(off.wrapping_sub(1 as libc::c_int as
...
unsafe extern "C" fn grid_reflow_dead(mut gl: *mut grid_line) {
    memset(gl as *mut libc::c_void, 0 as libc::c_int,
           ::std::mem::size_of::<grid_line>() as libc::c_ulong);
...
unsafe extern "C" fn grid_reflow_join(mut target: *mut grid,
    ...
    if already == 0 {
        to = (*target).sy;
        gl =
            grid_reflow_move(target, &mut *(*gd).linedata.offset(yy as isize))
    } else {
    ...
    /*
		 ...
		 * done.
		 */
    while !(yy.wrapping_add(1 as libc::c_int as
                                libc::c_uint).wrapping_add(lines) ==
                (*gd).hsize.wrapping_add((*gd).sy)) {
        line =
            yy.wrapping_add(1 as libc::c_int as
                                libc::c_uint).wrapping_add(lines);
        /* If the next line is empty, skip it. */
        if !(*(*gd).linedata.offset(line as isize)).flags & 0x1 as libc::c_int
               != 0 {
		 ...
		 */
            grid_get_cell1(&mut *(*gd).linedata.offset(line as isize),
                           0 as libc::c_int as u_int, &mut gc);
    ...
    if lines == 0 as libc::c_int as libc::c_uint { return }
    /*
    ...
    if left != 0 as libc::c_int as libc::c_uint {
        grid_move_cells(gd, 0 as libc::c_int as u_int, want,
                        yy.wrapping_add(lines), left,
                        8 as libc::c_int as u_int);
        (*from).cellused = left;
        (*from).cellsize = (*from).cellused;
        lines = lines.wrapping_sub(1)
    } else if wrapped == 0 { (*gl).flags &= !(0x1 as libc::c_int) }
    ...
    if (*gd).hscrolled > to.wrapping_add(lines) {
        (*gd).hscrolled =
            ((*gd).hscrolled as libc::c_uint).wrapping_sub(lines) as u_int as
                u_int
...
unsafe extern "C" fn grid_reflow_split(mut target: *mut grid,
    ...
    if !(*gl).flags & 0x2 as libc::c_int != 0 {
        lines =
            (1 as libc::c_int as
                 libc::c_uint).wrapping_add((*gl).cellused.wrapping_sub(1 as
                                                                            libc::c_int
                                                                            as
    ...
    while i < used {
        grid_get_cell1(gl, i, &mut gc);
        if width.wrapping_add(gc.data.width as libc::c_uint) > sx {
            (*(*target).linedata.offset(line as isize)).flags |=
                0x1 as libc::c_int;
    ...
    if yy <= (*gd).hscrolled {
        (*gd).hscrolled =
            ((*gd).hscrolled as
                 libc::c_uint).wrapping_add(lines.wrapping_sub(1 as
                                                                   libc::c_int
                                                                   as
                                                                   libc::c_uint))
                as u_int as u_int
...
pub unsafe extern "C" fn grid_reflow(mut gd: *mut grid, mut sx: u_int) {
	 ...
	 */
    target =
        grid_create((*gd).sx, 0 as libc::c_int as u_int,
...
#[no_mangle]
pub unsafe extern "C" fn grid_wrap_position(mut gd: *mut grid, mut px: u_int,
                                            mut py: u_int, mut wx: *mut u_int,
                                            mut wy: *mut u_int) {
    ...
    yy = 0 as libc::c_int as u_int;
    while yy < py {
        if (*(*gd).linedata.offset(yy as isize)).flags & 0x1 as libc::c_int !=
               0 {
            ax =
                (ax as
                     libc::c_uint).wrapping_add((*(*gd).linedata.offset(yy as
                                                                            isize)).cellused)
                    as u_int as u_int
        } else { ax = 0 as libc::c_int as u_int; ay = ay.wrapping_add(1) }
        yy = yy.wrapping_add(1)
    }
            ...
            (2147483647 as libc::c_int as
                 libc::c_uint).wrapping_mul(2 as
                                                libc::c_uint).wrapping_add(1
                                                                               as
                                                                               libc::c_uint)
    } else { ax = (ax as libc::c_uint).wrapping_add(px) as u_int as u_int }
    *wx = ax;
    *wy = ay;
}
/* Convert position based on wrapped lines back. */
#[no_mangle]
pub unsafe extern "C" fn grid_unwrap_position(mut gd: *mut grid,
                                              mut px: *mut u_int,
                                              mut py: *mut u_int,
                                              mut wx: u_int, mut wy: u_int) {
    let mut yy: u_int = 0;
    let mut ay: u_int = 0 as libc::c_int as u_int;
    yy = 0 as libc::c_int as u_int;
    while yy <
           ...
           (2147483647 as libc::c_int as
                libc::c_uint).wrapping_mul(2 as
                                               libc::c_uint).wrapping_add(1 as
                                                                              libc::c_uint)
       {
        while (*(*gd).linedata.offset(yy as isize)).flags & 0x1 as libc::c_int
                  != 0 {
            yy = yy.wrapping_add(1)
        }
        ...
        while (*(*gd).linedata.offset(yy as isize)).flags & 0x1 as libc::c_int
                  != 0 {
            if wx < (*(*gd).linedata.offset(yy as isize)).cellused { break ; }
            wx =
                (wx as
                     libc::c_uint).wrapping_sub((*(*gd).linedata.offset(yy as
                                                                            isize)).cellused)
                    as u_int as u_int;
            yy = yy.wrapping_add(1)
        }
...
/* Get length of line. */
#[no_mangle]
pub unsafe extern "C" fn grid_line_length(mut gd: *mut grid, mut py: u_int)
 -> u_int {
    let mut gc: grid_cell =
        grid_cell{data: utf8_data{data: [0; 21], have: 0, size: 0, width: 0,},
                  attr: 0,
    ...
    if px > (*gd).sx { px = (*gd).sx }
    while px > 0 as libc::c_int as libc::c_uint {
        grid_get_cell(gd, px.wrapping_sub(1 as libc::c_int as libc::c_uint),
                      py, &mut gc);
        if gc.flags as libc::c_int & 0x4 as libc::c_int != 0 ||
