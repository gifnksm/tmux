...
extern "C" {
    ...
    #[no_mangle]
    fn window_copy_pageup(_: *mut window_pane, _: libc::c_int);
    #[no_mangle]
    ...
    unsafe {
        {
            let mut init =
                cmd_entry{name:
                          ...
                          usage:
                              b"[-eHMuq] [-s src-pane] [-t target-pane]\x00"
 ...
 */
unsafe extern "C" fn cmd_copy_mode_exec(mut self_0: *mut cmd,
 ...
 -> cmd_retval {
    ...
    if cmd_get_entry(self_0) == &cmd_clock_mode_entry as *const cmd_entry {
        window_pane_set_mode(wp, 0 as *mut window_pane, &window_clock_mode,
    ...
    if window_pane_set_mode(wp, swp, &window_copy_mode,
                            0 as *mut cmd_find_state, args) == 0 {
        if args_has(args, 'M' as i32 as u_char) != 0 {
