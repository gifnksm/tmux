    ...
    unsafe {
        {
            let mut init =
                cmd_entry{name:
                              b"list-buffers\x00" as *const u8 as
                                  *const libc::c_char,
                          alias:
                              b"lsb\x00" as *const u8 as *const libc::c_char,
                          args:
                              {
                                  let mut init =
...
unsafe extern "C" fn cmd_list_buffers_exec(mut self_0: *mut cmd,
 ...
 -> cmd_retval {
    ...
    if template.is_null() {
        template =
            b"#{buffer_name}: #{buffer_size} bytes: \"#{buffer_sample}\"\x00"
