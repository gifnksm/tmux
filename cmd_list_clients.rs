    ...
    unsafe {
        {
            let mut init =
                cmd_entry{name:
                              b"list-clients\x00" as *const u8 as
                                  *const libc::c_char,
                          alias:
                              b"lsc\x00" as *const u8 as *const libc::c_char,
                          args:
                              {
                                  let mut init =
                          ...
                          usage:
                              b"[-F format] [-t target-session]\x00" as
...
unsafe extern "C" fn cmd_list_clients_exec(mut self_0: *mut cmd,
