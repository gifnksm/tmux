...
pub static mut cmd_select_window_entry: cmd_entry = {
    {
        let mut init = cmd_entry {
            ...
            usage: b"[-lnpT] [-t target-window]\x00" as *const u8 as *const libc::c_char,
...
pub static mut cmd_next_window_entry: cmd_entry = {
    {
        let mut init = cmd_entry {
            ...
            usage: b"[-a] [-t target-session]\x00" as *const u8 as *const libc::c_char,
            source: cmd_entry_flag {
                flag: 0,
                type_0: CMD_FIND_PANE,
                flags: 0,
...
unsafe extern "C" fn cmd_select_window_exec(
    ...
    if next != 0 || previous != 0 || last != 0 {
        ...
        cmdq_insert_hook(
            ...
            item,
            current,
            b"after-select-window\x00" as *const u8 as *const libc::c_char,
        );
    } else {
        /*
