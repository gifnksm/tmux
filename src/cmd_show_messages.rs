use crate::tty_code::Code as TtyCode;
use ::libc;
...
extern "C" {
    ...
    #[no_mangle]
    fn format_add_tv(_: *mut crate::format::format_tree, _: *const libc::c_char, _: *mut timeval);
    #[no_mangle]
    fn format_expand(
        _: *mut crate::format::format_tree,
        _: *const libc::c_char,
    ...
    #[no_mangle]
    fn format_create_from_target(
        _: *mut crate::cmd_queue::cmdq_item,
    ) -> *mut crate::format::format_tree;
    #[no_mangle]
    fn job_print_summary(_: *mut crate::cmd_queue::cmdq_item, _: libc::c_int);
    #[no_mangle]
    static mut tty_terms: tty_terms;
    #[no_mangle]
    fn tty_term_ncodes() -> u_int;
    #[no_mangle]
    fn tty_term_describe(_: *mut tty_term, _: TtyCode) -> *const libc::c_char;
    #[no_mangle]
