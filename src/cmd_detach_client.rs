...
pub static mut cmd_detach_client_entry: cmd_entry = {
    {
        let mut init = cmd_entry {
            ...
            alias: b"detach\x00" as *const u8 as *const libc::c_char,
            args: {
            ...
            usage: b"[-aP] [-E shell-command] [-s target-session] [-t target-client]\x00"
...
pub static mut cmd_suspend_client_entry: cmd_entry = {
    {
        let mut init = cmd_entry {
            ...
            alias: b"suspendc\x00" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_32 {
            ...
            usage: b"[-t target-client]\x00" as *const u8 as *const libc::c_char,
