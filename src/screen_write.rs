...
extern "C" {
    ...
    #[no_mangle]
    fn screen_reset_tabs(_: *mut crate::screen::Screen);
    #[no_mangle]
    ...
    #[no_mangle]
    fn screen_check_selection(_: *mut crate::screen::Screen, _: u_int, _: u_int) -> libc::c_int;
    #[no_mangle]
...
/* Set up for writing. */
unsafe extern "C" fn screen_write_init(
    mut ctx: *mut screen_write_ctx,
