...
pub static mut cmd_kill_window_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"kill-window\x00" as *const u8 as *const libc::c_char,
            alias: b"killw\x00" as *const u8 as *const libc::c_char,
            args: {
            ...
            usage: b"[-a] [-t target-window]\x00" as *const u8 as *const libc::c_char,
...
pub static mut cmd_unlink_window_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"unlink-window\x00" as *const u8 as *const libc::c_char,
            alias: b"unlinkw\x00" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_32 {
            ...
            usage: b"[-k] [-t target-window]\x00" as *const u8 as *const libc::c_char,
            source: cmd_entry_flag {
                flag: 0,
                type_0: CMD_FIND_PANE,
                flags: 0,
