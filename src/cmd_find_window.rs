...
pub static mut cmd_find_window_entry: cmd_entry = {
    {
        let mut init = cmd_entry {
            ...
            alias: b"findw\x00" as *const u8 as *const libc::c_char,
            args: {
            ...
            usage: b"[-CiNrTZ] [-t target-pane] match-string\x00" as *const u8
...
unsafe extern "C" fn cmd_find_window_exec(
    ...
    if C != 0 && N != 0 && T != 0 {
        xasprintf(
            &mut filter as *mut *mut libc::c_char,
        ...
        xasprintf(
            &mut filter as *mut *mut libc::c_char,
            b"#{||:#{C%s:%s},#{m%s:*%s*,#{window_name}}}\x00" as *const u8 as *const libc::c_char,
            suffix,
            s,
            suffix,
            s,
        ...
        xasprintf(
            &mut filter as *mut *mut libc::c_char,
            b"#{||:#{C%s:%s},#{m%s:*%s*,#{pane_title}}}\x00" as *const u8 as *const libc::c_char,
            suffix,
            s,
            suffix,
            s,
        ...
        xasprintf(
            &mut filter as *mut *mut libc::c_char,
            b"#{||:#{m%s:*%s*,#{window_name}},#{m%s:*%s*,#{pane_title}}}\x00" as *const u8
                as *const libc::c_char,
            suffix,
            s,
            suffix,
        ...
        xasprintf(
            &mut filter as *mut *mut libc::c_char,
            b"#{m%s:*%s*,#{window_name}}\x00" as *const u8 as *const libc::c_char,
            suffix,
            s,
        );
    } else {
        xasprintf(
            &mut filter as *mut *mut libc::c_char,
            b"#{m%s:*%s*,#{pane_title}}\x00" as *const u8 as *const libc::c_char,
            suffix,
            s,
        );
    }
