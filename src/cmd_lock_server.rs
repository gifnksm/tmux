...
pub static mut cmd_lock_server_entry: cmd_entry = {
    {
        let mut init = cmd_entry {
            ...
            alias: b"lock\x00" as *const u8 as *const libc::c_char,
            args: {
...
pub static mut cmd_lock_session_entry: cmd_entry = {
    {
        let mut init = cmd_entry {
            ...
            alias: b"locks\x00" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_32 {
...
pub static mut cmd_lock_client_entry: cmd_entry = {
    {
        let mut init = cmd_entry {
            ...
            alias: b"lockc\x00" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_32 {
                    template: b"t:\x00" as *const u8 as *const libc::c_char,
                    lower: 0i32,
...
unsafe extern "C" fn cmd_lock_server_exec(
    ...
    if cmd_get_entry(self_0) == &cmd_lock_server_entry as *const cmd_entry {
        server_lock();
    } else if cmd_get_entry(self_0) == &cmd_lock_session_entry as *const cmd_entry {
