...
pub static mut cmd_select_layout_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            ...
            alias: b"selectl\x00" as *const u8 as *const libc::c_char,
            args: {
            ...
            usage: b"[-Enop] [-t target-pane] [layout-name]\x00" as *const u8
...
pub static mut cmd_next_layout_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            ...
            alias: b"nextl\x00" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_32 {
            ...
            usage: b"[-t target-window]\x00" as *const u8 as *const libc::c_char,
            source: cmd_entry_flag {
                flag: 0,
                type_0: CMD_FIND_PANE,
                flags: 0,
...
pub static mut cmd_previous_layout_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            ...
            alias: b"prevl\x00" as *const u8 as *const libc::c_char,
            args: {
                let mut init = C2RustUnnamed_32 {
                    template: b"t:\x00" as *const u8 as *const libc::c_char,
                    lower: 0 as libc::c_int,
