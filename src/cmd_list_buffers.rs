...
pub static mut cmd_list_buffers_entry: cmd_entry = {
    {
        let mut init = cmd_entry {
            name: b"list-buffers\x00" as *const u8 as *const libc::c_char,
            alias: b"lsb\x00" as *const u8 as *const libc::c_char,
            args: {
            ...
            usage: b"[-F format] [-f filter]\x00" as *const u8 as *const libc::c_char,
