...
pub static mut cmd_rename_session_entry: cmd_entry = unsafe {
    {
        let mut init = cmd_entry {
            name: b"rename-session\x00" as *const u8 as *const libc::c_char,
            alias: b"rename\x00" as *const u8 as *const libc::c_char,
            args: {
            ...
            usage: b"[-t target-session] new-name\x00" as *const u8 as *const libc::c_char,
