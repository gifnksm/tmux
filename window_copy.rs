...
extern "C" {
    ...
    #[no_mangle]
    fn format_add_cb(_: *mut format_tree, _: *const libc::c_char,
                     _: format_cb);
    #[no_mangle]
    ...
    #[no_mangle]
    fn format_grid_word(_: *mut grid, _: u_int, _: u_int)
     -> *mut libc::c_char;
    #[no_mangle]
    ...
    fn job_run(_: *const libc::c_char, _: *mut session,
               ...
               _: libc::c_int, _: libc::c_int) -> *mut job;
    #[no_mangle]
    ...
    fn grid_duplicate_lines(_: *mut grid, _: u_int, _: *mut grid, _: u_int,
                            _: u_int);
    #[no_mangle]
    fn grid_wrap_position(_: *mut grid, _: u_int, _: u_int, _: *mut u_int,
                          _: *mut u_int);
    #[no_mangle]
    fn grid_unwrap_position(_: *mut grid, _: *mut u_int, _: *mut u_int,
                            _: u_int, _: u_int);
    #[no_mangle]
    ...
    #[no_mangle]
    fn utf8_cstrhas(_: *const libc::c_char, _: *const utf8_data)
     -> libc::c_int;
    #[no_mangle]
...
pub type format_cb
    =
    Option<unsafe extern "C" fn(_: *mut format_tree) -> *mut libc::c_char>;
...
pub struct C2RustUnnamed_35 {
    ...
    pub f: Option<unsafe extern "C" fn(_: *mut window_copy_cmd_state)
    ...
    unsafe {
        {
            let mut init =
                window_mode{name:
                                b"copy-mode\x00" as *const u8 as
                                    *const libc::c_char,
                            default_format: 0 as *const libc::c_char,
                            init:
                                Some(window_copy_init as
                                         unsafe extern "C" fn(_:
                                             ...
                                             -> *mut screen),
                            free:
                                Some(window_copy_free as
                                         unsafe extern "C" fn(_:
                                                                  *mut window_mode_entry)
                                             -> ()),
                            resize:
                                Some(window_copy_resize as
                                         unsafe extern "C" fn(_:
                                                                  *mut window_mode_entry,
                                                              _: u_int,
                                                              _: u_int)
                            ...
                            key: None,
                            key_table:
                                Some(window_copy_key_table as
                                         unsafe extern "C" fn(_:
                                                                  *mut window_mode_entry)
                                             -> *const libc::c_char),
                            command:
                                Some(window_copy_command as
                                         unsafe extern "C" fn(_:
                                                                  *mut window_mode_entry,
                                                              _: *mut client,
                                                              _: *mut session,
    ...
    unsafe {
        {
            let mut init =
                window_mode{name:
                                b"view-mode\x00" as *const u8 as
                                    *const libc::c_char,
                            default_format: 0 as *const libc::c_char,
                            init:
                                Some(window_copy_view_init as
                                         unsafe extern "C" fn(_:
                                                                  *mut window_mode_entry,
                                                              _:
                                                                  *mut cmd_find_state,
...
unsafe extern "C" fn window_copy_scroll_timer(mut fd: libc::c_int,
    ...
    if (*data).cy == 0 as libc::c_int as libc::c_uint {
        ...
        window_copy_cursor_up(wme, 1 as libc::c_int);
                  ...
                  (*(*data).screen.grid).sy.wrapping_sub(1 as libc::c_int as
                                                             libc::c_uint) {
        event_add(&mut (*data).dragtimer, &mut tv);
        window_copy_cursor_down(wme, 1 as libc::c_int);
    };
}
unsafe extern "C" fn window_copy_clone_screen(mut src: *mut screen,
                                              mut hint: *mut screen,
                                              mut cx: *mut u_int,
                                              mut cy: *mut u_int,
                                              mut trim: libc::c_int)
 -> *mut screen {
    ...
    dst =
        xcalloc(1 as libc::c_int as size_t,
                ::std::mem::size_of::<screen>() as libc::c_ulong) as
            *mut screen;
    sy = (*(*src).grid).hsize.wrapping_add((*(*src).grid).sy);
    if trim != 0 {
        while sy > (*(*src).grid).hsize {
            gl =
                grid_peek_line((*src).grid,
                               sy.wrapping_sub(1 as libc::c_int as
                                                   libc::c_uint));
            if (*gl).cellused != 0 as libc::c_int as libc::c_uint { break ; }
            sy = sy.wrapping_sub(1)
        }
    }
    log_debug(b"%s: target screen is %ux%u, source %ux%u\x00" as *const u8 as
                  *const libc::c_char,
              (*::std::mem::transmute::<&[u8; 25],
                                        &[libc::c_char; 25]>(b"window_copy_clone_screen\x00")).as_ptr(),
              (*(*src).grid).sx, sy, (*(*hint).grid).sx,
    ...
    grid_duplicate_lines((*dst).grid, 0 as libc::c_int as u_int, (*src).grid,
                         0 as libc::c_int as u_int, sy);
    (*(*dst).grid).sy = sy.wrapping_sub((*(*src).grid).hsize);
    (*(*dst).grid).hsize = (*(*src).grid).hsize;
    (*(*dst).grid).hscrolled = (*(*src).grid).hscrolled;
    if (*src).cy >
           (*(*dst).grid).sy.wrapping_sub(1 as libc::c_int as libc::c_uint) {
        (*dst).cx = 0 as libc::c_int as u_int;
        (*dst).cy =
            (*(*dst).grid).sy.wrapping_sub(1 as libc::c_int as libc::c_uint)
    } else { (*dst).cx = (*src).cx; (*dst).cy = (*src).cy }
    if !cx.is_null() && !cy.is_null() {
        *cx = (*dst).cx;
        *cy = (*(*dst).grid).hsize.wrapping_add((*dst).cy);
        reflow = ((*(*hint).grid).sx != (*(*dst).grid).sx) as libc::c_int
    } else { reflow = 0 as libc::c_int }
    if reflow != 0 {
        grid_wrap_position((*dst).grid, *cx, *cy, &mut wx, &mut wy);
    }
    screen_resize_cursor(dst, (*(*hint).grid).sx, (*(*hint).grid).sy,
                         1 as libc::c_int, 0 as libc::c_int,
                         0 as libc::c_int);
    if reflow != 0 { grid_unwrap_position((*dst).grid, cx, cy, wx, wy); }
    return dst;
}
unsafe extern "C" fn window_copy_common_init(mut wme: *mut window_mode_entry)
 -> *mut window_copy_mode_data {
    ...
    data =
        xcalloc(1 as libc::c_int as size_t,
                ::std::mem::size_of::<window_copy_mode_data>() as
    ...
    screen_init(&mut (*data).screen, (*(*base).grid).sx, (*(*base).grid).sy,
                0 as libc::c_int as u_int);
    (*data).modekeys =
        options_get_number((*(*wp).window).options,
                           b"mode-keys\x00" as *const u8 as
                               *const libc::c_char) as libc::c_int;
    event_set(&mut (*data).dragtimer, -(1 as libc::c_int),
              0 as libc::c_int as libc::c_short,
              Some(window_copy_scroll_timer as
                       unsafe extern "C" fn(_: libc::c_int, _: libc::c_short,
                                            _: *mut libc::c_void) -> ()),
              wme as *mut libc::c_void);
    return data;
}
unsafe extern "C" fn window_copy_init(mut wme: *mut window_mode_entry,
    ...
    (*data).backing =
        window_copy_clone_screen(base, &mut (*data).screen, &mut cx, &mut cy,
    ...
    screen_write_cursormove(&mut ctx, (*data).cx as libc::c_int,
                            (*data).cy as libc::c_int, 0 as libc::c_int);
    screen_write_stop(&mut ctx);
    return &mut (*data).screen;
}
unsafe extern "C" fn window_copy_view_init(mut wme: *mut window_mode_entry,
                                           mut fs: *mut cmd_find_state,
                                           mut args: *mut args)
 -> *mut screen {
    let mut wp: *mut window_pane = (*wme).wp;
    ...
    s =
        xmalloc(::std::mem::size_of::<screen>() as libc::c_ulong) as
            *mut screen;
    (*data).backing = s;
    screen_init(s, (*(*base).grid).sx, (*(*base).grid).sy,
...
#[no_mangle]
pub unsafe extern "C" fn window_copy_add(mut wp: *mut window_pane,
...
pub unsafe extern "C" fn window_copy_vadd(mut wp: *mut window_pane,
    ...
    if (*data).backing_written != 0 {
        ...
        screen_write_linefeed(&mut back_ctx, 0 as libc::c_int,
                              8 as libc::c_int as u_int);
    } else { (*data).backing_written = 1 as libc::c_int }
    old_cy = (*backing).cy;
    screen_write_vnputs(&mut back_ctx, 0 as libc::c_int as ssize_t, &mut gc,
                        fmt, ap.as_va_list());
    ...
    if (*(*(*data).backing).grid).hsize != 0 {
        window_copy_redraw_lines(wme, 0 as libc::c_int as u_int,
                                 1 as libc::c_int as u_int);
    }
    /* Write the new lines. */
    window_copy_redraw_lines(wme, old_cy,
                             (*backing).cy.wrapping_sub(old_cy).wrapping_add(1
                                                                                 as
                                                                                 libc::c_int
                                                                                 as
                                                                                 libc::c_uint));
...
unsafe extern "C" fn window_copy_pageup1(mut wme: *mut window_mode_entry,
                                         mut half_page: libc::c_int) {
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
    ...
    if (*(*s).grid).sy > 2 as libc::c_int as libc::c_uint {
        if half_page != 0 {
            n = (*(*s).grid).sy.wrapping_div(2 as libc::c_int as libc::c_uint)
        } else {
            n = (*(*s).grid).sy.wrapping_sub(2 as libc::c_int as libc::c_uint)
        }
    }
    if (*data).oy.wrapping_add(n) > (*(*(*data).backing).grid).hsize {
        ...
        if (*data).cy < n {
            ...
            (*data).cy =
                ((*data).cy as libc::c_uint).wrapping_sub(n) as u_int as u_int
        }
    } else {
        (*data).oy =
    ...
    if !(*data).searchmark.is_null() && (*data).timeout == 0 {
        window_copy_search_marks(wme, 0 as *mut screen, (*data).searchregex,
                                 1 as libc::c_int);
    }
    window_copy_update_selection(wme, 1 as libc::c_int, 0 as libc::c_int);
    window_copy_redraw_screen(wme);
}
unsafe extern "C" fn window_copy_pagedown(mut wme: *mut window_mode_entry,
                                          mut half_page: libc::c_int,
 ...
 -> libc::c_int {
    ...
    if (*data).oy < n {
        ...
        if (*data).cy.wrapping_add(n.wrapping_sub((*data).oy)) >=
               (*(*(*data).backing).grid).sy {
            (*data).cy =
                (*(*(*data).backing).grid).sy.wrapping_sub(1 as libc::c_int as
                                                               libc::c_uint)
        } else {
            (*data).cy =
                ((*data).cy as
                     libc::c_uint).wrapping_add(n.wrapping_sub((*data).oy)) as
                    u_int as u_int
        }
    } else {
        (*data).oy =
...
unsafe extern "C" fn window_copy_previous_paragraph(mut wme:
                                                        *mut window_mode_entry) {
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
    let mut oy: u_int = 0;
    ...
    while oy > 0 as libc::c_int as libc::c_uint &&
              window_copy_find_length(wme, oy) ==
    ...
    window_copy_scroll_to(wme, 0 as libc::c_int as u_int, oy,
                          0 as libc::c_int);
}
unsafe extern "C" fn window_copy_next_paragraph(mut wme:
                                                    *mut window_mode_entry) {
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
    let mut s: *mut screen = &mut (*data).screen;
    ...
    oy =
        (*(*(*data).backing).grid).hsize.wrapping_add((*data).cy).wrapping_sub((*data).oy);
    maxy =
        (*(*(*data).backing).grid).hsize.wrapping_add((*(*s).grid).sy).wrapping_sub(1
                                                                                        as
                                                                                        libc::c_int
                                                                                        as
                                                                                        libc::c_uint);
...
#[no_mangle]
pub unsafe extern "C" fn window_copy_get_word(mut wp: *mut window_pane,
...
#[no_mangle]
pub unsafe extern "C" fn window_copy_get_line(mut wp: *mut window_pane,
                                              mut y: u_int)
 -> *mut libc::c_char {
    let mut wme: *mut window_mode_entry = (*wp).modes.tqh_first;
    let mut data: *mut window_copy_mode_data =
...
unsafe extern "C" fn window_copy_cursor_word_cb(mut ft: *mut format_tree)
 -> *mut libc::c_char {
...
unsafe extern "C" fn window_copy_cursor_line_cb(mut ft: *mut format_tree)
 -> *mut libc::c_char {
    let mut wp: *mut window_pane = format_get_pane(ft);
    let mut wme: *mut window_mode_entry = (*wp).modes.tqh_first;
    let mut data: *mut window_copy_mode_data =
...
unsafe extern "C" fn window_copy_search_match_cb(mut ft: *mut format_tree)
 -> *mut libc::c_char {
    let mut wp: *mut window_pane = format_get_pane(ft);
    let mut wme: *mut window_mode_entry = (*wp).modes.tqh_first;
    let mut data: *mut window_copy_mode_data =
...
unsafe extern "C" fn window_copy_formats(mut wme: *mut window_mode_entry,
                                         mut ft: *mut format_tree) {
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
    format_add(ft, b"scroll_position\x00" as *const u8 as *const libc::c_char,
               b"%d\x00" as *const u8 as *const libc::c_char, (*data).oy);
    format_add(ft,
               b"rectangle_toggle\x00" as *const u8 as *const libc::c_char,
               b"%d\x00" as *const u8 as *const libc::c_char,
               (*data).rectflag);
    format_add(ft, b"copy_cursor_x\x00" as *const u8 as *const libc::c_char,
               b"%d\x00" as *const u8 as *const libc::c_char, (*data).cx);
    format_add(ft, b"copy_cursor_y\x00" as *const u8 as *const libc::c_char,
               b"%d\x00" as *const u8 as *const libc::c_char, (*data).cy);
    format_add(ft,
               b"selection_present\x00" as *const u8 as *const libc::c_char,
               b"%d\x00" as *const u8 as *const libc::c_char,
               ((*data).screen.sel !=
                    0 as *mut libc::c_void as *mut screen_sel) as
                   libc::c_int);
    if !(*data).screen.sel.is_null() {
        format_add(ft,
                   b"selection_start_x\x00" as *const u8 as
                       *const libc::c_char,
                   b"%d\x00" as *const u8 as *const libc::c_char,
                   (*data).selx);
        format_add(ft,
                   b"selection_start_y\x00" as *const u8 as
                       *const libc::c_char,
                   b"%d\x00" as *const u8 as *const libc::c_char,
                   (*data).sely);
        format_add(ft,
        ...
        format_add(ft,
                   ...
                   (*data).endsely);
        format_add(ft,
                   b"selection_active\x00" as *const u8 as
                       *const libc::c_char,
                   b"%d\x00" as *const u8 as *const libc::c_char,
                   ((*data).cursordrag as libc::c_uint !=
                        CURSORDRAG_NONE as libc::c_int as libc::c_uint) as
                       libc::c_int);
    } else {
        format_add(ft,
                   b"selection_active\x00" as *const u8 as
    ...
    format_add(ft, b"search_present\x00" as *const u8 as *const libc::c_char,
               b"%d\x00" as *const u8 as *const libc::c_char,
               ((*data).searchmark != 0 as *mut libc::c_void as *mut u_char)
                   as libc::c_int);
    format_add_cb(ft, b"search_match\x00" as *const u8 as *const libc::c_char,
                  Some(window_copy_search_match_cb as
                           unsafe extern "C" fn(_: *mut format_tree)
                               -> *mut libc::c_char));
    format_add_cb(ft,
                  b"copy_cursor_word\x00" as *const u8 as *const libc::c_char,
                  Some(window_copy_cursor_word_cb as
                           unsafe extern "C" fn(_: *mut format_tree)
                               -> *mut libc::c_char));
    format_add_cb(ft,
                  b"copy_cursor_line\x00" as *const u8 as *const libc::c_char,
                  Some(window_copy_cursor_line_cb as
                           unsafe extern "C" fn(_: *mut format_tree)
                               -> *mut libc::c_char));
}
unsafe extern "C" fn window_copy_size_changed(mut wme:
                                                  *mut window_mode_entry) {
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
    let mut s: *mut screen = &mut (*data).screen;
    ...
    let mut search: libc::c_int =
        ((*data).searchmark != 0 as *mut libc::c_void as *mut u_char) as
            libc::c_int;
    window_copy_clear_selection(wme);
    window_copy_clear_marks(wme);
    screen_write_start(&mut ctx, s);
    window_copy_write_lines(wme, &mut ctx, 0 as libc::c_int as u_int,
                            (*(*s).grid).sy);
    screen_write_stop(&mut ctx);
...
unsafe extern "C" fn window_copy_resize(mut wme: *mut window_mode_entry,
    ...
    if reflow != 0 { grid_wrap_position(gd, cx, cy, &mut wx, &mut wy); }
    screen_resize_cursor((*data).backing, sx, sy, 1 as libc::c_int,
                         0 as libc::c_int, 0 as libc::c_int);
    if reflow != 0 { grid_unwrap_position(gd, &mut cx, &mut cy, wx, wy); }
    (*data).cx = cx;
    if cy < (*gd).hsize {
        (*data).cy = 0 as libc::c_int as u_int;
 ...
 */
unsafe extern "C" fn window_copy_key_table(mut wme: *mut window_mode_entry)
 -> *const libc::c_char {
    let mut wp: *mut window_pane = (*wme).wp;
...
unsafe extern "C" fn window_copy_expand_search_string(mut cs:
                                                          *mut window_copy_cmd_state)
 -> libc::c_int {
    ...
    if (*(*cs).args).argc == 2 as libc::c_int {
        ...
        if *argument as libc::c_int != '\u{0}' as i32 {
            if args_has((*cs).args, 'F' as i32 as u_char) != 0 {
                expanded =
                    format_single(0 as *mut cmdq_item, argument,
                                  0 as *mut client, 0 as *mut session,
                                  0 as *mut winlink, (*wme).wp);
...
unsafe extern "C" fn window_copy_cmd_append_selection(mut cs:
                                                          *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
...
unsafe extern "C" fn window_copy_cmd_append_selection_and_cancel(mut cs:
                                                                     *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut s: *mut session = (*cs).s;
...
unsafe extern "C" fn window_copy_cmd_back_to_indentation(mut cs:
                                                             *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
...
unsafe extern "C" fn window_copy_cmd_begin_selection(mut cs:
                                                         *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
...
unsafe extern "C" fn window_copy_cmd_stop_selection(mut cs:
                                                        *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
...
unsafe extern "C" fn window_copy_cmd_bottom_line(mut cs:
                                                     *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
...
unsafe extern "C" fn window_copy_cmd_cancel(mut cs:
                                                *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    return WINDOW_COPY_CMD_CANCEL;
}
unsafe extern "C" fn window_copy_cmd_clear_selection(mut cs:
                                                         *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    window_copy_clear_selection(wme);
...
unsafe extern "C" fn window_copy_cmd_copy_end_of_line(mut cs:
                                                          *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut c: *mut client = (*cs).c;
    ...
    if (*(*cs).args).argc == 2 as libc::c_int {
        prefix =
            format_single(0 as *mut cmdq_item,
                          *(*(*cs).args).argv.offset(1 as libc::c_int as
                                                         isize), c, s, wl, wp)
    }
    window_copy_start_selection(wme);
...
unsafe extern "C" fn window_copy_cmd_copy_line(mut cs:
                                                   *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut c: *mut client = (*cs).c;
...
unsafe extern "C" fn window_copy_cmd_copy_selection_no_clear(mut cs:
                                                                 *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut c: *mut client = (*cs).c;
...
unsafe extern "C" fn window_copy_cmd_copy_selection(mut cs:
                                                        *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
...
unsafe extern "C" fn window_copy_cmd_copy_selection_and_cancel(mut cs:
                                                                   *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    window_copy_cmd_copy_selection_no_clear(cs);
...
unsafe extern "C" fn window_copy_cmd_cursor_down(mut cs:
                                                     *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut np: u_int = (*wme).prefix;
...
unsafe extern "C" fn window_copy_cmd_cursor_down_and_cancel(mut cs:
                                                                *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
...
unsafe extern "C" fn window_copy_cmd_cursor_left(mut cs:
                                                     *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut np: u_int = (*wme).prefix;
...
unsafe extern "C" fn window_copy_cmd_cursor_right(mut cs:
                                                      *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut np: u_int = (*wme).prefix;
...
unsafe extern "C" fn window_copy_cmd_cursor_up(mut cs:
                                                   *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut np: u_int = (*wme).prefix;
...
unsafe extern "C" fn window_copy_cmd_end_of_line(mut cs:
                                                     *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    window_copy_cursor_end_of_line(wme);
...
unsafe extern "C" fn window_copy_cmd_halfpage_down(mut cs:
                                                       *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
    ...
    let mut np: u_int = (*wme).prefix;
    while np != 0 as libc::c_int as libc::c_uint {
        if window_copy_pagedown(wme, 1 as libc::c_int, (*data).scroll_exit) !=
               0 {
            return WINDOW_COPY_CMD_CANCEL
        }
        np = np.wrapping_sub(1)
...
unsafe extern "C" fn window_copy_cmd_halfpage_down_and_cancel(mut cs:
                                                                  *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut np: u_int = (*wme).prefix;
...
unsafe extern "C" fn window_copy_cmd_halfpage_up(mut cs:
                                                     *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut np: u_int = (*wme).prefix;
...
unsafe extern "C" fn window_copy_cmd_history_bottom(mut cs:
                                                        *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
    ...
    let mut oy: u_int = 0;
    oy = (*(*s).grid).hsize.wrapping_add((*data).cy).wrapping_sub((*data).oy);
    if (*data).lineflag as libc::c_uint ==
...
unsafe extern "C" fn window_copy_cmd_history_top(mut cs:
                                                     *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
...
unsafe extern "C" fn window_copy_cmd_jump_again(mut cs:
                                                    *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
...
unsafe extern "C" fn window_copy_cmd_jump_reverse(mut cs:
                                                      *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
...
unsafe extern "C" fn window_copy_cmd_middle_line(mut cs:
                                                     *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
...
unsafe extern "C" fn window_copy_cmd_previous_matching_bracket(mut cs:
                                                                   *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut np: u_int = (*wme).prefix;
    ...
    while np != 0 as libc::c_int as libc::c_uint {
        ...
        px = (*data).cx;
        py =
            (*(*s).grid).hsize.wrapping_add((*data).cy).wrapping_sub((*data).oy);
        xx = window_copy_find_length(wme, py);
        if xx == 0 as libc::c_int as libc::c_uint { break ; }
        /*
        ...
        loop  {
            ...
            if cp.is_null() {
                if !((*data).modekeys == 0 as libc::c_int) { break ; }
                ...
                start =
                    open[cp.wrapping_offset_from(close.as_mut_ptr()) as
                ...
                loop  {
                    if px == 0 as libc::c_int as libc::c_uint {
                        if py == 0 as libc::c_int as libc::c_uint {
                            ...
                            if xx == 0 as libc::c_int as libc::c_uint &&
                                ...
                                px =
                                    xx.wrapping_sub(1 as libc::c_int as
                                                        libc::c_uint)
                            }
                        }
                    ...
                    grid_get_cell((*s).grid, px, py, &mut gc);
                    if gc.data.size as libc::c_int == 1 as libc::c_int &&
                           !(gc.flags as libc::c_int) & 0x4 as libc::c_int !=
                               0 {
                        if *gc.data.data.as_mut_ptr() as libc::c_int ==
                               found as libc::c_int {
                            n = n.wrapping_add(1)
                        } else if *gc.data.data.as_mut_ptr() as libc::c_int ==
                                      start as libc::c_int {
                            n = n.wrapping_sub(1)
                        }
                    }
                    if !(n != 0 as libc::c_int as libc::c_uint) { break ; }
                }
...
unsafe extern "C" fn window_copy_cmd_next_matching_bracket(mut cs:
                                                               *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut np: u_int = (*wme).prefix;
    ...
    's_33:
        while np != 0 as libc::c_int as libc::c_uint {
            ...
            xx = window_copy_find_length(wme, py);
            yy =
                (*(*s).grid).hsize.wrapping_add((*(*s).grid).sy).wrapping_sub(1
                                                                                  as
                                                                                  libc::c_int
                                                                                  as
                                                                                  libc::c_uint);
			 ...
			 */
                    ...
                    if !cp.is_null() && (*data).modekeys == 1 as libc::c_int {
                        ...
                        if gc.data.size as libc::c_int == 1 as libc::c_int &&
                               !(gc.flags as libc::c_int) & 0x4 as libc::c_int
                                   != 0 &&
                               !strchr(close.as_mut_ptr(),
                                       *gc.data.data.as_mut_ptr() as
                                           libc::c_int).is_null() {
                ...
                if cp.is_null() {
                    if (*data).modekeys == 0 as libc::c_int {
                        ...
                        if !(*gl).flags & 0x1 as libc::c_int != 0 { break ; }
                        if (*gl).cellsize > (*(*s).grid).sx { break ; }
                        ...
                        close[cp.wrapping_offset_from(open.as_mut_ptr()) as
                                  libc::c_long as usize];
                    ...
                    loop  {
                        ...
                        if gc.data.size as libc::c_int == 1 as libc::c_int &&
                            ...
                            if *gc.data.data.as_mut_ptr() as libc::c_int ==
                                   found as libc::c_int {
                                n = n.wrapping_add(1)
                            } else if *gc.data.data.as_mut_ptr() as
                                          libc::c_int == end as libc::c_int {
                                n = n.wrapping_sub(1)
                            }
                        }
...
unsafe extern "C" fn window_copy_cmd_next_paragraph(mut cs:
                                                        *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut np: u_int = (*wme).prefix;
...
unsafe extern "C" fn window_copy_cmd_next_space(mut cs:
                                                    *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut np: u_int = (*wme).prefix;
...
unsafe extern "C" fn window_copy_cmd_next_space_end(mut cs:
                                                        *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut np: u_int = (*wme).prefix;
...
unsafe extern "C" fn window_copy_cmd_next_word(mut cs:
                                                   *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut s: *mut session = (*cs).s;
...
unsafe extern "C" fn window_copy_cmd_next_word_end(mut cs:
                                                       *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut s: *mut session = (*cs).s;
...
unsafe extern "C" fn window_copy_cmd_other_end(mut cs:
                                                   *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut np: u_int = (*wme).prefix;
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
    (*data).selflag = SEL_CHAR;
    if np.wrapping_rem(2 as libc::c_int as libc::c_uint) !=
           0 as libc::c_int as libc::c_uint {
        window_copy_other_end(wme);
    }
    return WINDOW_COPY_CMD_NOTHING;
}
unsafe extern "C" fn window_copy_cmd_page_down(mut cs:
                                                   *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
    ...
    let mut np: u_int = (*wme).prefix;
    while np != 0 as libc::c_int as libc::c_uint {
        if window_copy_pagedown(wme, 0 as libc::c_int, (*data).scroll_exit) !=
               0 {
            return WINDOW_COPY_CMD_CANCEL
        }
        np = np.wrapping_sub(1)
...
unsafe extern "C" fn window_copy_cmd_page_down_and_cancel(mut cs:
                                                              *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut np: u_int = (*wme).prefix;
...
unsafe extern "C" fn window_copy_cmd_page_up(mut cs:
                                                 *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut np: u_int = (*wme).prefix;
...
unsafe extern "C" fn window_copy_cmd_previous_paragraph(mut cs:
                                                            *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut np: u_int = (*wme).prefix;
...
unsafe extern "C" fn window_copy_cmd_previous_space(mut cs:
                                                        *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut np: u_int = (*wme).prefix;
...
unsafe extern "C" fn window_copy_cmd_previous_word(mut cs:
                                                       *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut s: *mut session = (*cs).s;
...
unsafe extern "C" fn window_copy_cmd_rectangle_toggle(mut cs:
                                                          *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
...
unsafe extern "C" fn window_copy_cmd_scroll_down(mut cs:
                                                     *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
    ...
    if (*data).scroll_exit != 0 &&
           (*data).oy == 0 as libc::c_int as libc::c_uint {
        return WINDOW_COPY_CMD_CANCEL
    }
    return WINDOW_COPY_CMD_NOTHING;
}
unsafe extern "C" fn window_copy_cmd_scroll_down_and_cancel(mut cs:
                                                                *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
...
unsafe extern "C" fn window_copy_cmd_scroll_up(mut cs:
                                                   *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut np: u_int = (*wme).prefix;
...
unsafe extern "C" fn window_copy_cmd_search_again(mut cs:
                                                      *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
...
unsafe extern "C" fn window_copy_cmd_search_reverse(mut cs:
                                                        *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
...
unsafe extern "C" fn window_copy_cmd_select_line(mut cs:
                                                     *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
...
unsafe extern "C" fn window_copy_cmd_select_word(mut cs:
                                                     *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut s: *mut session = (*cs).s;
    ...
    if px >= window_copy_find_length(wme, py) ||
           window_copy_in_set(wme,
                              px.wrapping_add(1 as libc::c_int as
                                                  libc::c_uint), py,
                              (*data).ws) == 0 {
        window_copy_cursor_next_word_end(wme, (*data).ws, 1 as libc::c_int);
    } else {
        window_copy_update_cursor(wme, px, (*data).cy);
        if window_copy_update_selection(wme, 1 as libc::c_int,
                                        1 as libc::c_int) != 0 {
            window_copy_redraw_lines(wme, (*data).cy,
                                     1 as libc::c_int as u_int);
        }
    }
    ...
    (*data).endselry =
        (*(*(*data).backing).grid).hsize.wrapping_add((*data).cy).wrapping_sub((*data).oy);
    if (*data).dx > (*data).endselrx { (*data).dx = (*data).endselrx }
    return WINDOW_COPY_CMD_REDRAW;
}
unsafe extern "C" fn window_copy_cmd_set_mark(mut cs:
                                                  *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut data: *mut window_copy_mode_data =
        (*(*cs).wme).data as *mut window_copy_mode_data;
    (*data).mx = (*data).cx;
    (*data).my =
        (*(*(*data).backing).grid).hsize.wrapping_add((*data).cy).wrapping_sub((*data).oy);
...
unsafe extern "C" fn window_copy_cmd_start_of_line(mut cs:
                                                       *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    window_copy_cursor_start_of_line(wme);
...
unsafe extern "C" fn window_copy_cmd_top_line(mut cs:
                                                  *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
...
unsafe extern "C" fn window_copy_cmd_copy_pipe_no_clear(mut cs:
                                                            *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut c: *mut client = (*cs).c;
    ...
    if (*(*cs).args).argc == 3 as libc::c_int {
        prefix =
            format_single(0 as *mut cmdq_item,
                          *(*(*cs).args).argv.offset(2 as libc::c_int as
                                                         isize), c, s, wl, wp)
    }
    if !s.is_null() && (*(*cs).args).argc > 1 as libc::c_int &&
           **(*(*cs).args).argv.offset(1 as libc::c_int as isize) as
...
unsafe extern "C" fn window_copy_cmd_copy_pipe(mut cs:
                                                   *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
...
unsafe extern "C" fn window_copy_cmd_copy_pipe_and_cancel(mut cs:
                                                              *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    window_copy_cmd_copy_pipe_no_clear(cs);
...
unsafe extern "C" fn window_copy_cmd_goto_line(mut cs:
                                                   *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
...
unsafe extern "C" fn window_copy_cmd_jump_backward(mut cs:
                                                       *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
...
unsafe extern "C" fn window_copy_cmd_jump_forward(mut cs:
                                                      *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
...
unsafe extern "C" fn window_copy_cmd_jump_to_backward(mut cs:
                                                          *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
...
unsafe extern "C" fn window_copy_cmd_jump_to_forward(mut cs:
                                                         *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
...
unsafe extern "C" fn window_copy_cmd_jump_to_mark(mut cs:
                                                      *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
...
unsafe extern "C" fn window_copy_cmd_search_backward(mut cs:
                                                         *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
...
unsafe extern "C" fn window_copy_cmd_search_backward_text(mut cs:
                                                              *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
...
unsafe extern "C" fn window_copy_cmd_search_forward(mut cs:
                                                        *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
...
unsafe extern "C" fn window_copy_cmd_search_forward_text(mut cs:
                                                             *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
...
unsafe extern "C" fn window_copy_cmd_search_backward_incremental(mut cs:
                                                                     *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
    ...
    match prefix as libc::c_int {
        61 | 45 => {
            ...
            free((*data).searchstr as *mut libc::c_void);
            (*data).searchstr = xstrdup(argument);
            if window_copy_search_up(wme, 0 as libc::c_int, 1 as libc::c_int)
                   == 0 {
                window_copy_clear_marks(wme);
                return WINDOW_COPY_CMD_REDRAW
            }
        ...
        43 => {
            ...
            free((*data).searchstr as *mut libc::c_void);
            (*data).searchstr = xstrdup(argument);
            if window_copy_search_down(wme, 0 as libc::c_int,
                                       0 as libc::c_int) == 0 {
                window_copy_clear_marks(wme);
                return WINDOW_COPY_CMD_REDRAW
            }
...
unsafe extern "C" fn window_copy_cmd_search_forward_incremental(mut cs:
                                                                    *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut data: *mut window_copy_mode_data =
...
unsafe extern "C" fn window_copy_cmd_refresh_from_pane(mut cs:
                                                           *mut window_copy_cmd_state)
 -> window_copy_cmd_action {
    let mut wme: *mut window_mode_entry = (*cs).wme;
    let mut wp: *mut window_pane = (*wme).swp;
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
    if (*data).viewmode != 0 { return WINDOW_COPY_CMD_NOTHING }
    screen_free((*data).backing);
    free((*data).backing as *mut libc::c_void);
    (*data).backing =
        window_copy_clone_screen(&mut (*wp).base, &mut (*data).screen,
                                 0 as *mut u_int, 0 as *mut u_int,
                                 ((*wme).swp != (*wme).wp) as libc::c_int);
    window_copy_size_changed(wme);
    return WINDOW_COPY_CMD_REDRAW;
}
        ...
        [{
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  f:
                                      Some(window_copy_cmd_append_selection as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"append-selection-and-cancel\x00" as
                                          *const u8 as *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 0 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_append_selection_and_cancel
                                               as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"back-to-indentation\x00" as *const u8
                                          as *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 0 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_back_to_indentation
                                               as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_begin_selection as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"bottom-line\x00" as *const u8 as
                                          *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 0 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_bottom_line as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_cancel as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_clear_selection as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_copy_end_of_line as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"copy-line\x00" as *const u8 as
                                          *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 1 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_copy_line as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"copy-pipe-no-clear\x00" as *const u8
                                          as *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 2 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_NEVER,
                                  f:
                                      Some(window_copy_cmd_copy_pipe_no_clear
                                               as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"copy-pipe\x00" as *const u8 as
                                          *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 2 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_copy_pipe as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"copy-pipe-and-cancel\x00" as *const u8
                                          as *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 2 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_copy_pipe_and_cancel
                                               as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"copy-selection-no-clear\x00" as
                                          *const u8 as *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 1 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_NEVER,
                                  f:
                                      Some(window_copy_cmd_copy_selection_no_clear
                                               as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_copy_selection as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"copy-selection-and-cancel\x00" as
                                          *const u8 as *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 1 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_copy_selection_and_cancel
                                               as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"cursor-down\x00" as *const u8 as
                                          *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 0 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_cursor_down as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"cursor-down-and-cancel\x00" as
                                          *const u8 as *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 0 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_cursor_down_and_cancel
                                               as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_cursor_left as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_cursor_right as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_cursor_up as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_end_of_line as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"goto-line\x00" as *const u8 as
                                          *const libc::c_char,
                                  minargs: 1 as libc::c_int,
                                  maxargs: 1 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_goto_line as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_halfpage_down as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"halfpage-down-and-cancel\x00" as
                                          *const u8 as *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 0 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_halfpage_down_and_cancel
                                               as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"halfpage-up\x00" as *const u8 as
                                          *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 0 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_halfpage_up as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_history_bottom as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"history-top\x00" as *const u8 as
                                          *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 0 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_history_top as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"jump-again\x00" as *const u8 as
                                          *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 0 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_jump_again as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_jump_backward as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"jump-forward\x00" as *const u8 as
                                          *const libc::c_char,
                                  minargs: 1 as libc::c_int,
                                  maxargs: 1 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_jump_forward as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"jump-reverse\x00" as *const u8 as
                                          *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 0 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_jump_reverse as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_jump_to_backward as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_jump_to_forward as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"jump-to-mark\x00" as *const u8 as
                                          *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 0 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_jump_to_mark as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"middle-line\x00" as *const u8 as
                                          *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 0 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_middle_line as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"next-matching-bracket\x00" as
                                          *const u8 as *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 0 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_next_matching_bracket
                                               as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_next_paragraph as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_next_space as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_next_space_end as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_next_word as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_next_word_end as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_other_end as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"page-down\x00" as *const u8 as
                                          *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 0 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_page_down as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"page-down-and-cancel\x00" as *const u8
                                          as *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 0 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_page_down_and_cancel
                                               as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"page-up\x00" as *const u8 as
                                          *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 0 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_page_up as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"previous-matching-bracket\x00" as
                                          *const u8 as *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 0 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_previous_matching_bracket
                                               as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"previous-paragraph\x00" as *const u8
                                          as *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 0 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_previous_paragraph
                                               as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_previous_space as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_previous_word as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_rectangle_toggle as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"refresh-from-pane\x00" as *const u8 as
                                          *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 0 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_refresh_from_pane
                                               as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"scroll-down\x00" as *const u8 as
                                          *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 0 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_scroll_down as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"scroll-down-and-cancel\x00" as
                                          *const u8 as *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 0 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_scroll_down_and_cancel
                                               as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"scroll-up\x00" as *const u8 as
                                          *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 0 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_scroll_up as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_search_again as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_search_backward as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"search-backward-text\x00" as *const u8
                                          as *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 1 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_search_backward_text
                                               as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"search-backward-incremental\x00" as
                                          *const u8 as *const libc::c_char,
                                  minargs: 1 as libc::c_int,
                                  maxargs: 1 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_search_backward_incremental
                                               as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_search_forward as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"search-forward-text\x00" as *const u8
                                          as *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 1 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_search_forward_text
                                               as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"search-forward-incremental\x00" as
                                          *const u8 as *const libc::c_char,
                                  minargs: 1 as libc::c_int,
                                  maxargs: 1 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_search_forward_incremental
                                               as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_search_reverse as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"select-line\x00" as *const u8 as
                                          *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 0 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_select_line as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"select-word\x00" as *const u8 as
                                          *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 0 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_select_word as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"set-mark\x00" as *const u8 as
                                          *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 0 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_set_mark as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_start_of_line as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                  ...
                                  clear: WINDOW_COPY_CMD_CLEAR_ALWAYS,
                                  f:
                                      Some(window_copy_cmd_stop_selection as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
         ...
         },
         {
             let mut init =
                 C2RustUnnamed_35{command:
                                      b"top-line\x00" as *const u8 as
                                          *const libc::c_char,
                                  minargs: 0 as libc::c_int,
                                  maxargs: 0 as libc::c_int,
                                  clear: WINDOW_COPY_CMD_CLEAR_EMACS_ONLY,
                                  f:
                                      Some(window_copy_cmd_top_line as
                                               unsafe extern "C" fn(_:
                                                                        *mut window_copy_cmd_state)
                                                   ->
                                                       window_copy_cmd_action),};
...
unsafe extern "C" fn window_copy_command(mut wme: *mut window_mode_entry,
                                         mut c: *mut client,
                                         mut s: *mut session,
                                         mut wl: *mut winlink,
                                         mut args: *mut args,
    ...
    let mut cs: window_copy_cmd_state =
        window_copy_cmd_state{wme: 0 as *mut window_mode_entry,
                              args: 0 as *mut args,
    ...
    if (*args).argc == 0 as libc::c_int { return }
    command = *(*args).argv.offset(0 as libc::c_int as isize);
    if !m.is_null() && (*m).valid != 0 &&
           (*m).b & 64 as libc::c_int as libc::c_uint == 0 {
    ...
    while (i as libc::c_ulong) <
              (::std::mem::size_of::<[C2RustUnnamed_35; 68]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<C2RustUnnamed_35>()
                                                   as libc::c_ulong) {
        if strcmp(window_copy_cmd_table[i as usize].command, command) ==
               0 as libc::c_int {
            if ((*args).argc - 1 as libc::c_int) <
                   window_copy_cmd_table[i as usize].minargs ||
                   (*args).argc - 1 as libc::c_int >
                       window_copy_cmd_table[i as usize].maxargs {
                break ;
            }
            clear = window_copy_cmd_table[i as usize].clear;
            action =
                window_copy_cmd_table[i as
                                          usize].f.expect("non-null function pointer")(&mut cs);
            break ;
        } else { i = i.wrapping_add(1) }
    }
    if strncmp(command, b"search-\x00" as *const u8 as *const libc::c_char,
               7 as libc::c_int as libc::c_ulong) != 0 as libc::c_int &&
           !(*data).searchmark.is_null() {
        keys =
            options_get_number((*(*(*wme).wp).window).options,
                               b"mode-keys\x00" as *const u8 as
                                   *const libc::c_char) as libc::c_int;
        if clear as libc::c_uint ==
               WINDOW_COPY_CMD_CLEAR_EMACS_ONLY as libc::c_int as libc::c_uint
               && keys == 1 as libc::c_int {
            clear = WINDOW_COPY_CMD_CLEAR_NEVER
        }
        if clear as libc::c_uint !=
               WINDOW_COPY_CMD_CLEAR_NEVER as libc::c_int as libc::c_uint {
            window_copy_clear_marks(wme);
            (*data).searchy = -(1 as libc::c_int);
            (*data).searchx = (*data).searchy
        ...
        if action as libc::c_uint ==
               WINDOW_COPY_CMD_NOTHING as libc::c_int as libc::c_uint {
            action = WINDOW_COPY_CMD_REDRAW
        }
    }
    (*wme).prefix = 1 as libc::c_int as u_int;
    if action as libc::c_uint ==
           WINDOW_COPY_CMD_CANCEL as libc::c_int as libc::c_uint {
        window_pane_reset_mode((*wme).wp);
    } else if action as libc::c_uint ==
                  WINDOW_COPY_CMD_REDRAW as libc::c_int as libc::c_uint {
        window_copy_redraw_screen(wme);
    };
}
unsafe extern "C" fn window_copy_scroll_to(mut wme: *mut window_mode_entry,
    ...
    window_copy_update_selection(wme, 1 as libc::c_int, 0 as libc::c_int);
    if no_redraw == 0 { window_copy_redraw_screen(wme); };
}
 ...
 -> libc::c_int {
    ...
    if cis != 0 && (*ud).size as libc::c_int == 1 as libc::c_int {
        return (({
                     ...
                     if ::std::mem::size_of::<u_char>() as libc::c_ulong >
                         ...
                         if 0 != 0 {
                             let mut __c: libc::c_int =
                                 (*ud).data[0 as libc::c_int as usize] as
                                     libc::c_int;
                             __res =
                             ...
                             __res =
                                 tolower((*ud).data[0 as libc::c_int as usize]
                                             as libc::c_int)
                         }
                     } else {
                         __res =
                             *(*__ctype_tolower_loc()).offset((*ud).data[0 as
                                                                             libc::c_int
                                                                             as
                                                                             usize]
                                                                  as
                     ...
                     __res
                 }) == (*sud).data[0 as libc::c_int as usize] as libc::c_int)
                   as libc::c_int
    }
    return (memcmp((*ud).data.as_ptr() as *const libc::c_void,
                   (*sud).data.as_ptr() as *const libc::c_void,
                   (*ud).size as libc::c_ulong) == 0 as libc::c_int) as
               libc::c_int;
}
unsafe extern "C" fn window_copy_search_lr(mut gd: *mut grid,
 ...
 -> libc::c_int {
    ...
    let mut gl: *mut grid_line = 0 as *mut grid_line;
    endline =
        (*gd).hsize.wrapping_add((*gd).sy).wrapping_sub(1 as libc::c_int as
                                                            libc::c_uint);
    ax = first;
    while ax < last {
        ...
        while bx < (*sgd).sx {
            ...
            while px >= (*gd).sx && pywrap < endline {
                ...
                if !(*gl).flags & 0x1 as libc::c_int != 0 { break ; }
                px =
                    (px as libc::c_uint).wrapping_sub((*gd).sx) as u_int as
                        u_int;
            ...
            if px >= (*gd).sx { break ; }
            matched =
                window_copy_search_compare(gd, px, pywrap, sgd, bx, cis);
            if matched == 0 { break ; }
            bx = bx.wrapping_add(1)
        }
        if bx == (*sgd).sx { *ppx = ax; return 1 as libc::c_int }
...
unsafe extern "C" fn window_copy_search_rl(mut gd: *mut grid,
 ...
 -> libc::c_int {
    ...
    while ax > first {
        ...
        while bx < (*sgd).sx {
            px =
                ax.wrapping_sub(1 as libc::c_int as
...
unsafe extern "C" fn window_copy_search_lr_regex(mut gd: *mut grid,
                                                 mut ppx: *mut u_int,
                                                 mut psx: *mut u_int,
                                                 mut py: u_int,
                                                 mut first: u_int,
 ...
 -> libc::c_int {
	 ...
	 * character on a line.
	 */
    if first >= last { return 0 as libc::c_int }
    ...
    *buf.offset(0 as libc::c_int as isize) = '\u{0}' as i32 as libc::c_char;
    ...
    while !buf.is_null() && pywrap <= endline {
        ...
        pywrap = pywrap.wrapping_add(1);
        buf =
            window_copy_stringify(gd, pywrap, 0 as libc::c_int as u_int,
                                  (*gd).sx, buf, &mut size);
        len = (len as libc::c_uint).wrapping_add((*gd).sx) as u_int as u_int
    }
    if regexec(reg, buf, 1 as libc::c_int as size_t, &mut regmatch, eflags) ==
           0 as libc::c_int && regmatch.rm_so != regmatch.rm_eo {
        foundx = first;
        foundy = py;
        window_copy_cstrtocellpos(gd, len, &mut foundx, &mut foundy,
                                  buf.offset(regmatch.rm_so as isize));
        if foundy == py && foundx < last {
            *ppx = foundx;
            len =
                (len as libc::c_uint).wrapping_sub(foundx.wrapping_sub(first))
                    as u_int as u_int;
            window_copy_cstrtocellpos(gd, len, &mut foundx, &mut foundy,
            ...
            *psx = foundx;
            while foundy > py {
                *psx =
                    (*psx as libc::c_uint).wrapping_add((*gd).sx) as u_int as
                        u_int;
                foundy = foundy.wrapping_sub(1)
            }
            *psx =
                (*psx as libc::c_uint).wrapping_sub(*ppx) as u_int as u_int;
...
unsafe extern "C" fn window_copy_search_rl_regex(mut gd: *mut grid,
                                                 mut ppx: *mut u_int,
                                                 mut psx: *mut u_int,
                                                 mut py: u_int,
                                                 mut first: u_int,
...
unsafe extern "C" fn window_copy_cellstring(mut gl: *const grid_line,
                                            mut px: u_int,
                                            mut size: *mut size_t,
                                            mut allocated: *mut libc::c_int)
 -> *const libc::c_char {
    static mut ud: utf8_data =
    ...
    if !((*gce).flags as libc::c_int) & 0x8 as libc::c_int != 0 {
        *size = 1 as libc::c_int as size_t;
        *allocated = 0 as libc::c_int;
        return &mut (*gce).c2rust_unnamed.data.data as *mut u_char as
                   *const libc::c_char
    }
    utf8_to_data((*(*gl).extddata.offset((*gce).c2rust_unnamed.offset as
                                             isize)).data, &mut ud);
    *size = ud.size as size_t;
    *allocated = 1 as libc::c_int;
    copy = xmalloc(ud.size as size_t) as *mut libc::c_char;
    memcpy(copy as *mut libc::c_void,
           ud.data.as_mut_ptr() as *const libc::c_void,
           ud.size as libc::c_ulong);
    return copy;
}
/* Find last match in given range. */
unsafe extern "C" fn window_copy_last_regex(mut gd: *mut grid, mut py: u_int,
                                            mut first: u_int, mut last: u_int,
                                            mut len: u_int,
                                            mut ppx: *mut u_int,
                                            mut psx: *mut u_int,
 ...
 -> libc::c_int {
    ...
    foundy = py;
    oldx = first;
    while regexec(preg, buf.offset(px as isize), 1 as libc::c_int as size_t,
                  &mut regmatch, eflags) == 0 as libc::c_int {
        if regmatch.rm_so == regmatch.rm_eo { break ; }
        window_copy_cstrtocellpos(gd, len, &mut foundx, &mut foundy,
                                  buf.offset(px as
                                                 isize).offset(regmatch.rm_so
                                                                   as isize));
        if foundy > py || foundx >= last { break ; }
        len =
            (len as libc::c_uint).wrapping_sub(foundx.wrapping_sub(oldx)) as
                u_int as u_int;
        savepx = foundx;
        window_copy_cstrtocellpos(gd, len, &mut foundx, &mut foundy,
                                  buf.offset(px as
                                                 isize).offset(regmatch.rm_eo
                                                                   as isize));
        if foundy > py || foundx >= last {
            *ppx = savepx;
            *psx = foundx;
            ...
            *psx =
            ...
            len =
                (len as libc::c_uint).wrapping_sub(savesx) as u_int as u_int;
            oldx = foundx
        }
        px =
            (px as libc::c_uint).wrapping_add(regmatch.rm_eo as libc::c_uint)
                as u_int as u_int
    }
...
unsafe extern "C" fn window_copy_stringify(mut gd: *mut grid, mut py: u_int,
                                           mut first: u_int, mut last: u_int,
 ...
 -> *mut libc::c_char {
    ...
    while ax < last {
        ...
        newsize =
            (newsize as libc::c_ulong).wrapping_add(dlen) as u_int as u_int;
        while bufsize < newsize as libc::c_ulong {
            bufsize =
                (bufsize as
                     libc::c_ulong).wrapping_mul(2 as libc::c_int as
                    ...
                    as size_t;
            buf =
                xrealloc(buf as *mut libc::c_void, bufsize) as
                    *mut libc::c_char
        }
        if dlen == 1 as libc::c_int as libc::c_ulong {
            ...
            *buf.offset(fresh2 as isize) = *d
            ...
            memcpy(buf.offset(bx as isize) as *mut libc::c_void,
                   d as *const libc::c_void, dlen);
            bx = (bx as libc::c_ulong).wrapping_add(dlen) as u_int as u_int
        }
        if allocated != 0 { free(d as *mut libc::c_void); }
        ax = ax.wrapping_add(1)
    }
    *buf.offset(newsize.wrapping_sub(1 as libc::c_int as libc::c_uint) as
                    isize) = '\u{0}' as i32 as libc::c_char;
    *size = newsize;
    return buf;
}
/* Map start of C string containing UTF-8 data to grid cell position. */
unsafe extern "C" fn window_copy_cstrtocellpos(mut gd: *mut grid,
                                               mut ncells: u_int,
                                               mut ppx: *mut u_int,
                                               mut ppy: *mut u_int,
    ...
    cells =
        xreallocarray(0 as *mut libc::c_void, ncells as size_t,
                      ::std::mem::size_of::<C2RustUnnamed_36>() as
                          libc::c_ulong) as *mut C2RustUnnamed_36;
    ...
    while cell < ncells {
        ...
        *fresh3 =
            window_copy_cellstring(gl, px,
                                   &mut (*cells.offset(cell as isize)).dlen,
                                   &mut (*cells.offset(cell as
                                                           isize)).allocated);
    ...
    while cell < ncells {
        ...
        while ccell < ncells {
            if *str.offset(pos as isize) as libc::c_int == '\u{0}' as i32 {
                ...
                if dlen == 1 as libc::c_int as libc::c_ulong {
                    if *str.offset(pos as isize) as libc::c_int !=
                           *d as libc::c_int {
                        match_0 = 0 as libc::c_int;
                        break ;
                    ...
                    if memcmp(str.offset(pos as isize) as *const libc::c_void,
                              d as *const libc::c_void, dlen) !=
                           0 as libc::c_int {
                        match_0 = 0 as libc::c_int;
                        break ;
                        ...
                        pos =
                            (pos as libc::c_ulong).wrapping_add(dlen) as u_int
                                as u_int
                    }
                }
...
unsafe extern "C" fn window_copy_move_left(mut s: *mut screen,
    ...
    if *fx == 0 as libc::c_int as libc::c_uint {
        ...
        if *fy == 0 as libc::c_int as libc::c_uint {
            ...
            if wrapflag != 0 {
                *fx =
                    (*(*s).grid).sx.wrapping_sub(1 as libc::c_int as
                                                     libc::c_uint);
                *fy =
                    (*(*s).grid).hsize.wrapping_add((*(*s).grid).sy).wrapping_sub(1
                                                                                      as
        ...
        *fx = (*(*s).grid).sx.wrapping_sub(1 as libc::c_int as libc::c_uint);
        *fy = (*fy).wrapping_sub(1 as libc::c_int as libc::c_uint)
    } else { *fx = (*fx).wrapping_sub(1 as libc::c_int as libc::c_uint) };
}
        ...
        if *ptr as libc::c_int !=
               ({
                    ...
                    if ::std::mem::size_of::<u_char>() as libc::c_ulong >
                        ...
                        __res =
                            *(*__ctype_tolower_loc()).offset(*ptr as u_char as
                                                                 libc::c_int
                                                                 as isize)
                    }
                    __res
 ...
 * not found.
 */
unsafe extern "C" fn window_copy_search_jump(mut wme: *mut window_mode_entry,
                                             mut gd: *mut grid,
                                             mut sgd: *mut grid,
 ...
 -> libc::c_int {
    ...
    if regex != 0 {
        ...
        *sbuf.offset(0 as libc::c_int as isize) =
            '\u{0}' as i32 as libc::c_char;
        sbuf =
            window_copy_stringify(sgd, 0 as libc::c_int as u_int,
                                  0 as libc::c_int as u_int, (*sgd).sx, sbuf,
                                  &mut ssize);
        if cis != 0 { cflags |= (1 as libc::c_int) << 1 as libc::c_int }
    ...
    if direction != 0 {
        ...
        while i <= endline {
            if regex != 0 {
                found =
                    window_copy_search_lr_regex(gd, &mut px, &mut sx, i, fx,
                                                (*gd).sx, &mut reg);
                if found != 0 { *foundlen = sx }
            } else {
                found =
                    window_copy_search_lr(gd, sgd, &mut px, i, fx, (*gd).sx,
                                          cis);
                if found != 0 { *foundlen = (*sgd).sx }
            }
            if found != 0 { break ; }
        ...
        *foundlen = 0 as libc::c_int as u_int;
        ...
        while endline < i {
            if regex != 0 {
                found =
                    window_copy_search_rl_regex(gd, &mut px, &mut sx,
                                                i.wrapping_sub(1 as
                                                                   libc::c_int
                                                                   as
                                                                   libc::c_uint),
                                                0 as libc::c_int as u_int,
                                                fx.wrapping_add(1 as
                                                                    libc::c_int
                                                                    as
                                                                    libc::c_uint),
                                                &mut reg)
                ...
                found =
                    window_copy_search_rl(gd, sgd, &mut px,
                                          i.wrapping_sub(1 as libc::c_int as
                                                             libc::c_uint),
                                          0 as libc::c_int as u_int,
                                          fx.wrapping_add(1 as libc::c_int as
                                                              libc::c_uint),
                                          cis)
            }
            if found != 0 {
    ...
    if wrap != 0 {
        return window_copy_search_jump(wme, gd, sgd,
                                       ...
                                       if direction != 0 {
                                           ...
                                           (*gd).hsize.wrapping_add((*gd).sy).wrapping_sub(1
                                                                                               as
                                                                                               libc::c_int
                                                                                               as
                                                                                               libc::c_uint)
                                       }, fy, cis, 0 as libc::c_int,
 ...
 * down.
 */
unsafe extern "C" fn window_copy_search(mut wme: *mut window_mode_entry,
                                        mut direction: libc::c_int,
                                        mut regex: libc::c_int,
 ...
 -> libc::c_int {
    ...
    screen_init(&mut ss,
                screen_write_strlen(b"%s\x00" as *const u8 as
                                        *const libc::c_char, str) as u_int,
    ...
    screen_write_nputs(&mut ctx as *mut screen_write_ctx,
                       ...
                       b"%s\x00" as *const u8 as *const libc::c_char, str);
    screen_write_stop(&mut ctx);
    wrapflag =
        options_get_number((*(*wp).window).options,
    ...
    if direction != 0 {
        endline =
            (*gd).hsize.wrapping_add((*gd).sy).wrapping_sub(1 as libc::c_int
                                                                as
                                                                libc::c_uint)
    } else {
        if again != 0 {
    ...
    found =
        window_copy_search_jump(wme, gd, ss.grid, fx, fy, endline, cis,
                                wrapflag, direction, regex, &mut foundlen);
    if found != 0 {
...
unsafe extern "C" fn window_copy_visible_lines(mut data:
                                                   *mut window_copy_mode_data,
                                               mut start: *mut u_int,
                                               mut end: *mut u_int) {
    let mut gd: *mut grid = (*(*data).backing).grid;
    ...
    *start = (*gd).hsize.wrapping_sub((*data).oy);
    while *start > 0 as libc::c_int as libc::c_uint {
        gl =
            grid_peek_line(gd,
                           (*start).wrapping_sub(1 as libc::c_int as
                                                     libc::c_uint));
        if !(*gl).flags & 0x1 as libc::c_int != 0 { break ; }
...
unsafe extern "C" fn window_copy_search_mark_at(mut data:
                                                    *mut window_copy_mode_data,
                                                mut px: u_int, mut py: u_int,
                                                mut at: *mut u_int)
 -> libc::c_int {
    ...
    if py >
           (*gd).hsize.wrapping_sub((*data).oy).wrapping_add((*gd).sy).wrapping_sub(1
                                                                                        as
                                                                                        libc::c_int
                                                                                        as
                                                                                        libc::c_uint)
    ...
    *at =
        py.wrapping_sub((*gd).hsize.wrapping_sub((*data).oy)).wrapping_mul((*gd).sx).wrapping_add(px);
    return 0 as libc::c_int;
}
unsafe extern "C" fn window_copy_search_marks(mut wme: *mut window_mode_entry,
                                              mut ssp: *mut screen,
                                              mut regex: libc::c_int,
 ...
 -> libc::c_int {
    ...
    if ssp.is_null() {
        ...
        screen_init(&mut ss, width, 1 as libc::c_int as u_int,
                    0 as libc::c_int as u_int);
        screen_write_start(&mut ctx, &mut ss);
        screen_write_nputs(&mut ctx as *mut screen_write_ctx,
                           -(1 as libc::c_int) as ssize_t,
    ...
    if regex != 0 {
        ...
        *sbuf.offset(0 as libc::c_int as isize) =
            '\u{0}' as i32 as libc::c_char;
        sbuf =
            window_copy_stringify((*ssp).grid, 0 as libc::c_int as u_int,
                                  0 as libc::c_int as u_int,
                                  (*(*ssp).grid).sx, sbuf, &mut ssize);
        if cis != 0 { cflags |= (1 as libc::c_int) << 1 as libc::c_int }
        if regcomp(&mut reg, sbuf, cflags) != 0 as libc::c_int {
            free(sbuf as *mut libc::c_void);
            return 0 as libc::c_int
    ...
    loop  {
        free((*data).searchmark as *mut libc::c_void);
        (*data).searchmark =
            xcalloc((*gd).sx as size_t, (*gd).sy as size_t) as *mut u_char;
        ...
        while py < end {
            ...
            loop  {
                if regex != 0 {
                    found =
                        window_copy_search_lr_regex(gd, &mut px, &mut width,
                                                    py, px, (*gd).sx,
                                                    &mut reg);
                    if found == 0 { break ; }
                } else {
                    found =
                        window_copy_search_lr(gd, (*ssp).grid, &mut px, py,
                                              px, (*gd).sx, cis);
                    if found == 0 { break ; }
                }
                ...
                if window_copy_search_mark_at(data, px, py, &mut b) ==
                       0 as libc::c_int {
                    if b.wrapping_add(width) > (*gd).sx.wrapping_mul((*gd).sy)
                       {
                        width =
                            (*gd).sx.wrapping_mul((*gd).sy).wrapping_sub(b)
                    }
                    i = b;
                    while i < b.wrapping_add(width) {
                        *(*data).searchmark.offset(i as isize) =
                            (*data).searchgen;
                        i = i.wrapping_add(1)
                    }
                ...
                px =
                    (px as libc::c_uint).wrapping_add(width) as u_int as u_int
            }
            t = get_timer();
        ...
        if (*data).timeout != 0 {
            ...
            if visible_only == 0 {
                if stopped != 0 {
                    ...
                    } else { (*data).searchcount = -(1 as libc::c_int) }
                    (*data).searchmore = 1 as libc::c_int
                } else {
                    if which != -(1 as libc::c_int) {
                        (*data).searchthis =
                            (1 as libc::c_int as
                                 libc::c_uint).wrapping_add(nfound).wrapping_sub(which
                                                                                     as
                                                                                     libc::c_uint)
                                as libc::c_int
                    } else { (*data).searchthis = -(1 as libc::c_int) }
    ...
    if ssp == &mut ss as *mut screen { screen_free(&mut ss); }
    if regex != 0 { regfree(&mut reg); }
    return 1 as libc::c_int;
}
unsafe extern "C" fn window_copy_clear_marks(mut wme:
                                                 *mut window_mode_entry) {
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
    free((*data).searchmark as *mut libc::c_void);
...
unsafe extern "C" fn window_copy_search_up(mut wme: *mut window_mode_entry,
                                           mut regex: libc::c_int,
                                           mut again: libc::c_int)
 -> libc::c_int {
    return window_copy_search(wme, 0 as libc::c_int, regex, again);
}
unsafe extern "C" fn window_copy_search_down(mut wme: *mut window_mode_entry,
                                             mut regex: libc::c_int,
                                             mut again: libc::c_int)
 -> libc::c_int {
    return window_copy_search(wme, 1 as libc::c_int, regex, again);
}
unsafe extern "C" fn window_copy_goto_line(mut wme: *mut window_mode_entry,
...
unsafe extern "C" fn window_copy_match_start_end(mut data:
                                                     *mut window_copy_mode_data,
                                                 mut at: u_int,
                                                 mut start: *mut u_int,
                                                 mut end: *mut u_int) {
    let mut gd: *mut grid = (*(*data).backing).grid;
    let mut last: u_int =
        (*gd).sy.wrapping_mul((*gd).sx).wrapping_sub(1 as libc::c_int as
                                                         libc::c_uint);
    let mut mark: u_char = *(*data).searchmark.offset(at as isize);
    *end = at;
    *start = *end;
    while *start != 0 as libc::c_int as libc::c_uint &&
              *(*data).searchmark.offset(*start as isize) as libc::c_int ==
                  mark as libc::c_int {
        *start = (*start).wrapping_sub(1)
    }
    if *(*data).searchmark.offset(*start as isize) as libc::c_int !=
           mark as libc::c_int {
        *start = (*start).wrapping_add(1)
    }
    while *end != last &&
              *(*data).searchmark.offset(*end as isize) as libc::c_int ==
                  mark as libc::c_int {
        *end = (*end).wrapping_add(1)
    }
    if *(*data).searchmark.offset(*end as isize) as libc::c_int !=
           mark as libc::c_int {
        *end = (*end).wrapping_sub(1)
    };
}
unsafe extern "C" fn window_copy_match_at_cursor(mut data:
                                                     *mut window_copy_mode_data)
 -> *mut libc::c_char {
    let mut gd: *mut grid = (*(*data).backing).grid;
    let mut gc: grid_cell =
    ...
    if (*data).searchmark.is_null() { return 0 as *mut libc::c_char }
    cy =
        (*(*(*data).backing).grid).hsize.wrapping_sub((*data).oy).wrapping_add((*data).cy);
    if window_copy_search_mark_at(data, (*data).cx, cy, &mut at) !=
           0 as libc::c_int {
        return 0 as *mut libc::c_char
    }
    if *(*data).searchmark.offset(at as isize) as libc::c_int ==
           0 as libc::c_int {
        return 0 as *mut libc::c_char
    }
    ...
    while at <= end {
        ...
        buf =
            xrealloc(buf as *mut libc::c_void,
                     len.wrapping_add(gc.data.size as
        ...
        len =
            (len as libc::c_ulong).wrapping_add(gc.data.size as libc::c_ulong)
                as size_t as size_t;
...
unsafe extern "C" fn window_copy_update_style(mut wme: *mut window_mode_entry,
                                              mut fx: u_int, mut fy: u_int,
    ...
    if (*data).showmark != 0 && fy == (*data).my {
        (*gc).attr = (*mkgc).attr;
        if fx == (*data).mx { inv = 1 as libc::c_int }
        if inv != 0 {
            (*gc).fg = (*mkgc).bg;
            (*gc).bg = (*mkgc).fg
        } else { (*gc).fg = (*mkgc).fg; (*gc).bg = (*mkgc).bg }
    }
    if (*data).searchmark.is_null() { return }
    if window_copy_search_mark_at(data, fx, fy, &mut current) !=
           0 as libc::c_int {
        return
    }
    mark = *(*data).searchmark.offset(current as isize) as u_int;
    if mark == 0 as libc::c_int as libc::c_uint { return }
    cy =
        (*(*(*data).backing).grid).hsize.wrapping_sub((*data).oy).wrapping_add((*data).cy);
    if window_copy_search_mark_at(data, (*data).cx, cy, &mut cursor) ==
           0 as libc::c_int {
        if *(*data).searchmark.offset(cursor as isize) as libc::c_uint == mark
           {
            ...
            if *(*data).searchmark.offset(cursor as isize) as libc::c_uint ==
                   mark {
                found = 1 as libc::c_int
            }
        }
        if found != 0 {
            ...
            if current >= start && current <= end {
                ...
                if inv != 0 {
                    (*gc).fg = (*cgc).bg;
                    (*gc).bg = (*cgc).fg
                } else { (*gc).fg = (*cgc).fg; (*gc).bg = (*cgc).bg }
                return
            }
        }
    }
    ...
    if inv != 0 {
        (*gc).fg = (*mgc).bg;
        (*gc).bg = (*mgc).fg
    } else { (*gc).fg = (*mgc).fg; (*gc).bg = (*mgc).bg };
}
unsafe extern "C" fn window_copy_write_one(mut wme: *mut window_mode_entry,
                                           mut ctx: *mut screen_write_ctx,
                                           mut py: u_int, mut fy: u_int,
                                           mut nx: u_int,
                                           mut mgc: *const grid_cell,
                                           mut cgc: *const grid_cell,
                                           mut mkgc: *const grid_cell) {
    ...
    let mut gc: grid_cell =
        grid_cell{data: utf8_data{data: [0; 21], have: 0, size: 0, width: 0,},
                  ...
                  us: 0,};
    let mut fx: u_int = 0;
    screen_write_cursormove(ctx, 0 as libc::c_int, py as libc::c_int,
                            0 as libc::c_int);
    fx = 0 as libc::c_int as u_int;
    while fx < nx {
...
unsafe extern "C" fn window_copy_write_line(mut wme: *mut window_mode_entry,
                                            mut ctx: *mut screen_write_ctx,
                                            mut py: u_int) {
    let mut wp: *mut window_pane = (*wme).wp;
    let mut data: *mut window_copy_mode_data =
    ...
    style_apply(&mut mgc, oo,
                b"copy-mode-match-style\x00" as *const u8 as
                    *const libc::c_char, 0 as *mut format_tree);
    mgc.flags = (mgc.flags as libc::c_int | 0x20 as libc::c_int) as u_char;
    style_apply(&mut cgc, oo,
                b"copy-mode-current-match-style\x00" as *const u8 as
                    *const libc::c_char, 0 as *mut format_tree);
    cgc.flags = (cgc.flags as libc::c_int | 0x20 as libc::c_int) as u_char;
    style_apply(&mut mkgc, oo,
                b"copy-mode-mark-style\x00" as *const u8 as
                    *const libc::c_char, 0 as *mut format_tree);
    mkgc.flags = (mkgc.flags as libc::c_int | 0x20 as libc::c_int) as u_char;
    if py == 0 as libc::c_int as libc::c_uint && (*s).rupper < (*s).rlower &&
        ...
        if (*data).searchmark.is_null() {
                ...
                size =
                    xsnprintf(hdr.as_mut_ptr(),
                              ::std::mem::size_of::<[libc::c_char; 512]>() as
                                  libc::c_ulong,
                              b"(timed out) [%u/%u]\x00" as *const u8 as
                                  *const libc::c_char, (*data).oy, hsize) as
                        size_t
            } else {
                size =
                    xsnprintf(hdr.as_mut_ptr(),
            ...
            size =
                xsnprintf(hdr.as_mut_ptr(),
                          ...
                          (*data).oy, hsize) as size_t
        } else if (*data).searchthis == -(1 as libc::c_int) {
            size =
                xsnprintf(hdr.as_mut_ptr(),
                          ::std::mem::size_of::<[libc::c_char; 512]>() as
                              libc::c_ulong,
                          b"(%d%s results) [%u/%u]\x00" as *const u8 as
            ...
            size =
                xsnprintf(hdr.as_mut_ptr(),
                          ::std::mem::size_of::<[libc::c_char; 512]>() as
                              libc::c_ulong,
                          b"(%d/%d results) [%u/%u]\x00" as *const u8 as
                              *const libc::c_char, (*data).searchthis,
                          (*data).searchcount, (*data).oy, hsize) as size_t
        }
        ...
        screen_write_puts(ctx, &mut gc as *mut grid_cell,
                          b"%s\x00" as *const u8 as *const libc::c_char,
                          hdr.as_mut_ptr());
    } else { size = 0 as libc::c_int as size_t }
    if size < (*(*s).grid).sx as libc::c_ulong {
        window_copy_write_one(wme, ctx, py,
                              hsize.wrapping_sub((*data).oy).wrapping_add(py),
                              ((*(*s).grid).sx as
                                   libc::c_ulong).wrapping_sub(size) as u_int,
                              &mut mgc, &mut cgc, &mut mkgc);
    }
    if py == (*data).cy && (*data).cx == (*(*s).grid).sx {
        screen_write_cursormove(ctx,
                                (*(*s).grid).sx.wrapping_sub(1 as libc::c_int
                                                                 as
                                                                 libc::c_uint)
                                    as libc::c_int, py as libc::c_int,
                                0 as libc::c_int);
        screen_write_putc(ctx, &grid_default_cell, '$' as i32 as u_char);
    };
}
unsafe extern "C" fn window_copy_write_lines(mut wme: *mut window_mode_entry,
                                             mut ctx: *mut screen_write_ctx,
...
unsafe extern "C" fn window_copy_redraw_selection(mut wme:
                                                      *mut window_mode_entry,
                                                  mut old_y: u_int) {
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
	 ...
	 */
    if (*data).selflag as libc::c_uint ==
           SEL_WORD as libc::c_int as libc::c_uint {
        /* Last grid line in data coordinates. */
        if end <
               (*gd).sy.wrapping_add((*data).oy).wrapping_sub(1 as libc::c_int
                                                                  as
                                                                  libc::c_uint)
           {
            end = end.wrapping_add(1)
    ...
    window_copy_redraw_lines(wme, start,
                             end.wrapping_sub(start).wrapping_add(1 as
                                                                      libc::c_int
                                                                      as
                                                                      libc::c_uint));
}
unsafe extern "C" fn window_copy_redraw_lines(mut wme: *mut window_mode_entry,
                                              mut py: u_int, mut ny: u_int) {
    let mut wp: *mut window_pane = (*wme).wp;
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
...
unsafe extern "C" fn window_copy_redraw_screen(mut wme:
                                                   *mut window_mode_entry) {
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
    window_copy_redraw_lines(wme, 0 as libc::c_int as u_int,
...
unsafe extern "C" fn window_copy_synchronize_cursor_end(mut wme:
                                                            *mut window_mode_entry,
                                                        mut begin:
                                                            libc::c_int,
                                                        mut no_reset:
        ...
        1 => {
            ...
            if !(no_reset != 0) {
                ...
                if (*data).dy > yy || (*data).dy == yy && (*data).dx > xx {
                    ...
                    window_copy_cursor_previous_word_pos(wme, (*data).ws,
                                                         0 as libc::c_int,
                                                         &mut xx, &mut yy);
                    ...
                    if xx >= window_copy_find_length(wme, yy) ||
                           window_copy_in_set(wme,
                                              xx.wrapping_add(1 as libc::c_int
                                                                  as
                                                                  libc::c_uint),
                                              yy, (*data).ws) == 0 {
                        window_copy_cursor_next_word_end_pos(wme, (*data).ws,
                                                             &mut xx,
                                                             &mut yy);
                    }
                    /* Reset the start. */
    ...
    if begin != 0 {
        (*data).selx = xx;
        (*data).sely = yy
    } else { (*data).endselx = xx; (*data).endsely = yy };
}
unsafe extern "C" fn window_copy_synchronize_cursor(mut wme:
                                                        *mut window_mode_entry,
                                                    mut no_reset:
                                                        libc::c_int) {
    let mut data: *mut window_copy_mode_data =
    ...
    match (*data).cursordrag as libc::c_uint {
        1 => {
            window_copy_synchronize_cursor_end(wme, 0 as libc::c_int,
                                               no_reset);
        }
        2 => {
            window_copy_synchronize_cursor_end(wme, 1 as libc::c_int,
                                               no_reset);
        }
        0 | _ => { }
    };
}
unsafe extern "C" fn window_copy_update_cursor(mut wme:
                                                   *mut window_mode_entry,
...
unsafe extern "C" fn window_copy_start_selection(mut wme:
                                                     *mut window_mode_entry) {
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
    (*data).selx = (*data).cx;
...
unsafe extern "C" fn window_copy_adjust_selection(mut wme:
                                                      *mut window_mode_entry,
                                                  mut selx: *mut u_int,
                                                  mut sely: *mut u_int)
 -> libc::c_int {
    ...
    if sy < ty {
        ...
        if (*data).rectflag == 0 { sx = 0 as libc::c_int as u_int }
        sy = 0 as libc::c_int as u_int
    } else if sy >
                  ty.wrapping_add((*(*s).grid).sy).wrapping_sub(1 as
                                                                    libc::c_int
                                                                    as
                                                                    libc::c_uint)
     {
        ...
        if (*data).rectflag == 0 {
            sx =
                (*(*s).grid).sx.wrapping_sub(1 as libc::c_int as libc::c_uint)
        }
        sy = (*(*s).grid).sy.wrapping_sub(1 as libc::c_int as libc::c_uint)
    } else {
...
unsafe extern "C" fn window_copy_update_selection(mut wme:
                                                      *mut window_mode_entry,
...
unsafe extern "C" fn window_copy_set_selection(mut wme:
 ...
 -> libc::c_int {
    ...
    style_apply(&mut gc, oo,
                ...
                0 as *mut format_tree);
    gc.flags = (gc.flags as libc::c_int | 0x20 as libc::c_int) as u_char;
    screen_set_selection(s, sx, sy, endsx, endsy, (*data).rectflag as u_int,
                         (*data).modekeys, &mut gc);
    if (*data).rectflag != 0 && may_redraw != 0 {
        ...
        if (*data).cursordrag as libc::c_uint ==
            ...
            if sy < cy {
                window_copy_redraw_lines(wme, sy,
                                         cy.wrapping_sub(sy).wrapping_add(1 as
                                                                              libc::c_int
                                                                              as
                                                                              libc::c_uint));
            } else {
                window_copy_redraw_lines(wme, cy,
                                         sy.wrapping_sub(cy).wrapping_add(1 as
                                                                              libc::c_int
                                                                              as
                                                                              libc::c_uint));
            }
            ...
            window_copy_redraw_lines(wme, endsy,
                                     cy.wrapping_sub(endsy).wrapping_add(1 as
                                                                             libc::c_int
                                                                             as
                                                                             libc::c_uint));
        } else {
            window_copy_redraw_lines(wme, cy,
                                     endsy.wrapping_sub(cy).wrapping_add(1 as
                                                                             libc::c_int
                                                                             as
                                                                             libc::c_uint));
        }
...
unsafe extern "C" fn window_copy_get_selection(mut wme:
                                                   *mut window_mode_entry,
                                               mut len: *mut size_t)
 -> *mut libc::c_void {
    let mut wp: *mut window_pane = (*wme).wp;
    ...
    *buf = '\u{0}' as i32 as libc::c_char;
    ...
    if (*data).rectflag != 0 {
        ...
        if selx < (*data).cx {
            ...
            if keys == 0 as libc::c_int {
                ...
                lastex =
                    (*data).cx.wrapping_add(1 as libc::c_int as libc::c_uint);
                restex =
                    (*data).cx.wrapping_add(1 as libc::c_int as libc::c_uint)
            }
            firstsx = selx;
        ...
        if keys == 0 as libc::c_int {
            lastex = ex
        } else { lastex = ex.wrapping_add(1 as libc::c_int as libc::c_uint) }
        restex = xx;
        firstsx = sx;
    ...
    i = sy;
    while i <= ey {
        window_copy_copy_line(wme, &mut buf, &mut off, i,
...
unsafe extern "C" fn window_copy_copy_buffer(mut wme: *mut window_mode_entry,
...
unsafe extern "C" fn window_copy_copy_pipe(mut wme: *mut window_mode_entry,
                                           mut s: *mut session,
                                           mut prefix: *const libc::c_char,
    ...
    if cmd.is_null() || *cmd as libc::c_int == '\u{0}' as i32 {
        cmd =
            options_get_string(global_options,
                               b"copy-command\x00" as *const u8 as
                                   *const libc::c_char)
    }
    if !cmd.is_null() && *cmd as libc::c_int != '\u{0}' as i32 {
        job =
            job_run(cmd, s, 0 as *const libc::c_char, None, None, None,
                    0 as *mut libc::c_void, 0x1 as libc::c_int,
                    -(1 as libc::c_int), -(1 as libc::c_int));
        bufferevent_write(job_get_event(job), buf, len);
    }
    if !buf.is_null() { window_copy_copy_buffer(wme, prefix, buf, len); };
}
unsafe extern "C" fn window_copy_copy_selection(mut wme:
                                                    *mut window_mode_entry,
                                                mut prefix:
                                                    *const libc::c_char) {
    let mut buf: *mut libc::c_char = 0 as *mut libc::c_char;
...
unsafe extern "C" fn window_copy_append_selection(mut wme:
                                                      *mut window_mode_entry) {
    let mut wp: *mut window_pane = (*wme).wp;
    let mut buf: *mut libc::c_char = 0 as *mut libc::c_char;
    ...
    if !pb.is_null() {
        ...
        buf =
            xrealloc(buf as *mut libc::c_void, len.wrapping_add(bufsize)) as
                *mut libc::c_char;
    ...
    if paste_set(buf, len, bufname, 0 as *mut *mut libc::c_char) !=
           0 as libc::c_int {
        free(buf as *mut libc::c_void);
    };
}
unsafe extern "C" fn window_copy_copy_line(mut wme: *mut window_mode_entry,
    ...
    if wrapped != 0 {
        xx = (*gl).cellsize
    } else { xx = window_copy_find_length(wme, sy) }
    if ex > xx { ex = xx }
    if sx > xx { sx = xx }
    if sx < ex {
        i = sx;
        while i < ex {
            ...
            if !(gc.flags as libc::c_int & 0x4 as libc::c_int != 0) {
                ...
                if ud.size as libc::c_int == 1 as libc::c_int &&
                    ...
                    s =
                        tty_acs_get(0 as *mut tty,
                                    ud.data[0 as libc::c_int as usize]);
                    if !s.is_null() &&
                           strlen(s) <=
                               ::std::mem::size_of::<[u_char; 21]>() as
                                   libc::c_ulong {
                ...
                *buf =
                    xrealloc(*buf as *mut libc::c_void,
                             (*off).wrapping_add(ud.size as libc::c_ulong)) as
                        *mut libc::c_char;
                ...
                *off =
                    (*off as
                         libc::c_ulong).wrapping_add(ud.size as libc::c_ulong)
                        as size_t as size_t
            }
            i = i.wrapping_add(1)
        }
...
unsafe extern "C" fn window_copy_clear_selection(mut wme:
                                                     *mut window_mode_entry) {
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
    let mut px: u_int = 0;
...
unsafe extern "C" fn window_copy_in_set(mut wme: *mut window_mode_entry,
                                        mut px: u_int, mut py: u_int,
...
unsafe extern "C" fn window_copy_find_length(mut wme: *mut window_mode_entry,
                                             mut py: u_int) -> u_int {
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
    return grid_line_length((*(*data).backing).grid, py);
}
unsafe extern "C" fn window_copy_cursor_start_of_line(mut wme:
                                                          *mut window_mode_entry) {
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
    ...
    if (*data).cx == 0 as libc::c_int as libc::c_uint &&
        ...
        while py > 0 as libc::c_int as libc::c_uint &&
                  (*grid_get_line(gd,
                                  py.wrapping_sub(1 as libc::c_int as
                                                      libc::c_uint))).flags &
                      0x1 as libc::c_int != 0 {
            window_copy_cursor_up(wme, 0 as libc::c_int);
            py =
    ...
    if window_copy_update_selection(wme, 1 as libc::c_int, 0 as libc::c_int)
           != 0 {
        window_copy_redraw_lines(wme, (*data).cy, 1 as libc::c_int as u_int);
    };
}
unsafe extern "C" fn window_copy_cursor_back_to_indentation(mut wme:
                                                                *mut window_mode_entry) {
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
    let mut px: u_int = 0;
...
unsafe extern "C" fn window_copy_cursor_end_of_line(mut wme:
                                                        *mut window_mode_entry) {
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
    let mut back_s: *mut screen = (*data).backing;
...
unsafe extern "C" fn window_copy_other_end(mut wme: *mut window_mode_entry) {
    ...
    } else if (*data).lineflag as libc::c_uint ==
                  LINE_SEL_RIGHT_LEFT as libc::c_int as libc::c_uint {
        (*data).lineflag = LINE_SEL_LEFT_RIGHT
    }
    match (*data).cursordrag as libc::c_uint {
    ...
    if sely < hsize.wrapping_sub((*data).oy) {
                  ...
                  hsize.wrapping_sub((*data).oy).wrapping_add((*(*s).grid).sy)
     {
        /* below */
        (*data).oy =
            hsize.wrapping_sub(sely).wrapping_add((*(*s).grid).sy).wrapping_sub(1
                                                                                    as
                                                                                    libc::c_int
                                                                                    as
                                                                                    libc::c_uint);
        (*data).cy =
            (*(*s).grid).sy.wrapping_sub(1 as libc::c_int as libc::c_uint)
    } else { (*data).cy = cy.wrapping_add(sely).wrapping_sub(yy) }
    window_copy_update_selection(wme, 1 as libc::c_int, 1 as libc::c_int);
    window_copy_redraw_screen(wme);
}
unsafe extern "C" fn window_copy_cursor_left(mut wme:
                                                 *mut window_mode_entry) {
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
    let mut py: u_int = 0;
    ...
    while cx > 0 as libc::c_int as libc::c_uint {
        ...
        if !(gc.flags as libc::c_int) & 0x4 as libc::c_int != 0 { break ; }
    ...
    if cx == 0 as libc::c_int as libc::c_uint &&
        ...
        window_copy_update_cursor(wme,
                                  cx.wrapping_sub(1 as libc::c_int as
                                                      libc::c_uint),
                                  (*data).cy);
        if window_copy_update_selection(wme, 1 as libc::c_int,
                                        0 as libc::c_int) != 0 {
...
unsafe extern "C" fn window_copy_cursor_right(mut wme: *mut window_mode_entry,
                                              mut all: libc::c_int) {
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
    let mut px: u_int = 0;
    ...
    py =
        (*(*(*data).backing).grid).hsize.wrapping_add((*data).cy).wrapping_sub((*data).oy);
    yy =
        (*(*(*data).backing).grid).hsize.wrapping_add((*(*(*data).backing).grid).sy).wrapping_sub(1
                                                                                                      as
                                                                                                      libc::c_int
                                                                                                      as
                                                                                                      libc::c_uint);
    ...
    } else { px = window_copy_find_length(wme, py) }
    if (*data).cx >= px && py < yy {
        window_copy_cursor_start_of_line(wme);
        window_copy_cursor_down(wme, 0 as libc::c_int);
    } else if (*data).cx < px {
...
unsafe extern "C" fn window_copy_cursor_up(mut wme: *mut window_mode_entry,
    ...
    if scroll_only != 0 || (*data).cy == 0 as libc::c_int as libc::c_uint {
        ...
        if scroll_only != 0 {
            if (*data).cy ==
                   (*(*s).grid).sy.wrapping_sub(1 as libc::c_int as
                                                    libc::c_uint) {
                window_copy_redraw_lines(wme, (*data).cy,
                                         1 as libc::c_int as u_int);
            } else {
        ...
        window_copy_update_cursor(wme, (*data).lastcx,
                                  (*data).cy.wrapping_sub(1 as libc::c_int as
                                                              libc::c_uint));
        if window_copy_update_selection(wme, 1 as libc::c_int,
                                        0 as libc::c_int) != 0 {
            if (*data).cy ==
...
unsafe extern "C" fn window_copy_cursor_down(mut wme: *mut window_mode_entry,
                                             mut scroll_only: libc::c_int) {
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
    let mut s: *mut screen = &mut (*data).screen;
               ...
               (*(*s).grid).sy.wrapping_sub(1 as libc::c_int as libc::c_uint)
       {
        ...
        if scroll_only != 0 && (*data).cy > 0 as libc::c_int as libc::c_uint {
            window_copy_redraw_lines(wme,
                                     (*data).cy.wrapping_sub(1 as libc::c_int
                                                                 as
                                                                 libc::c_uint),
                                     2 as libc::c_int as u_int);
        }
        ...
        window_copy_update_cursor(wme, (*data).lastcx,
                                  (*data).cy.wrapping_add(1 as libc::c_int as
                                                              libc::c_uint));
        if window_copy_update_selection(wme, 1 as libc::c_int,
                                        0 as libc::c_int) != 0 {
            window_copy_redraw_lines(wme,
...
unsafe extern "C" fn window_copy_cursor_jump(mut wme:
                                                 *mut window_mode_entry) {
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
    let mut back_s: *mut screen = (*data).backing;
...
unsafe extern "C" fn window_copy_cursor_jump_back(mut wme:
                                                      *mut window_mode_entry) {
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
    let mut back_s: *mut screen = (*data).backing;
    ...
    py =
        (*(*back_s).grid).hsize.wrapping_add((*data).cy).wrapping_sub((*data).oy);
    if px > 0 as libc::c_int as libc::c_uint { px = px.wrapping_sub(1) }
    loop  {
        grid_get_cell((*back_s).grid, px, py, &mut gc);
        if gc.flags as libc::c_int & 0x4 as libc::c_int == 0 &&
               gc.data.size as libc::c_int == 1 as libc::c_int &&
        ...
        if px == 0 as libc::c_int as libc::c_uint { break ; }
        px = px.wrapping_sub(1)
    };
}
unsafe extern "C" fn window_copy_cursor_jump_to(mut wme:
                                                    *mut window_mode_entry) {
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
    let mut back_s: *mut screen = (*data).backing;
    ...
    while px < xx {
        ...
        if gc.flags as libc::c_int & 0x4 as libc::c_int == 0 &&
               ...
               *gc.data.data.as_mut_ptr() as libc::c_int ==
                   (*data).jumpchar as libc::c_int {
            window_copy_update_cursor(wme,
                                      px.wrapping_sub(1 as libc::c_int as
                                                          libc::c_uint),
                                      (*data).cy);
            if window_copy_update_selection(wme, 1 as libc::c_int,
                                            0 as libc::c_int) != 0 {
...
unsafe extern "C" fn window_copy_cursor_jump_to_back(mut wme:
                                                         *mut window_mode_entry) {
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
    let mut back_s: *mut screen = (*data).backing;
...
unsafe extern "C" fn window_copy_cursor_next_word(mut wme:
                                                      *mut window_mode_entry,
                                                  mut separators:
                                                      *const libc::c_char) {
    let mut data: *mut window_copy_mode_data =
    ...
    xx = window_copy_find_length(wme, py);
    yy =
        (*(*back_s).grid).hsize.wrapping_add((*(*back_s).grid).sy).wrapping_sub(1
                                                                                    as
                                                                                    libc::c_int
                                                                                    as
                                                                                    libc::c_uint);
	 ...
	 */
        ...
        if !(expected == 1 as libc::c_int) { break ; }
    }
    window_copy_update_cursor(wme, px, (*data).cy);
    if window_copy_update_selection(wme, 1 as libc::c_int, 0 as libc::c_int)
           != 0 {
...
unsafe extern "C" fn window_copy_cursor_next_word_end_pos(mut wme:
                                                              *mut window_mode_entry,
                                                          mut separators:
                                                              *const libc::c_char,
                                                          mut ppx: *mut u_int,
    ...
    if keys == 1 as libc::c_int &&
           window_copy_in_set(wme, px, py, separators) == 0 {
        px = px.wrapping_add(1)
    }
    loop 
         /*
	 ...
	 */
        ...
        expected = (expected == 0) as libc::c_int;
        if !(expected == 0 as libc::c_int) { break ; }
    }
...
unsafe extern "C" fn window_copy_cursor_next_word_end(mut wme:
                                                          *mut window_mode_entry,
                                                      mut separators:
                                                          *const libc::c_char,
                                                      mut no_reset:
...
unsafe extern "C" fn window_copy_cursor_previous_word_pos(mut wme:
                                                              *mut window_mode_entry,
                                                          mut separators:
                                                              *const libc::c_char,
                                                          mut already:
        ...
        match current_block {
            8236137900636309791 => {
                ...
                while px > 0 as libc::c_int as libc::c_uint &&
                          window_copy_in_set(wme,
                                             px.wrapping_sub(1 as libc::c_int
                                                                 as
                                                                 libc::c_uint),
                                             py, separators) == 0 {
                    px = px.wrapping_sub(1)
                    ...
                    if py == 0 as libc::c_int as libc::c_uint ||
                           (*data).cy == 0 as libc::c_int as libc::c_uint &&
                               ((*(*(*data).backing).grid).hsize ==
                                    0 as libc::c_int as libc::c_uint ||
                                    (*data).oy >=
                                        (*(*(*data).backing).grid).hsize.wrapping_sub(1
                                                                                          as
                                                                                          libc::c_int
                                                                                          as
                                                                                          libc::c_uint))
...
unsafe extern "C" fn window_copy_cursor_previous_word(mut wme:
                                                          *mut window_mode_entry,
                                                      mut separators:
                                                          *const libc::c_char,
                                                      mut already:
...
unsafe extern "C" fn window_copy_scroll_up(mut wme: *mut window_mode_entry,
                                           mut ny: u_int) {
    let mut wp: *mut window_pane = (*wme).wp;
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
    ...
    if ny == 0 as libc::c_int as libc::c_uint { return }
    (*data).oy =
    ...
    screen_write_start_pane(&mut ctx, wp, 0 as *mut screen);
    screen_write_cursormove(&mut ctx, 0 as libc::c_int, 0 as libc::c_int,
                            0 as libc::c_int);
    screen_write_deleteline(&mut ctx, ny, 8 as libc::c_int as u_int);
    window_copy_write_lines(wme, &mut ctx, (*(*s).grid).sy.wrapping_sub(ny),
                            ny);
    ...
    if (*(*s).grid).sy > 3 as libc::c_int as libc::c_uint {
        window_copy_write_line(wme, &mut ctx,
                               (*(*s).grid).sy.wrapping_sub(2 as libc::c_int
                                                                as
                                                                libc::c_uint));
    }
    if !(*s).sel.is_null() && (*(*s).grid).sy > ny {
        window_copy_write_line(wme, &mut ctx,
                               (*(*s).grid).sy.wrapping_sub(ny).wrapping_sub(1
                                                                                 as
                                                                                 libc::c_int
                                                                                 as
                                                                                 libc::c_uint));
...
unsafe extern "C" fn window_copy_scroll_down(mut wme: *mut window_mode_entry,
                                             mut ny: u_int) {
    let mut wp: *mut window_pane = (*wme).wp;
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
...
unsafe extern "C" fn window_copy_rectangle_toggle(mut wme:
                                                      *mut window_mode_entry) {
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
    let mut px: u_int = 0;
...
pub unsafe extern "C" fn window_copy_start_drag(mut c: *mut client,
    ...
    if cmd_mouse_at(wp, m, &mut x, &mut y, 1 as libc::c_int) !=
           0 as libc::c_int {
        return
    }
    (*c).tty.mouse_drag_update =
        Some(window_copy_drag_update as
                 unsafe extern "C" fn(_: *mut client, _: *mut mouse_event)
                     -> ());
    (*c).tty.mouse_drag_release =
        Some(window_copy_drag_release as
                 unsafe extern "C" fn(_: *mut client, _: *mut mouse_event)
                     -> ());
    data = (*wme).data as *mut window_copy_mode_data;
    yg =
        (*(*(*data).backing).grid).hsize.wrapping_add(y).wrapping_sub((*data).oy);
    ...
    match (*data).selflag as libc::c_uint {
        1 => {
            if !(*data).ws.is_null() {
                window_copy_update_cursor(wme, x, y);
                window_copy_cursor_previous_word_pos(wme, (*data).ws,
                                                     0 as libc::c_int, &mut x,
                                                     &mut y);
                y =
                    (y as
                         libc::c_uint).wrapping_sub((*(*(*data).backing).grid).hsize.wrapping_sub((*data).oy))
                        as u_int as u_int
            }
            window_copy_update_cursor(wme, x, y);
        }
        2 => { window_copy_update_cursor(wme, 0 as libc::c_int as u_int, y); }
        0 => {
            window_copy_update_cursor(wme, x, y);
            window_copy_start_selection(wme);
        }
    ...
    if old_cy != (*data).cy || old_cx == (*data).cx {
        if y == 0 as libc::c_int as libc::c_uint {
            ...
            window_copy_cursor_up(wme, 1 as libc::c_int);
                      ...
                      (*(*data).screen.grid).sy.wrapping_sub(1 as libc::c_int
                                                                 as
                                                                 libc::c_uint)
         {
            event_add(&mut (*data).dragtimer, &mut tv);
...
unsafe extern "C" fn window_copy_drag_release(mut c: *mut client,
                                              mut m: *mut mouse_event) {
    let mut wp: *mut window_pane = 0 as *mut window_pane;
    let mut wme: *mut window_mode_entry = 0 as *mut window_mode_entry;
    let mut data: *mut window_copy_mode_data =
...
unsafe extern "C" fn window_copy_jump_to_mark(mut wme:
                                                  *mut window_mode_entry) {
    let mut data: *mut window_copy_mode_data =
        (*wme).data as *mut window_copy_mode_data;
    let mut tmx: u_int = 0;
    ...
    if (*data).my < (*(*(*data).backing).grid).hsize {
        ...
        (*data).cy =
            (*data).my.wrapping_sub((*(*(*data).backing).grid).hsize);
        (*data).oy = 0 as libc::c_int as u_int
    }
    (*data).mx = tmx;
    (*data).my = tmy;
